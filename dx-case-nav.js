...
const DxCaseNav = {
    config: {
        ...
        showQuickNav: true,
        confirmExit: true,
        parentPage: '../adventure-hub.html',
        parentName: 'Adventure Hub',
        platformRoot: '../',
    ...
    init(options = {}) {
        ...
        // Create exit modal (MUST be before setupEventListeners so buttons exist)
    ...
    detectPageType() {
        ...
        if (path.includes('adventure-cases') || path.includes('-expanded') || path.includes('-adventure')) {
            ...
            this.config.parentPage = '../adventure-hub.html';
            this.config.parentName = 'Adventures';
    ...
    createBreadcrumb() {
        ...
        if (this.pageType === 'adventure-case') {
            ...
            crumbs.push(`<a href="../adventure-hub.html">Adventures</a>`);
    ...
    createMenuContent() {
        ...
        return `
            ...
            <div class="dx-menu-section">
                ...
                <a href="${platformRoot}mechanism/index.html" class="dx-menu-item">
                    <span class="dx-menu-item-icon">⚙️</span>
                    MechanismDx
                </a>
