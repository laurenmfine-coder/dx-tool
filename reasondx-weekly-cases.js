        ...
        return `
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl p-6">
                    ...
                    <div class="space-y-4">
                        ${[1,2,3,4,5].map(n => `
                            <div class="grid grid-cols-12 gap-3 items-center">
                                ...
                                <input type="text" id="ddx${n}" placeholder="Type to search diagnoses..." 
                                    list="diagnosisList"
                    ...
                    <p class="text-xs text-zinc-500 mt-3">💡 Start typing to see matching diagnoses from our database of 800+ conditions</p>
