...
window.EMR_DATA = {
  ...
  "patientHPI": "The doctors called and said something came back abnormal on my baby's newborn screening test and we need to come in right away. She seems completely fine to me - she's eating well, gaining weight, and hasn't been sick at all, so I'm confused and worried about what this could mean.",
    ...
    "immunizations": [
      { "name": "Hepatitis B (Birth dose)", "date": "01/15/2026", "lot": "NB-01", "site": "Right Vastus Lateralis" }
    ],
    "familyHistory": [
    ...
    "socialHistory": [
      ["Birth", "Full term, uncomplicated vaginal delivery"],
      ["Newborn screening", "TREC (T-cell receptor excision circles) — ABSENT on NBS — flagged at 3 days of life"],
      ["Key", "SCID detected by newborn screening (TREC absent) before clinical disease. Treatment window open — HSCT curative."]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Absent TRECs on newborn blood spot screening — urgent SCID evaluation", "status": "Active", "onset": "Congenital", "icd10": "D81.3" },
        { "id": "prob-2", "description": "Otherwise well-appearing 6-week-old", "status": "Active", "onset": "", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "PCP prophylaxis (TMP-SMX)", "dose": "Pediatric dosing", "route": "PO", "frequency": "3×/week — started empirically pending workup", "status": "Active", "prescriber": "Dr. Immunology Fellow" }
      ],
      "vitals": [
        { "date": "02/28/2026", "time": "09:00", "bp": "78/48", "hr": "144", "rr": "42", "temp": "37.1°C", "spo2": "99% (room air)", "pain": "N/A — infant" }
      ],
      "labs": [
        {
          "date": "02/28/2026", "time": "09:30", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-392840",
          "collected": "02/28/2026 09:25", "fasting": "Not fasting",
          "facility": "Jackson Memorial Hospital", "specimenType": "Blood",
          "groups": [
            {
              "name": "CBC WITH DIFFERENTIAL",
              "results": [
                { "test": "WBC", "value": "3.1", "unit": "x10³/µL", "range": "9.0-30.0 (newborn)", "flag": "L" },
                { "test": "Lymphocytes (Absolute)", "value": "320", "unit": "cells/µL", "range": ">2500 (infants)", "flag": "L" },
                { "test": "Neutrophils", "value": "68%", "unit": "%", "range": "35-70", "flag": "" },
                { "test": "Hemoglobin", "value": "14.2", "unit": "g/dL", "range": "13.5-19.5 (newborn)", "flag": "" },
                { "test": "Platelets", "value": "298", "unit": "x10³/µL", "range": "150-400", "flag": "" }
              ]
            },
            {
              "name": "LYMPHOCYTE SUBSETS (Flow Cytometry)",
              "results": [
                { "test": "CD3+ T Cells (Absolute)", "value": "28", "unit": "cells/µL", "range": ">2000 (infants)", "flag": "L" },
                { "test": "CD4+ T Cells (Absolute)", "value": "18", "unit": "cells/µL", "range": ">1500 (infants)", "flag": "L" },
                { "test": "CD8+ T Cells (Absolute)", "value": "10", "unit": "cells/µL", "range": ">500 (infants)", "flag": "L" },
                { "test": "CD19+ B Cells (Absolute)", "value": "0", "unit": "cells/µL", "range": ">200 (infants)", "flag": "L" },
                { "test": "NK Cells CD56+ (Absolute)", "value": "0", "unit": "cells/µL", "range": ">200 (infants)", "flag": "L" },
                { "test": "T cell phenotype note", "value": "Maternal T-cell engraftment suspected — CD3+ cells present are predominantly CD45RO+ memory cells (likely maternal). Confirm with maternal lymphocyte chimerism.", "unit": "", "range": "", "flag": "A" }
              ]
            },
            {
              "name": "IMMUNOGLOBULINS (Age-Appropriate Interpretation Needed)",
              "results": [
                { "test": "IgG", "value": "821", "unit": "mg/dL", "range": "Reflects maternal IgG (normal at 6 weeks)", "flag": "" },
                { "test": "IgA", "value": "<7", "unit": "mg/dL", "range": "Infants normally have no endogenous IgA at 6 weeks", "flag": "" },
                { "test": "IgM", "value": "8", "unit": "mg/dL", "range": "14-142 (infants)", "flag": "L" }
              ]
            },
            {
              "name": "ADA ENZYME ASSAY (Adenosine Deaminase)",
              "results": [
                { "test": "RBC ADA Activity", "value": "2", "unit": "µmol/h/gHb", "range": "130-600 µmol/h/gHb", "flag": "L" },
                { "test": "Interpretation", "value": "Severe ADA deficiency — <5% of normal. Consistent with ADA-SCID. Toxic metabolites (dATP, SAH hydrolase inhibition) accumulate → T, B, and NK cell apoptosis.", "unit": "", "range": "Normal: 130-600", "flag": "A" },
                { "test": "dATP (Toxic Metabolite)", "value": "Markedly elevated", "unit": "", "range": "Undetectable", "flag": "H" }
              ]
            },
            {
              "name": "TREC CONFIRMATION",
              "results": [
                { "test": "Peripheral Blood TRECs (Quantitative)", "value": "Undetectable (<5 copies/µg DNA)", "unit": "copies/µg", "range": ">1000 copies/µg (infants)", "flag": "L" },
                { "test": "Interpretation", "value": "Absent TRECs confirm profound T cell lymphopenia. TRECs are DNA excision circles produced during normal T cell development in the thymus — absent in SCID where thymic T cell output is zero.", "unit": "", "range": "", "flag": "A" }
              ]
            }
          ]
        }
      ...
      "imaging": [
        {
          "id": "img-1", "date": "02/28/2026", "study": "Chest X-Ray",
          "status": "Final", "priority": "Stat",
          "orderedBy": "Dr. Pediatric Immunology", "readBy": "Dr. Radiologist",
          "facility": "Jackson Memorial Hospital", "accession": "IMG-481920",
          ...
          "dictated": "02/28/2026 10:00", "verified": "02/28/2026 10:20"
        }
      ],
      "visits": [
        {
          "id": "visit-1", "type": "Urgent Immunology Consultation",
          "date": "02/28/2026", "provider": "Dr. Pediatric Immunology Attending",
    ...
    "inpatient": {
      ...
      "problems": [
        { "id": "prob-1", "description": "ADA-SCID — admitted for matched sibling donor HSCT (none available — proceeding with matched unrelated donor)", "status": "Active", "onset": "Congenital", "icd10": "D81.3" },
        { "id": "prob-2", "description": "On PEG-ADA bridge therapy since diagnosis", "status": "Active", "onset": "", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "PEG-ADA (Elapegademase)", "dose": "30 units/kg", "route": "IM", "frequency": "Weekly — bridge therapy", "status": "Active", "prescriber": "Dr. Pediatric Immunology" },
        { "id": "med-2", "name": "TMP-SMX", "dose": "Pediatric dosing", "route": "PO", "frequency": "3×/week", "status": "Active", "prescriber": "Dr. Pediatric Immunology" },
        { "id": "med-3", "name": "Busulfan + Fludarabine (conditioning)", "dose": "Per BMT protocol", "route": "IV", "frequency": "Per BMT schedule", "status": "Pending", "prescriber": "Dr. BMT Attending" }
      ],
      "vitals": [
        { "date": "03/15/2026", "time": "08:00", "bp": "80/50", "hr": "138", "rr": "38", "temp": "37.0°C", "spo2": "99%", "pain": "N/A" }
      ],
      "labs": [
        {
          "date": "03/15/2026", "time": "07:30", "status": "Final",
          "orderedBy": "Dr. BMT Attending", "accession": "LAB-412033",
          "collected": "03/15/2026 07:25", "fasting": "Not fasting",
          "facility": "Jackson Memorial Hospital — BMT Unit", "specimenType": "Blood",
          "groups": [
            {
              "name": "PRE-CONDITIONING LABS",
              "results": [
                { "test": "ALC (Post-PEG-ADA)", "value": "680", "unit": "cells/µL", "range": ">2500 (infants)", "flag": "L" },
                { "test": "Note", "value": "Improvement with PEG-ADA bridge — ADA enzyme activity partially restored. Lymphocytes recovering partially. HSCT remains definitive treatment.", "unit": "", "range": "", "flag": "A" },
                { "test": "CMV PCR", "value": "Negative", "unit": "", "range": "Negative", "flag": "" },
                { "test": "EBV PCR", "value": "Negative", "unit": "", "range": "Negative", "flag": "" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-2", "type": "BMT Pre-Conditioning Consult", "date": "03/15/2026",
    ...
    "office": {
      ...
      "problems": [
        { "id": "prob-1", "description": "ADA-SCID — Day +120 post-MUD HSCT", "status": "Active", "onset": "Congenital", "icd10": "D81.3" },
        { "id": "prob-2", "description": "Immune reconstitution in progress — CD4 recovering", "status": "Active", "onset": "", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Cyclosporine", "dose": "Taper ongoing", "route": "PO", "frequency": "BID — GVHD prophylaxis taper", "status": "Active", "prescriber": "Dr. BMT Attending" },
        { "id": "med-2", "name": "TMP-SMX", "dose": "Pediatric", "route": "PO", "frequency": "3×/week — continue until CD4 >200 cells/µL", "status": "Active", "prescriber": "Dr. BMT Attending" },
        { "id": "med-3", "name": "IVIG", "dose": "400 mg/kg", "route": "IV", "frequency": "q4 weeks — continue until endogenous IgG producing", "status": "Active", "prescriber": "Dr. BMT Attending" }
      ],
      "vitals": [
        { "date": "07/13/2026", "time": "10:00", "bp": "82/52", "hr": "124", "rr": "36", "temp": "36.8°C", "spo2": "99%", "pain": "N/A" }
      ],
      "labs": [
        {
          "date": "07/13/2026", "time": "10:15", "status": "Final",
          "orderedBy": "Dr. BMT Attending", "accession": "LAB-448019",
          "collected": "07/13/2026 10:10", "fasting": "Not fasting",
          "facility": "Jackson Memorial Hospital — BMT Clinic", "specimenType": "Blood",
          "groups": [
            {
              "name": "IMMUNE RECONSTITUTION PANEL — Day +120",
              "results": [
                { "test": "CD4+ T Cells (Absolute)", "value": "342", "unit": "cells/µL", "range": ">200 (initial recovery target)", "flag": "" },
                { "test": "CD8+ T Cells (Absolute)", "value": "218", "unit": "cells/µL", "range": ">100", "flag": "" },
                { "test": "CD19+ B Cells (Absolute)", "value": "48", "unit": "cells/µL", "range": "Beginning to recover", "flag": "L" },
                { "test": "NK Cells (Absolute)", "value": "180", "unit": "cells/µL", "range": ">100", "flag": "" },
                { "test": "Chimerism (Donor:Host)", "value": "98% donor T cells, 96% donor B cells", "unit": "", "range": "Target: full donor chimerism", "flag": "" },
                { "test": "GVHD Signs", "value": "No rash, diarrhea, or liver abnormalities — no active GVHD", "unit": "", "range": "Absent", "flag": "" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-3", "type": "BMT Clinic Follow-Up — Day +120", "date": "07/13/2026",
          "provider": "Dr. BMT Attending",
