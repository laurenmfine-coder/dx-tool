...
window.EMR_DATA = {
  ...
  "patientHPI": "My son has had a fever for two days and won't put any weight on his right leg, and his knee is really swollen - I'm worried because he's had so many infections already for a 2-year-old.",
    ...
    "immunizations": [
      { "name": "DTaP (Dose 3)", "date": "02/2024", "lot": "PED-24", "site": "Left Thigh" },
      { "name": "PCV15 (Dose 3)", "date": "02/2024", "lot": "PED-24A", "site": "Right Thigh" }
    ],
    "familyHistory": [
    ...
    "socialHistory": [
      ["Living situation", "Lives with both parents, no siblings"],
      ["Daycare", "Started daycare at 12 months"],
      ["Key", "Male infant with recurrent bacterial infections after 6 months — absent B cells — XLA until proven otherwise"]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Septic arthritis — right knee (Streptococcus pneumoniae)", "status": "Active", "onset": "Acute", "icd10": "M00.061" },
        { "id": "prob-2", "description": "Prior: S. pneumoniae bacteremia (age 14 months)", "status": "Resolved", "onset": "Past", "icd10": "" },
        { "id": "prob-3", "description": "Prior: Recurrent otitis media — 5 episodes in 8 months", "status": "Active", "onset": "Chronic", "icd10": "" },
        { "id": "prob-4", "description": "Prior: Haemophilus influenzae pneumonia (age 18 months)", "status": "Resolved", "onset": "Past", "icd10": "" },
        { "id": "prob-5", "description": "Normal growth and development", "status": "Active", "onset": "Chronic", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Amoxicillin", "dose": "45 mg/kg/day", "route": "PO", "frequency": "Divided BID (recent course)", "status": "Active", "prescriber": "Dr. Angela Simmons, MD" },
        { "id": "med-2", "name": "Cefazolin", "dose": "50 mg/kg IV", "route": "IV", "frequency": "Q8H (admitted)", "status": "Active", "prescriber": "Dr. ED Attending" }
      ],
      "vitals": [
        { "date": "03/01/2026", "time": "14:30", "bp": "92/58", "hr": "128", "rr": "28", "temp": "38.9°C", "spo2": "97%", "pain": "7/10 (crying, guarding right knee)" }
      ],
      "labs": [
        {
          "date": "03/01/2026", "time": "14:45", "status": "Final",
          "orderedBy": "Dr. ED Attending", "accession": "LAB-281044",
          "collected": "03/01/2026 14:40", "fasting": "Not fasting",
          "facility": "ReasonDx Medical Center", "specimenType": "Blood",
          "groups": [
            {
              "name": "CBC WITH DIFFERENTIAL",
              "results": [
                { "test": "WBC", "value": "18.4", "unit": "x10³/µL", "range": "6.0-17.5", "flag": "H" },
                { "test": "Neutrophils", "value": "82%", "unit": "%", "range": "35-65", "flag": "H" },
                { "test": "Lymphocytes", "value": "12%", "unit": "%", "range": "25-50", "flag": "L" },
                { "test": "Hemoglobin", "value": "10.8", "unit": "g/dL", "range": "10.5-13.5", "flag": "" },
                { "test": "Platelets", "value": "412", "unit": "x10³/µL", "range": "150-400", "flag": "H" }
              ]
            },
            {
              "name": "IMMUNOGLOBULINS",
              "results": [
                { "test": "IgG", "value": "42", "unit": "mg/dL", "range": "345-1213 (age 2)", "flag": "L" },
                { "test": "IgA", "value": "<7", "unit": "mg/dL", "range": "14-106 (age 2)", "flag": "L" },
                { "test": "IgM", "value": "<5", "unit": "mg/dL", "range": "43-173 (age 2)", "flag": "L" },
                { "test": "IgE Total", "value": "2", "unit": "IU/mL", "range": "0-15 (age 2)", "flag": "" }
              ]
            },
            {
              "name": "LYMPHOCYTE SUBSETS (Flow Cytometry)",
              "results": [
                { "test": "CD3+ T Cells", "value": "78%", "unit": "%", "range": "60-85", "flag": "" },
                { "test": "CD4+ T Cells", "value": "44%", "unit": "%", "range": "30-60", "flag": "" },
                { "test": "CD8+ T Cells", "value": "31%", "unit": "%", "range": "15-35", "flag": "" },
                { "test": "CD19+ B Cells", "value": "0.1%", "unit": "%", "range": "15-30", "flag": "L" },
                { "test": "CD19+ B Cells (Absolute)", "value": "8", "unit": "cells/µL", "range": "200-500", "flag": "L" },
                { "test": "NK Cells (CD56+)", "value": "18%", "unit": "%", "range": "5-20", "flag": "" }
              ]
            },
            {
              "name": "JOINT FLUID ANALYSIS — Right Knee Aspirate",
              "results": [
                { "test": "WBC (Joint)", "value": "94,000", "unit": "cells/µL", "range": "<200", "flag": "H" },
                { "test": "PMN%", "value": "96%", "unit": "%", "range": "<25%", "flag": "H" },
                { "test": "Glucose (Joint)", "value": "28", "unit": "mg/dL", "range": "Serum-like", "flag": "L" },
                { "test": "Culture (Joint)", "value": "Pending — GPCs in pairs/short chains", "unit": "", "range": "No growth", "flag": "A" }
              ]
            }
          ]
        }
      ...
      "imaging": [
        {
          "id": "img-1", "date": "03/01/2026", "study": "Right Knee X-Ray",
          "status": "Final", "priority": "Stat",
          "orderedBy": "Dr. ED Attending", "readBy": "Dr. Radiologist",
          "facility": "ReasonDx Medical Center", "accession": "IMG-381029",
          ...
          "dictated": "03/01/2026 15:10", "verified": "03/01/2026 15:30"
        }
      ],
      "visits": [
        {
          "id": "visit-1", "type": "Emergency Visit", "date": "03/01/2026",
    ...
    "inpatient": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Septic arthritis — right knee (S. pneumoniae confirmed)", "status": "Active", "onset": "Acute", "icd10": "M00.061" },
        { "id": "prob-2", "description": "X-Linked Agammaglobulinemia (XLA) — newly diagnosed", "status": "Active", "onset": "Chronic", "icd10": "D80.0" },
        { "id": "prob-3", "description": "Panhypogammaglobulinemia with absent B cells", "status": "Active", "onset": "Congenital", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Cefazolin", "dose": "50 mg/kg", "route": "IV", "frequency": "Q8H × 3 weeks total", "status": "Active", "prescriber": "Dr. Pediatric Orthopedics" },
        { "id": "med-2", "name": "IVIG (Intravenous Immunoglobulin)", "dose": "400 mg/kg", "route": "IV", "frequency": "Loading dose, then q3-4 weeks", "status": "Active", "prescriber": "Dr. Pediatric Immunology" }
      ],
      "vitals": [
        { "date": "03/03/2026", "time": "08:00", "bp": "96/62", "hr": "104", "rr": "22", "temp": "37.4°C", "spo2": "99%", "pain": "3/10" }
      ],
      "labs": [
        {
          "date": "03/03/2026", "time": "07:30", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-282190",
          "collected": "03/03/2026 07:25", "fasting": "Fasting",
          "facility": "ReasonDx Medical Center", "specimenType": "Blood",
          "groups": [
            {
              "name": "BTK GENE SEQUENCING (Send-Out)",
              "results": [
                { "test": "BTK Mutation", "value": "Pathogenic variant identified: c.1684C>T (p.Arg562Cys) in BTK gene — hemizygous", "unit": "", "range": "No mutation", "flag": "A" },
                { "test": "Interpretation", "value": "Confirms X-linked agammaglobulinemia (Bruton's). BTK kinase-dead mutation. Absent BTK protein expression expected on flow cytometry monocyte staining.", "unit": "", "range": "Normal BTK expression", "flag": "A" }
              ]
            },
            {
              "name": "REPEAT IMMUNOGLOBULINS (Post-IVIG loading, Day 2)",
              "results": [
                { "test": "IgG (post-IVIG)", "value": "621", "unit": "mg/dL", "range": "Target trough >500", "flag": "" },
                { "test": "IgA", "value": "<7", "unit": "mg/dL", "range": "14-106", "flag": "L" },
                { "test": "IgM", "value": "<5", "unit": "mg/dL", "range": "43-173", "flag": "L" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-2", "type": "Inpatient Progress Note", "date": "03/03/2026",
    ...
    "office": {
      ...
      "problems": [
        { "id": "prob-1", "description": "X-Linked Agammaglobulinemia — on IVIG q3 weeks", "status": "Active", "onset": "Congenital", "icd10": "D80.0" },
        { "id": "prob-2", "description": "Septic arthritis — resolved post-arthroscopy + antibiotics", "status": "Resolved", "onset": "Past", "icd10": "" },
        { "id": "prob-3", "description": "Hearing evaluation — mild CHL noted, bilateral tympanic membranes scarred from recurrent OM", "status": "Active", "onset": "Chronic", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "IVIG (Gammagard Liquid)", "dose": "500 mg/kg", "route": "IV", "frequency": "Every 3 weeks (home infusion)", "status": "Active", "prescriber": "Dr. Pediatric Immunology" }
      ],
      "vitals": [
        { "date": "03/24/2026", "time": "10:00", "bp": "94/60", "hr": "96", "rr": "22", "temp": "36.9°C", "spo2": "99%", "pain": "0/10" }
      ],
      "labs": [
        {
          "date": "03/24/2026", "time": "10:15", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-294011",
          "collected": "03/24/2026 10:10", "fasting": "Fasting (pre-infusion trough)",
          "facility": "ReasonDx Medical Center", "specimenType": "Blood",
          "groups": [
            {
              "name": "IVIG TROUGH — IgG Pre-Infusion",
              "results": [
                { "test": "IgG Trough", "value": "534", "unit": "mg/dL", "range": "Target >500 mg/dL", "flag": "" },
                { "test": "Interpretation", "value": "Adequate — maintain current dose. Target trough >500 mg/dL. If breakthrough infections develop, target >700 mg/dL.", "unit": "", "range": "", "flag": "" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-3", "type": "Office Visit — Allergy/Immunology", "date": "03/24/2026",
          "provider": "Dr. Pediatric Immunology",
