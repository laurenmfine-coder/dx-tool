    ...
    const html = `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 24px;">
                ...
                <h1 style="color: #0f766e; margin: 16px 0 8px;">ReasonDx</h1>
                <p style="color: #64748b; margin: 0;">Clinical Reasoning Education</p>
            </div>
            
            <div style="background: #f0fdfa; border: 2px solid #a7f3d0; border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 24px;">
                <p style="margin: 0 0 8px; color: #166534; font-size: 14px;">Your verification code is:</p>
                <div style="font-size: 36px; font-weight: bold; color: #0f766e; letter-spacing: 8px; font-family: monospace;">
                    ${code}
                </div>
            </div>
...
async function sendPasswordResetEmail(toEmail, code) {
    ...
    const html = `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 24px;">
                <span style="font-size: 48px;">🔑</span>
                <h1 style="color: #0f766e; margin: 16px 0 8px;">Password Reset</h1>
            </div>
    ...
    const html = `
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 24px;">
                ...
                <h1 style="color: #0f766e; margin: 16px 0 8px;">Welcome to ReasonDx!</h1>
            </div>
            ...
            <div style="background: #f0fdfa; border: 2px solid #a7f3d0; border-radius: 12px; padding: 20px; text-align: center; margin: 24px 0;">
                <p style="margin: 0 0 4px; color: #166534; font-size: 12px;">Your Study ID</p>
                <div style="font-size: 24px; font-weight: bold; color: #0f766e; font-family: monospace;">
                    ${studyId}
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 24px;">
                <a href="https://reasondx.com" style="display: inline-block; background: #0f766e; color: white; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                    Start Learning →
                </a>
            </div>
        </div>
