...
(function() {
  ...
  widget.innerHTML = `
    ...
    <div class="rdx-help-panel" id="rdx-help-panel">
      ...
      <div class="rdx-help-body">
        ...
        <a href="${base}modules/index.html" class="rdx-help-link">
          <span class="icon">🧬</span>
          <span>Modules</span>
        </a>
        <a href="${base}cases/index.html" class="rdx-help-link">
          <span class="icon">🎮</span>
        ...
        <a href="${base}deep-dive-hub.html" class="rdx-help-link">
          <span class="icon">📖</span>
          <span>Deep Dives</span>
        </a>
        <div class="rdx-help-divider"></div>
        <a href="${base}help.html" class="rdx-help-link">
  ...
  if (path.endsWith('help.html')) return;
