...
'ai-chronic-urticaria': {
    ...
    defined_responses: {
        ...
        'treatment': 'Per AAAAI/ACAAI Practice Parameter: Step 1: Second-generation H1 antihistamine (cetirizine, loratadine, fexofenadine) daily - not PRN. Step 2: Increase to 2-4x standard dose (FDA approved up to 4x for CSU). Step 3: Add omalizumab if inadequate response at 4 weeks. Avoid chronic systemic corticosteroids.',
...
'ai-severe-asthma-phenotyping': {
    ...
    defined_responses: {
        ...
        'dupilumab': 'Dupilumab is particularly attractive here - treats BOTH asthma and nasal polyps (FDA approved for both). IL-4/IL-13 blockade reduces eosinophilic inflammation. Added benefit: may help if any atopic dermatitis component.',
...
'ai-allergic-rhinitis': {
    ...
    defined_responses: {
        ...
        'scit vs slit': 'SCIT (subcutaneous/allergy shots): Most effective, broadest allergen coverage, requires office visits (weekly→monthly), anaphylaxis risk (~1/million). SLIT (sublingual tablets): Convenient daily home use, FDA-approved for grass, ragweed, dust mite, no anaphylaxis risk, single-allergen only.',
...
'ai-food-allergy-ige': {
    ...
    defined_responses: {
        ...
        'oit': 'Oral immunotherapy (Palforzia) FDA-approved for peanut allergy ages 4-17. Doesn\'t cure allergy but raises threshold for reaction - provides protection against accidental exposures. Requires commitment - daily dosing, monthly clinic visits.',
