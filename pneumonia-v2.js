...
window.EMR_DATA = {
  "patient": {
    ...
    "pharmacy": "Publix Pharmacy \u2014 2501 University Dr, Davie, FL",
    "language": "English",
    "race": "Black or African American",
    "address": "1847 SW 62nd Ave, Davie, FL 33314",
    "phone": "(954) 555-7293",
      ...
      "groups": [
        {
          ...
          "results": [
            ...
            {"test": "eGFR", "value": "48", "unit": "mL/min/1.73m2", "range": ">60", "flag": "L"},
            ...
            {"test": "CO2", "value": "24", "unit": "mEq/L", "range": "21-31", "flag": ""},
            {"test": "Calcium", "value": "9.2", "unit": "mg/dL", "range": "8.5-10.5", "flag": ""},
            {"test": "Total Protein", "value": "7.1", "unit": "g/dL", "range": "6.0-8.3", "flag": ""},
        ...
        },
        {
          "name": "HEMOGLOBIN A1C",
          "results": [
            {"test": "Hemoglobin A1c", "value": "7.8", "unit": "%", "range": "<5.7", "flag": "H"}
          ]
        }
      ]
    }
  ...
  "socialHistory": [
    ["Occupation", "Retired warehouse supervisor (35 years). Occupational dust exposure."],
    ["Marital", "Married, lives with wife"],
    ["Tobacco", "Active smoker \u2014 1 PPD x 40 years (40 pack-years). Multiple quit attempts, returns to smoking."],
    ["Alcohol", "Social \u2014 2-3 beers on weekends"],
    ["Drugs", "Denies illicit drug use"],
    ["Exercise", "Sedentary. Walks to mailbox. Limited by dyspnea on exertion."],
    ["Housing", "Single-story home, Davie, FL. Central A/C. No stairs."],
    ["Safety", "Wears seatbelt. No firearms in home."],
