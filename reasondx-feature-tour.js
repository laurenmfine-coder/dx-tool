...
const ReasonDxFeatureTour = (function() {
    ...
    const tourSlides = [
        ...
        },
        {
            ...
            icon: '📚',
            content: `<p>Access integrated <strong>study resources</strong> and AI-powered learning tools.</p>`,
            features: [
                { icon: '📕', text: '<strong>Resource Links</strong> — references to Bates\' Guide & other texts' },
