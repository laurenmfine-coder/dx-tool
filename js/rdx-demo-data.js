...
(function() {
  ...
  // ── DEMO USERS ─────────────────────────────────────────────────────────────
  var DEMO_FACULTY = [
    { username: 'lfine@reasondx.edu',  displayName: 'Dr. Lauren Fine', tier: 'admin' },
    { username: 'jsmith@reasondx.edu', displayName: 'Dr. James Smith', tier: 'faculty' },
  ];

  var DEMO_STUDENTS = [
    { username: 'alopez@reasondx.edu',    displayName: 'Ana Lopez' },
    { username: 'mchen@reasondx.edu',     displayName: 'Michael Chen' },
    { username: 'srahman@reasondx.edu',   displayName: 'Sara Rahman' },
    { username: 'dwalker@reasondx.edu',   displayName: 'Devon Walker' },
    { username: 'priya.n@reasondx.edu',   displayName: 'Priya Nair' },
    { username: 'jkimura@reasondx.edu',   displayName: 'Jake Kimura' },
  ];
  ...
  var FEEDBACK = {
    ...
    'srahman@reasondx.edu': null  // not yet graded
  };
  ...
  window.RDXDemoData = {
    ...
    inject: function() {
      ...
      var assignments = {
        'lfine@reasondx.edu':  ['alopez@reasondx.edu','mchen@reasondx.edu','srahman@reasondx.edu','dwalker@reasondx.edu'],
        'jsmith@reasondx.edu': ['priya.n@reasondx.edu','jkimura@reasondx.edu']
      };
      dbSet('emr-assignments', assignments);

      // 4. Submissions
      var submissionTimes = {
        'alopez@reasondx.edu':  hoursAgo(48),
        'mchen@reasondx.edu':   hoursAgo(36),
        'srahman@reasondx.edu': hoursAgo(24),
        'dwalker@reasondx.edu': hoursAgo(12),
        'priya.n@reasondx.edu': hoursAgo(8),
        'jkimura@reasondx.edu': hoursAgo(3)
      };
      var caseIds = {
        'alopez@reasondx.edu':  'ace-angioedema',
        'mchen@reasondx.edu':   'anaphylaxis-v3',
        'srahman@reasondx.edu': 'anaphylaxis-v4',
        'dwalker@reasondx.edu': 'hereditary-angioedema',
        'priya.n@reasondx.edu': 'insect-sting-anaphylaxis',
        'jkimura@reasondx.edu': 'asthma-exacerbation'
      };
      var weekLabels = {
        'alopez@reasondx.edu':  'Week 3 — Angioedema',
        'mchen@reasondx.edu':   'Week 2 — Anaphylaxis',
        'srahman@reasondx.edu': 'Week 2 — Anaphylaxis',
        'dwalker@reasondx.edu': 'Week 4 — HAE',
        'priya.n@reasondx.edu': 'Week 3 — Venom Allergy',
        'jkimura@reasondx.edu': 'Week 1 — Asthma'
      };
      ...
      var adminUser = { username: 'lfine@reasondx.edu', displayName: 'Dr. Lauren Fine', role: 'admin', tier: 'admin', _demo: true };
      ...
      dbSet('reasondx-user', { email: 'lfine@reasondx.edu', name: 'Dr. Lauren Fine', tier: 'admin', supabaseId: 'lfine@reasondx.edu', _demo: true });
