...
'nursing-deteriorating-patient': {
    ...
    patient: { name: 'Nneka Okonkwo', age: 72, sex: 'Female', setting: 'Med-Surg Floor', room: '4215', acuity: 'High', chiefComplaint: 'POD2 Hip Replacement' },
...
'nursing-postop-hypotension': {
    ...
    patient: { name: 'Tariq Hussain', age: 64, sex: 'Male', setting: 'Surgical Floor', room: '3108', acuity: 'High', chiefComplaint: 'Post-op Colectomy' },
...
'nursing-chest-pain-floor': {
    ...
    patient: { name: 'Sienna Nakagawa', age: 68, sex: 'Female', setting: 'Med-Surg', room: '2108', acuity: 'Critical', chiefComplaint: 'New chest pain' },
...
'nursing-fall': {
    ...
    patient: { name: 'Mirembe Nakato', age: 82, sex: 'Female', setting: 'Med-Surg', room: '3205', acuity: 'Medium', chiefComplaint: 'Found on floor' },
...
'nursing-new-afib': {
    ...
    patient: { name: 'Omar Farouk', age: 69, sex: 'Male', setting: 'Medical Floor', room: '4105', acuity: 'Medium', chiefComplaint: 'Pneumonia with new AFib' },
...
'nursing-transfusion-reaction': {
    ...
    patient: { name: 'Abayomi Oladipo', age: 71, sex: 'Male', setting: 'Med-Surg', room: '2215', acuity: 'High', chiefComplaint: 'Transfusion reaction' },
...
'ems-stemi': {
    ...
    patient: { name: 'Hiroshi Sato', age: 58, sex: 'Male', setting: 'Field', room: 'Field', acuity: 'Critical', chiefComplaint: 'Crushing chest pain' },
...
'ems-stroke': {
    ...
    patient: { name: 'Keiko Nakamura', age: 67, sex: 'Female', setting: 'Field', room: 'Field', acuity: 'Critical', chiefComplaint: 'Weakness and slurred speech' },
...
'ems-anaphylaxis': {
    ...
    patient: { name: 'Daisuke Yamamoto', age: 28, sex: 'Male', setting: 'Field', room: 'Field', acuity: 'Critical', chiefComplaint: 'Allergic reaction' },
...
'rt-bipap-recommendation': {
    ...
    patient: { name: 'Chukwuemeka Nnamdi', age: 68, sex: 'Male', setting: 'ED', room: 'ED Bed 12', acuity: 'High', chiefComplaint: 'COPD Exacerbation' },
...
'rt-weaning': {
    ...
    openingStatement: 'Mrs. Adesanya on PSV 10/5, FiO2 30%. Assess extubation readiness.',
