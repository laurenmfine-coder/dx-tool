...
'pharmd-interaction-critical': {
    ...
    profession: 'pharmd',
    patient: { name: 'Harold Mitchell', age: 72, sex: 'Male', setting: 'Community Pharmacy', acuity: 'High', chiefComplaint: 'New prescription for TMP-SMX' },
...
'pharmd-renal-dosing': {
    ...
    profession: 'pharmd',
    patient: { name: 'Dorothy Williams', age: 78, sex: 'Female', setting: 'Hospital Consult', acuity: 'Medium', chiefComplaint: 'Antibiotic dosing consult' },
...
'pharmd-stewardship': {
    ...
    profession: 'pharmd',
    patient: { name: 'Robert Chen', age: 58, sex: 'Male', setting: 'Hospital', acuity: 'Medium', chiefComplaint: 'Day 3 antibiotic review' },
...
'pharmd-counseling': {
    ...
    profession: 'pharmd',
    patient: { name: 'James Wilson', age: 55, sex: 'Male', setting: 'Community Pharmacy', acuity: 'Low', chiefComplaint: 'New metformin and empagliflozin' },
