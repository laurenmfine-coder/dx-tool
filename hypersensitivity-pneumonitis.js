...
window.EMR_DATA = {
  ...
  "patientHPI": "I've been getting more and more short of breath when I walk upstairs or do things around the house, and it's been going on for over a year now. I also have this dry cough that won't go away, and I've lost about 12 pounds without trying. I love my birds - I have over 40 parakeets that I take care of every day, and they bring me so much joy.",
    ...
    "allergies": [
      { "allergen": "Penicillin", "reaction": "Rash — reported childhood. Never formally evaluated.", "severity": "Unknown" }
    ],
    "immunizations": [
      { "name": "Influenza", "date": "10/2025" },
      { "name": "Pneumococcal PCV20", "date": "2023" },
      { "name": "COVID-19 (bivalent)", "date": "09/2025" }
    ],
    "familyHistory": [
    ...
    "socialHistory": [
      ...
      ["Avian exposure", "Bird breeder × 25 years. Currently owns 40+ birds (parakeets, cockatiels, 2 African Greys). Birds housed in a dedicated aviary room. Cleans cages daily. Sleeps adjacent to aviary room."],
      ["Other antigens", "No hot tub, no occupational mold/dust exposure, no feather bedding (replaced 3 years ago — no improvement)"],
      ["Exercise tolerance", "Baseline walked 2 miles/day. Now limited to 200 feet before stopping due to dyspnea."]
    ]
  },
  ...
  "encounters": {
    "ed": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Progressive exertional dyspnea × 14 months — worsening. Now SOB walking to mailbox.", "status": "Active" },
        { "id": "prob-2", "description": "Chronic dry cough × 18 months — precedes dyspnea onset", "status": "Active" },
        { "id": "prob-3", "description": "Unintentional weight loss 12 lbs × 8 months", "status": "Active" },
        { "id": "prob-4", "description": "Avian antigen exposure × 25 years (bird breeder — 40+ birds). Chronic fibrotic HP leading diagnosis.", "status": "Active" },
        { "id": "prob-5", "description": "Restrictive spirometry pattern on PFTs (PCP). HRCT of chest ordered — pending.", "status": "Active" }
      ],
      "medications": [
        { "id": "med-1", "name": "Lisinopril 10 mg", "dose": "Daily", "route": "Oral", "indication": "Hypertension" },
        { "id": "med-2", "name": "Atorvastatin 40 mg", "dose": "Daily", "route": "Oral" },
        { "id": "med-3", "name": "Albuterol MDI", "dose": "PRN (minimal relief)", "route": "Inhaled", "note": "Minimal bronchodilator response — consistent with fibrotic/restrictive disease" }
      ],
      "vitals": {
        "rows": [
          { "time": "Clinic visit", "bp": "136/82", "hr": "88", "rr": "18", "temp": "37.1", "spo2": "93% RA at rest", "note": "⚠️ SpO₂ drops to 84% with 6-minute walk test (desaturation with exertion — fibrotic pattern)" }
        ]
      },
      "labs": {
        "pfts": {
          ...
          "rows": [
            { "test": "FVC", "value": "1.98 L (58% predicted)", "flag": "L", "note": "Reduced — restrictive physiology" },
            { "test": "FEV₁", "value": "1.61 L (62% predicted)", "flag": "L" },
            { "test": "FEV₁/FVC", "value": "0.81", "note": "Normal ratio — NOT obstructive. Restrictive pattern confirmed." },
            { "test": "TLC (body pleth)", "value": "3.8 L (62% predicted)", "flag": "L", "note": "Reduced TLC confirms restriction" },
            { "test": "DLCO", "value": "38% predicted", "flag": "L", "note": "⚠️ Severely reduced DLCO — impaired gas exchange. Correlates with fibrotic parenchymal destruction. Key severity marker in HP." },
            { "test": "Post-BD FEV₁ change", "value": "+3% / +60 mL", "note": "No significant bronchodilator response — not asthma/COPD" }
          ]
        },
        "serology": {
          ...
          "rows": [
            { "test": "Avian serum precipitins (budgerigar/parakeet IgG)", "value": "POSITIVE", "flag": "H", "note": "⚠️ Positive serum precipitins (IgG antibodies to avian proteins). Confirms sensitization to avian antigens. Does NOT diagnose HP alone — 40–50% of bird owners have precipitins without HP. But in context of clinical syndrome + HRCT findings = highly supportive of bird fancier's lung." },
            { "test": "Avian serum precipitins (pigeon IgG)", "value": "POSITIVE", "flag": "H" },
            { "test": "Farmer's lung precipitins (thermophilic actinomycetes)", "value": "Negative" },
            { "test": "Hot tub lung panel (M. avium complex)", "value": "Negative" },
            { "test": "ANA", "value": "1:40 (speckled)", "note": "Low-titer, non-specific. Repeat in 3 months if fibrosis confirmed — CTD-ILD must be excluded." },
            { "test": "Anti-CCP", "value": "Negative" },
            { "test": "Anti-MDA5", "value": "Negative", "note": "Important: MDA5-positive RP-ILD can mimic HP — excluded" },
            { "test": "RF", "value": "14 IU/mL (borderline)", "note": "Non-specific at this level" },
            { "test": "CBC with differential", "value": "WBC 8.4k, Eosinophils 3% (252/µL)", "note": "Eosinophilia NOT a feature of HP (key distinguishing point from eosinophilic pneumonia)" }
          ]
        }
      },
      "imaging": [
    ...
    "office": {
      ...
      "problems": [
        { "id": "prob-1", "description": "HP — antigen avoidance × 10 weeks. Partial symptomatic improvement (dyspnea at 600 feet vs 200 feet). Fibrotic pattern on HRCT — antifibrotic therapy indicated.", "status": "Active — progressing" },
        { "id": "prob-2", "description": "BAL: lymphocytosis 42% — confirms HP (normal BAL <15% lymphocytes; HP typically >30%)", "status": "Resolved — confirmed HP" }
      ],
      "medications": [
        { "id": "med-1", "name": "Nintedanib (Ofev) 150 mg", "dose": "BID with food", "route": "Oral", "indication": "Antifibrotic — FDA-approved for progressive fibrosing ILD including fibrotic HP. Slows FVC decline. NOT a cure — does not reverse fibrosis." },
        { "id": "med-2", "name": "Prednisone 40 mg", "dose": "Daily (6-week taper)", "route": "Oral", "indication": "Short-course OCS for inflammatory component — if HP has active alveolitis. Fibrotic disease responds poorly to steroids. Taper: 40mg × 2wk → 30mg × 2wk → 20mg → 10mg → off." },
        { "id": "med-3", "name": "All prior medications continued", "dose": "Unchanged" }
      ],
      "vitals": {
        "rows": [
          { "time": "3-month follow-up", "bp": "130/78", "hr": "82", "rr": "16", "spo2": "94% RA at rest (93% at initial visit)", "note": "Marginal SpO₂ improvement at rest" }
        ]
      },
      "labs": {
        "bal": {
          ...
          "rows": [
            { "test": "BAL Lymphocytes", "value": "42%", "flag": "H", "ref": "Normal <15%", "note": "⚠️ Markedly elevated BAL lymphocytes = lymphocyte-predominant alveolitis — HALLMARK of HP. Confirms active alveolitis. In chronic fibrotic HP, BAL lymphocytosis may be less dramatic than acute/subacute HP (can be 20–30% in fibrotic phase)." },
            { "test": "BAL CD4:CD8 ratio", "value": "0.8", "ref": "Normal >1.5", "note": "INVERTED CD4:CD8 ratio (<1) = characteristic of HP. Contrast: sarcoidosis CD4:CD8 typically >3.5 (CD4-predominant). This helps distinguish HP from sarcoidosis when both present with granulomatous ILD." },
            { "test": "BAL Neutrophils", "value": "8%", "note": "Mild elevation — consistent with fibrotic component" },
            { "test": "BAL Eosinophils", "value": "1%", "note": "NOT elevated — helps exclude eosinophilic pneumonia" },
            { "test": "BAL Culture", "value": "No growth" },
            { "test": "BAL Mycobacteria", "value": "Negative AFB/culture" },
            { "test": "BAL Cytology", "value": "No malignant cells" }
          ],
        ...
        "pfts_repeat": {
          ...
          "rows": [
            { "test": "FVC", "value": "1.88 L (55% predicted)", "flag": "L", "note": "Declined from 58% → 55% predicted despite antigen avoidance. Fibrotic progression ongoing." },
            { "test": "DLCO", "value": "35% predicted", "flag": "L", "note": "Declined from 38% → 35%. Progressive impairment in gas exchange. Indicates need for antifibrotic therapy." }
          ],
    ...
    "inpatient": {
      ...
      "problems": [
        { "id": "prob-1", "description": "HP — antigen avoidance × 7 months. Complete bird removal. Nintedanib × 6 months.", "status": "Chronic — stable on therapy" },
        { "id": "prob-2", "description": "Lung transplant evaluation complete. Listed for bilateral lung transplant.", "status": "Active" },
        { "id": "prob-3", "description": "Nintedanib GI side effects: diarrhea grade 1 managed with loperamide PRN. LFTs mildly elevated (1.5× ULN) — monitoring.", "status": "Active" }
      ],
      "medications": [
        { "id": "med-1", "name": "Nintedanib 150 mg BID — continued" },
        { "id": "med-2", "name": "Loperamide 2 mg PRN diarrhea" },
        { "id": "med-3", "name": "Supplemental O₂ 2L NC with exertion (now requiring 3L for ADLs)" }
      ],
      "vitals": {
        "rows": [
          { "time": "6-month follow-up", "bp": "128/76", "hr": "86", "rr": "17", "spo2": "92% RA at rest", "note": "SpO₂ 92% at rest — has declined from 94% (3-month visit). Requiring higher O₂." }
        ]
      },
      "labs": {
        "pfts_6mo": {
          ...
          "rows": [
            { "test": "FVC", "value": "1.84 L (54% predicted)", "flag": "L", "note": "Minimal decline 55% → 54% (1 percentage point in 6 months on nintedanib vs 3 points in 3 months off antifibrotic). Stabilization response." },
            { "test": "DLCO", "value": "33% predicted", "flag": "L", "note": "33% (was 35%). Continued slow decline but markedly slower than pre-treatment trajectory." },
            { "test": "6MWT distance", "value": "210 meters", "ref": "Baseline ~350m (estimated from prior activity)", "note": "Significant exercise limitation. SpO₂ nadir 81% on 6MWT — supplemental O₂ during walk required." }
          ],
        ...
        "lfts": {
          ...
          "rows": [
            { "test": "ALT", "value": "52 U/L", "flag": "H", "ref": "7–35 U/L", "note": "1.5× ULN — mild elevation. Monitor. Dose reduce to 100 mg BID if >3× ULN. Discontinue if >5× ULN." },
            { "test": "AST", "value": "44 U/L", "flag": "H", "ref": "10–40 U/L" },
            { "test": "Total bilirubin", "value": "0.8 mg/dL", "note": "Normal" }
          ]
        }
      },
