...
**Select Your Top 3-5 Diagnoses**

Students must select 3-5 diagnoses from an expanded list (12-16 options per case). Each diagnosis falls into one of four categories:
