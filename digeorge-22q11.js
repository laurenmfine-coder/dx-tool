...
window.EMR_DATA = {
  ...
  "patientHPI": "My baby has been having some trouble feeding and seems to have problems with her breathing sometimes. She also had what looked like a seizure episode yesterday which really frightened us, and I noticed her mouth looks a little different than other babies.",
    ...
    "immunizations": [
      { "name": "Hepatitis B (Birth dose)", "date": "02/01/2026", "lot": "NB-02", "site": "Right Vastus Lateralis" }
    ],
    "familyHistory": [
    ...
    "socialHistory": [
      ["Birth", "Full-term NSVD. Noted: bilateral cleft palate at delivery, small jaw (micrognathia)."],
      ["Cardiac echo at 24h", "Truncus arteriosus — referred to pediatric cardiology"],
      ["Neonatal course", "Hypocalcemia seizure on day 3 (Ca 5.8 mg/dL). Resolved with IV calcium gluconate."],
      ["Key", "Cardiac defect + hypocalcemia + palate anomaly = 22q11.2 deletion until proven otherwise"]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        { "id": "prob-1", "description": "22q11.2 deletion syndrome (DiGeorge) — newly diagnosed", "status": "Active", "onset": "Congenital", "icd10": "Q93.81" },
        { "id": "prob-2", "description": "Truncus arteriosus — surgical repair planned", "status": "Active", "onset": "Congenital", "icd10": "Q20.0" },
        { "id": "prob-3", "description": "Hypoparathyroidism — hypocalcemia (parathyroid aplasia)", "status": "Active", "onset": "Congenital", "icd10": "E20.9" },
        { "id": "prob-4", "description": "Cleft palate — surgical repair planned", "status": "Active", "onset": "Congenital", "icd10": "Q35.9" },
        { "id": "prob-5", "description": "T-cell lymphopenia — partial DiGeorge (residual thymic tissue)", "status": "Active", "onset": "Congenital", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Calcium Carbonate", "dose": "50 mg/kg/day", "route": "PO", "frequency": "Divided Q6H", "status": "Active", "prescriber": "Dr. NICU Attending" },
        { "id": "med-2", "name": "Calcitriol (1,25-OH Vitamin D)", "dose": "0.05 mcg/kg/day", "route": "PO", "frequency": "Daily", "status": "Active", "prescriber": "Dr. Endocrinology" }
      ],
      "vitals": [
        { "date": "02/22/2026", "time": "10:00", "bp": "72/44", "hr": "152", "rr": "48", "temp": "37.2°C", "spo2": "94% (room air — truncus arteriosus)", "pain": "N/A" }
      ],
      "labs": [
        {
          "date": "02/22/2026", "time": "10:15", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-402881",
          "collected": "02/22/2026 10:10", "fasting": "Not fasting",
          "facility": "Jackson Memorial Hospital", "specimenType": "Blood",
          "groups": [
            {
              "name": "CBC WITH DIFFERENTIAL",
              "results": [
                { "test": "WBC", "value": "8.2", "unit": "x10³/µL", "range": "9.0-30.0 (newborn)", "flag": "L" },
                { "test": "Lymphocytes (Absolute)", "value": "1,840", "unit": "cells/µL", "range": ">2500 (infants)", "flag": "L" },
                { "test": "Neutrophils", "value": "62%", "unit": "%", "range": "35-70", "flag": "" },
                { "test": "Hemoglobin", "value": "16.1", "unit": "g/dL", "range": "13.5-19.5", "flag": "" }
              ]
            },
            {
              "name": "LYMPHOCYTE SUBSETS (Flow Cytometry)",
              "results": [
                { "test": "CD3+ T Cells (Absolute)", "value": "820", "unit": "cells/µL", "range": ">2000 (infants)", "flag": "L" },
                { "test": "CD4+ T Cells (Absolute)", "value": "544", "unit": "cells/µL", "range": ">1500 (infants)", "flag": "L" },
                { "test": "CD8+ T Cells (Absolute)", "value": "248", "unit": "cells/µL", "range": ">500 (infants)", "flag": "L" },
                { "test": "CD19+ B Cells (Absolute)", "value": "482", "unit": "cells/µL", "range": ">200 (infants)", "flag": "" },
                { "test": "NK Cells (Absolute)", "value": "312", "unit": "cells/µL", "range": ">200 (infants)", "flag": "" },
                { "test": "T Cell Receptor (TCR) Diversity", "value": "Reduced but present — oligoclonal pattern", "unit": "", "range": "Normal polyclonal", "flag": "A" },
                { "test": "Interpretation", "value": "Partial DiGeorge — some residual thymic tissue producing T cells. NOT complete DiGeorge (where T cells are completely absent — rare). Partial DiGeorge: T cells present but reduced and oligoclonal. Immune function may improve with age.", "unit": "", "range": "", "flag": "A" }
              ]
            },
            {
              "name": "CALCIUM & PARATHYROID",
              "results": [
                { "test": "Calcium (Total)", "value": "7.4", "unit": "mg/dL", "range": "8.8-11.2 (infants)", "flag": "L" },
                { "test": "Ionized Calcium", "value": "0.88", "unit": "mmol/L", "range": "1.0-1.3 (infants)", "flag": "L" },
                { "test": "Phosphorus", "value": "7.8", "unit": "mg/dL", "range": "4.5-9.0 (infants)", "flag": "" },
                { "test": "PTH (Intact)", "value": "4", "unit": "pg/mL", "range": "10-65 (infants)", "flag": "L" },
                { "test": "25-OH Vitamin D", "value": "28", "unit": "ng/mL", "range": ">20 (sufficient)", "flag": "" },
                { "test": "Interpretation", "value": "Hypocalcemia with low PTH — hypoparathyroidism. In DiGeorge: parathyroid glands derive from 3rd/4th pharyngeal pouches — same region as thymus. Deletion disrupts both thymus AND parathyroid development.", "unit": "", "range": "", "flag": "A" }
              ]
            },
            {
              "name": "22q11.2 CHROMOSOMAL MICROARRAY",
              "results": [
                { "test": "Chromosomal Microarray Result", "value": "22q11.21 deletion — approximately 3 Mb. Heterozygous deletion encompassing TBX1 and ~30 additional genes.", "unit": "", "range": "No pathogenic copy number variant", "flag": "A" },
                { "test": "TBX1 Gene (Key Gene)", "value": "Deleted (hemizygous)", "unit": "", "range": "Normal — 2 copies", "flag": "A" },
                { "test": "Interpretation", "value": "Confirms DiGeorge/22q11.2 deletion syndrome. TBX1 is the master regulator of pharyngeal arch development — haploinsufficiency explains cardiac (aortic arch, outflow tract defects), thymus, parathyroid, and palate anomalies.", "unit": "", "range": "", "flag": "A" }
              ]
            }
          ]
        }
      ...
      "imaging": [
        {
          "id": "img-1", "date": "02/02/2026", "study": "Echocardiogram",
          "status": "Final", "priority": "Urgent",
          "orderedBy": "Dr. Neonatology", "readBy": "Dr. Pediatric Cardiology",
          "facility": "Jackson Memorial Hospital", "accession": "IMG-492938",
          ...
          "dictated": "02/02/2026 12:00", "verified": "02/02/2026 12:30"
        }
      ],
      "visits": [
        {
          "id": "visit-1", "type": "Immunology Consultation",
          "date": "02/22/2026", "provider": "Dr. Pediatric Immunology",
    ...
    "inpatient": {
      ...
      "problems": [
        { "id": "prob-1", "description": "22q11.2 deletion — post-op truncus arteriosus repair (Day 5)", "status": "Active", "onset": "Congenital", "icd10": "Q93.81" },
        { "id": "prob-2", "description": "Hypocalcemia — persistent, on calcium + calcitriol", "status": "Active", "onset": "Congenital", "icd10": "E20.9" },
        { "id": "prob-3", "description": "T-cell lymphopenia — monitoring", "status": "Active", "onset": "Congenital", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Calcium Carbonate", "dose": "50 mg/kg/day", "route": "PO", "frequency": "Q6H", "status": "Active", "prescriber": "Dr. Endocrinology" },
        { "id": "med-2", "name": "Calcitriol", "dose": "0.05 mcg/kg/day", "route": "PO", "frequency": "Daily", "status": "Active", "prescriber": "Dr. Endocrinology" },
        { "id": "med-3", "name": "TMP-SMX", "dose": "Pediatric", "route": "PO", "frequency": "3×/week — prophylaxis if T cells remain low", "status": "Active", "prescriber": "Dr. Pediatric Immunology" }
      ],
      "vitals": [
        { "date": "03/08/2026", "time": "08:00", "bp": "78/48", "hr": "148", "rr": "42", "temp": "37.3°C", "spo2": "97% (post-repair)", "pain": "N/A" }
      ],
      "labs": [
        {
          "date": "03/08/2026", "time": "07:30", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-429011",
          "collected": "03/08/2026 07:25", "fasting": "Not fasting",
          "facility": "Jackson Memorial Hospital", "specimenType": "Blood",
          "groups": [
            {
              "name": "POST-OP T-CELL MONITORING",
              "results": [
                { "test": "CD3+ T Cells", "value": "1,140", "unit": "cells/µL", "range": ">2000 (infants)", "flag": "L" },
                { "test": "CD4+ T Cells", "value": "780", "unit": "cells/µL", "range": ">1500 (infants)", "flag": "L" },
                { "test": "Note", "value": "T cells recovering compared to pre-op levels (820 → 1140 CD3+). Post-bypass lymphocyte decrease is transient and expected. Trend is upward. Continue monitoring.", "unit": "", "range": "", "flag": "A" },
                { "test": "Calcium (Total)", "value": "7.9", "unit": "mg/dL", "range": "8.8-11.2", "flag": "L" },
                { "test": "PTH (Intact)", "value": "6", "unit": "pg/mL", "range": "10-65", "flag": "L" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-2", "type": "Post-Operative Immunology Note", "date": "03/08/2026",
    ...
    "office": {
      ...
      "problems": [
        { "id": "prob-1", "description": "22q11.2 deletion (DiGeorge) — partial T-cell deficiency improving", "status": "Active", "onset": "Congenital", "icd10": "Q93.81" },
        { "id": "prob-2", "description": "Hypoparathyroidism — stable on calcium + calcitriol", "status": "Active", "onset": "Congenital", "icd10": "E20.9" },
        { "id": "prob-3", "description": "Post-truncus repair — good cardiac function", "status": "Active", "onset": "Resolved", "icd10": "" },
        { "id": "prob-4", "description": "Developmental delay — speech referral active", "status": "Active", "onset": "Congenital", "icd10": "" }
      ],
      "medications": [
        { "id": "med-1", "name": "Calcium Carbonate", "dose": "Ongoing", "route": "PO", "frequency": "Q6H", "status": "Active", "prescriber": "Dr. Endocrinology" },
        { "id": "med-2", "name": "Calcitriol", "dose": "Ongoing", "route": "PO", "frequency": "Daily", "status": "Active", "prescriber": "Dr. Endocrinology" }
      ],
      "vitals": [
        { "date": "08/01/2026", "time": "10:00", "bp": "88/56", "hr": "118", "rr": "32", "temp": "36.9°C", "spo2": "99%", "pain": "N/A" }
      ],
      "labs": [
        {
          "date": "08/01/2026", "time": "10:15", "status": "Final",
          "orderedBy": "Dr. Pediatric Immunology", "accession": "LAB-482011",
          "collected": "08/01/2026 10:10", "fasting": "Not fasting",
          "facility": "ReasonDx Medical Center", "specimenType": "Blood",
          "groups": [
            {
              "name": "T-CELL MONITORING — 6 Months",
              "results": [
                { "test": "CD3+ T Cells (Absolute)", "value": "2,240", "unit": "cells/µL", "range": ">2000 (infants)", "flag": "" },
                { "test": "CD4+ T Cells (Absolute)", "value": "1,680", "unit": "cells/µL", "range": ">1500 (infants)", "flag": "" },
                { "test": "CD8+ T Cells", "value": "520", "unit": "cells/µL", "range": ">500", "flag": "" },
                { "test": "Interpretation", "value": "T cells now in normal range. Typical partial DiGeorge trajectory — thymic tissue matures over first 6 months → T-cell recovery. Live vaccine discussion appropriate: MMR may be given NOW per ACIP guidelines for patients with partial DiGeorge whose CD4 has normalized and T-cell function confirmed. SCID spectrum (complete DiGeorge) → NO live vaccines ever.", "unit": "", "range": "", "flag": "" }
              ]
            }
          ]
        }
      ...
      "visits": [
        {
          "id": "visit-3", "type": "Immunology Follow-Up — 6 months", "date": "08/01/2026",
          "provider": "Dr. Pediatric Immunology",
