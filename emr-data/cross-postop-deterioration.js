...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Post-Hip-Replacement Day 1",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Post-Hip-Replacement Day 1",
    "acuity": 1,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "68yo Post-Hip-Replacement Day 1 \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for medicine. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) medicine assessment revealed the key discriminating features. (3) He had 4 pre-operative dental extractions for clearance 3 weeks ago. RN called because he 'looks terrible.' He is on enoxaparin since the procedure. What is your leading diagnosis, what do you order in the next 5 minutes \u2014 and is the dental history relevant to this presentation? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
