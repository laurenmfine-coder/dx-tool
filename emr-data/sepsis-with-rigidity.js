...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: urosepsis precipitating Parkinson akinetic crisis (dopaminergic withdrawal) — a syndrome mimicking neuroleptic malignant syndrome. Key learning: (1) Parkinson disease patients are uniquely vulnerable when they cannot take oral levodopa (NPO status, severe illness preventing swallowing, surgery, GI obstruction). Interruption of dopaminergic therapy for even 24-48 hours can precipitate akinetic crisis: severe worsening rigidity, bradykinesia, mutism, dysphagia, autonomic instability (fever, tachycardia, labile BP), and altered mental status. Clinically indistinguishable from NMS — both have rigidity, hyperthermia, autonomic instability, and CK elevation from muscle breakdown. The distinguishing feature: NMS arises from dopamine D2 RECEPTOR BLOCKADE (antipsychotics, antiemetics); parkinsonism-hyperpyrexia syndrome ('neuroleptic malignant-like syndrome of Parkinson disease') arises from LOSS of dopaminergic activity — the underlying pathology is the same dopamine deficiency, just from different causes. (2) The concurrent urosepsis adds complexity. Infection is a common trigger for decompensation in Parkinson patients: fever alters drug absorption and metabolism, NPO status interrupts oral medications, delirium clouds the clinical picture, and sepsis-related cytokines worsen motor symptoms. UTI is especially common in PD (from autonomic dysfunction causing incomplete bladder emptying), and urosepsis is a leading cause of hospitalization. (3) Management requires simultaneous treatment of sepsis AND restoration of dopaminergic therapy. (a) Sepsis: broad-spectrum antibiotics (ceftriaxone, piperacillin-tazobactam), IV fluids, source control (imaging for obstruction, urinary catheter drainage, possibly ureteral stent or nephrostomy if obstruction), lactate monitoring, and ICU admission if unstable. (b) Restore dopaminergic therapy URGENTLY: - Continue levodopa whenever possible — via NG tube if unable to swallow. - Parenteral apomorphine (SQ or IV) for severe akinetic crisis. - Rotigotine transdermal patch if oral not possible and apomorphine unavailable — converts to continuous dopaminergic stimulation. - Levodopa-carbidopa intestinal gel (Duopa) in patients already on it. AVOID all dopamine-blocking drugs — antiemetics (metoclopramide, prochlorperazine, promethazine) and antipsychotics (haloperidol) can precipitate or worsen crisis. Safe antiemetics in PD: ondansetron, trimethobenzamide (limited), domperidone (not in US). Safe antipsychotics for delirium in PD: quetiapine, pimavanserin, clozapine (all preserve dopaminergic activity). (c) Supportive: aggressive hydration for muscle breakdown and AKI risk, rhabdomyolysis workup and management (see rhabdomyolysis case), DVT prophylaxis, airway protection if dysphagic, and nutritional support. (4) Diagnostic clarification of the mimic. Distinguishing NMS from parkinsonism-hyperpyrexia is often impossible on clinical grounds alone. Features that suggest parkinsonism-hyperpyrexia: known PD diagnosis, recent PD medication interruption or reduction, and rapid improvement with restoration of dopaminergic therapy. Features that suggest NMS: recent initiation of or dose increase in antipsychotic/antiemetic, no underlying PD. When uncertain, hold all dopamine blockers AND restore/add dopaminergic therapy — this treats both conditions. (5) Classic pitfalls: (a) labeling the patient as 'NMS' and giving dopamine blockers as sedatives for the agitation — worsens the underlying dopamine deficiency. (b) Stopping all PD medications because of acute illness — 'medication holiday' is contraindicated in PD. (c) Using metoclopramide for sepsis-related nausea — blocks dopamine and precipitates/worsens crisis; use ondansetron. (d) Missing occult infection as trigger — always look for UTI, pneumonia, skin/wound infection, C. difficile in any PD patient with sudden worsening. (e) Forgetting that constipation, fever, dehydration, and hypoxia can all acutely worsen PD motor symptoms — address each proactively."
    }
  }
};
