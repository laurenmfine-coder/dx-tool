...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "JW Patient Refusing Transfusion",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for JW Patient Refusing Transfusion",
      "assessment": "Working diagnosis: JW Patient Refusing Transfusion",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with jw patient refusing transfusion. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
