...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Extraction Needed",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Extraction Needed",
    "acuity": 3,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "Extraction Needed \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for dentistry. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) dentistry assessment revealed the key discriminating features. (3) What does the current evidence say about dental extraction in anticoagulated patients \u2014 and what do you tell the cardiologist? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
