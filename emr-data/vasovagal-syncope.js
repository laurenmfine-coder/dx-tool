...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: vasovagal (neurocardiogenic) syncope — the most common cause of syncope. Key learning: (1) Syncope is transient loss of consciousness due to global cerebral hypoperfusion, characterized by rapid onset, short duration, and spontaneous complete recovery. Causes are classified: (a) Reflex (neurally mediated) — vasovagal (most common), situational (cough, micturition, defecation, swallowing, phlebotomy, emotional), carotid sinus. (b) Orthostatic — volume depletion, autonomic failure, medications. (c) Cardiac — arrhythmia (bradycardia/AV block, tachyarrhythmia), structural (aortic stenosis, HCM, pulmonary embolism, atrial myxoma, pericardial tamponade). (d) Cerebrovascular (rare — vertebrobasilar TIA, subclavian steal). (2) Vasovagal syncope pathophysiology. Triggered by specific precipitants (prolonged standing, heat, fear, pain, sight of blood, phlebotomy, urination) or by the Bezold-Jarisch reflex. Mechanism: vagal activation causing bradycardia and peripheral vasodilation, leading to hypotension and cerebral hypoperfusion. Classic features — a CLASSIC PRODROME: warmth, nausea, diaphoresis, visual changes ('grayout' or tunnel vision), lightheadedness, feeling faint; lasts seconds to a minute before loss of consciousness. Loss of consciousness typically brief (seconds to 1-2 minutes), with rapid recovery and potentially some fatigue afterward. Absence of post-ictal confusion, focal deficits, or tongue biting — helps distinguish from seizure. Myoclonic jerks during syncope are common and can mimic seizure — 'convulsive syncope'. (3) Workup. History is the most important — characterize the episode, triggers, prodrome, recovery, and witnessed description. Physical exam including orthostatic vitals, cardiac exam, neurologic exam, and carotid auscultation. ECG is mandatory for all syncope — look for arrhythmia, conduction abnormalities (long QT, Brugada, WPW, AV block), ventricular hypertrophy, Q waves, right heart strain, prior MI. Additional testing based on suspicion: echocardiogram (if cardiac cause suspected), Holter or event monitor for suspected arrhythmia, tilt-table test for recurrent unexplained syncope, stress testing, MRI brain and EEG if seizure suspected. Lab: BMP, CBC, sometimes troponin, BNP, D-dimer, pregnancy test — as appropriate. (4) Risk stratification. Low-risk vasovagal syncope with clear prodrome, typical trigger, normal ECG, no structural heart disease, no family history of sudden death — outpatient management. High-risk features requiring admission or intensive workup: syncope during exertion, supine syncope, syncope with palpitations, abnormal ECG, structural heart disease, family history of sudden cardiac death, age >60, lack of prodrome, injury from syncope. Validated scores: San Francisco Syncope Rule, EGSYS, OESIL, Canadian Syncope Risk Score. (5) Management of vasovagal syncope. Education — understanding triggers and prodrome is the cornerstone; patients can often abort episodes with physical counter-pressure maneuvers (leg crossing, handgrip, arm tensing) during prodrome. Lifestyle: adequate hydration (2+ L/day), liberal salt (8-10 g/day), avoiding triggers (prolonged standing, heat, dehydration), regular exercise, tilt training. Pharmacologic options for refractory cases: fludrocortisone (expands volume), midodrine (alpha agonist — most evidence), SSRI (paroxetine), beta-blocker (evidence mixed; may help specific subsets). Pacemaker for selected patients with documented cardioinhibitory type (sinus arrest or AV block during syncope). Driving restrictions — vary by jurisdiction; most recommend 1-6 months abstinence after unexplained syncope. Classic pitfalls: (a) mislabeling cardiac syncope (with brief dizziness) as 'just vasovagal' — high-risk features warrant thorough cardiac workup. (b) Missing pulmonary embolism, aortic dissection, SAH, or ACS in a patient with 'syncope' — broader differential when features don't fit vasovagal. (c) Confusing convulsive syncope with seizure — leads to unnecessary AEDs. (d) Not counseling about physical counter-pressure maneuvers and lifestyle — dramatically reduces episodes. (e) Forgetting to address driving restrictions — medicolegal requirement."
    }
  }
};
