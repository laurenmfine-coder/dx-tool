...
window.EMR_DATA = {
  "patient": {
    ...
    "pharmacy": "Walgreens — 4100 Davie Rd, Davie, FL",
    "language": "English",
      ...
      "groups": [
        {
          ...
          "results": [
            ...
            { "test": "BUN", "value": "6", "unit": "mg/dL", "range": "7-20", "flag": "L" },
            { "test": "Creatinine", "value": "0.6", "unit": "mg/dL", "range": "0.7-1.3", "flag": "L" },
            { "test": "Sodium", "value": "114", "unit": "mEq/L", "range": "136-145", "flag": "L" },
            { "test": "Potassium", "value": "3.0", "unit": "mEq/L", "range": "3.5-5.0", "flag": "L" },
            { "test": "Chloride", "value": "84", "unit": "mEq/L", "range": "98-106", "flag": "L" },
        ...
        },
        {
          ...
          "results": [
            { "test": "Serum Osmolality", "value": "238", "unit": "mOsm/kg", "range": "275-295", "flag": "L" },
            { "test": "Urine Osmolality", "value": "48", "unit": "mOsm/kg", "range": "300-900", "flag": "L" },
            { "test": "Urine Sodium", "value": "8", "unit": "mEq/L", "range": "20-200", "flag": "L" },
            { "test": "Urine Specific Gravity", "value": "1.002", "unit": "", "range": "1.005-1.030", "flag": "L" }
          ]
        },
        {
          ...
          "results": [
            ...
            { "test": "ANC", "value": "3,800", "unit": "/µL", "range": ">1500", "flag": "" },
  ...
  "immunizations": [
    { "vaccine": "Influenza (Fluarix Quadrivalent)", "date": "10/2024", "site": "Left deltoid IM", "lot": "FL899K", "mfr": "GSK" },
    { "vaccine": "COVID-19 (Moderna, updated)", "date": "10/2024", "site": "Right deltoid IM", "lot": "CV902T", "mfr": "Moderna" },
    { "vaccine": "Tdap (Adacel)", "date": "06/2022", "site": "Left deltoid IM", "lot": "TA228R", "mfr": "Sanofi" }
  ],
  "familyHistory": [
  ...
  "socialHistory": [
    ["Occupation", "Disabled — SSI; unable to work due to chronic mental illness"],
    ["Marital", "Single; never married; lives in supervised group home (6 residents)"],
    ["Tobacco", "1 PPD x 12 years"],
    ["Alcohol", "Denies current use"],
    ["Drugs", "Denies"],
    ["Exercise", "Walks within group home and to nearby park with staff supervision"],
    ["Housing", "Licensed assisted living facility / group home; 24-hour staff supervision"],
    ["Safety", "No firearms; supervised environment; water access monitored but not fully restricted"],
    ["Advance Directive", "Healthcare proxy: Karen Dunn (mother)"]
  ],
  "meta": {
