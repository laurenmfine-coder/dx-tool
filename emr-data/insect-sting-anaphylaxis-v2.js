...
,"references":[
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Miguel Herrera-Santos is alert and cooperative, clearly concerned but provides a clear history.",
    "interviewQuestions": [
    ...
    "patientResponses": {
        ...
        "allergies": "'My allergies: Wasp venom.'",
        "family": "Non-contributory",
        "social": "Occupation: Landscape worker \u2014 daily outdoor insect exposure, cannot change careers  Insurance: Uninsured \u2014 cannot afford EpiPen ($600) or VIT ($200-400/visit)  Income: $15/hr, family of 5  Language: Spanish only  Risk: Without VIT, 60% recurrence risk with next sting"
    },
    "examManeuvers": [
        "General appearance",
        "Vital signs",
    ...
    "coachPrompts": {
        "phase2": "Before interviewing Miguel Herrera-Santos: what does the chart suggest? Top 3 diagnoses?",
