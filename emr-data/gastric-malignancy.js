...
window.EMR_DATA = {
  ...
  "labs": [
    {
      ...
      "groups": [
        ...
        },
        {
          ...
          "results": [
            {
              "test": "Fecal Occult Blood (Guaiac) #1",
              "value": "Positive",
              "unit": "",
              "range": "Negative",
              "flag": "H"
            ...
            {
              "test": "Fecal Occult Blood (Guaiac) #2",
              "value": "Positive",
              "unit": "",
              "range": "Negative",
              "flag": "H"
            ...
            {
              "test": "Fecal Occult Blood (Guaiac) #3",
              "value": "Positive",
              "unit": "",
              "range": "Negative",
              "flag": "H"
  ...
  "socialHistory": [
    [
      "Occupation",
      "Retired electrical engineer; retired 2016"
    ],
    [
      "Marital",
      "Married 48 years"
    ...
    [
      "Alcohol",
      "Occasional sake — 1-2 times per month"
    ],
    [
      "Drugs",
      "Denies"
    ...
    [
      "Exercise",
      "Daily walks with wife (30 min); tai chi 2x/week — recently reduced due to fatigue"
    ],
    [
      "Housing",
      "Condominium with wife; single-level"
    ],
    [
      "Safety",
    ...
    [
      "Advance Directive",
      "Living will signed; Full code; DPOA designated (wife Yuki)"
    ]
  ],
  "meta": {
