...
window.EMR_DATA = {
  ...
  "guided": {
    "coachPrompts": {
      "final": "Diagnosis: severe CRSwNP with AERD, post-FESS polyp recurrence, initiating dupilumab with planned aspirin desensitization. Key learning: (1) Polyp recurrence after FESS is common in AERD — up to 90% recur within 5 years without disease-modifying therapy. Surgery clears the mechanical obstruction but does not address the underlying type 2 inflammation, which is why a medical strategy is essential. The modern treatment paradigm is: topical intranasal corticosteroids (first line), short courses of oral corticosteroids for acute flares, then escalation to biologics and/or aspirin desensitization for steroid-dependent or recurrent disease. (2) Dupilumab mechanism: monoclonal antibody against IL-4Ra, blocking signaling from both IL-4 and IL-13. It addresses the core type 2 inflammatory axis driving polyp formation, mucus hypersecretion, and goblet cell hyperplasia. SINUS-24 and SINUS-52 trials demonstrated significant reductions in nasal polyp score, nasal congestion score, and Lund-Mackay CT score, with measurable smell recovery within weeks. Dosing for CRSwNP is 300 mg SQ every 2 weeks. (3) Safety considerations: dupilumab can cause transient eosinophilia (usually clinically insignificant but monitor), conjunctivitis (counsel patients; treat with lubricating drops or topical therapy), and rare joint symptoms. It is not associated with immunosuppression, infection risk, or malignancy in long-term data to date. (4) Aspirin desensitization (ASD) offers disease modification beyond symptom control. The protocol typically escalates doses (e.g., 40 mg to 81 to 162 to 325 mg) over 1-2 days under continuous monitoring with rescue medications ready. Maintenance dose is usually 325-650 mg BID, taken indefinitely — any interruption over 48 hours requires re-desensitization. Combining dupilumab with ASD is increasingly common and well tolerated; some centers initiate dupilumab first to optimize airway status, then proceed to ASD. (5) Pitfall: underestimating the quality-of-life impact of anosmia. For many AERD patients, smell loss is more distressing than nasal obstruction — they cannot smell food, their children, or smoke (a safety concern). Counsel patients that smell recovery with dupilumab is real but variable (30-60% regain meaningful olfaction within 6 months), and document baseline and follow-up smell testing (UPSIT, Sniffin' Sticks). Finally: united airway disease means asthma control and rhinitis control rise and fall together — optimize both, always."
    }
  }
};
