...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: peritonsillar abscess (PTA, 'quinsy') — the most common deep neck space infection in adolescents and young adults. Key learning: (1) PTA is a collection of pus in the potential space between the tonsillar capsule and the superior constrictor muscle, typically arising from progression of bacterial tonsillitis. Microbiology is polymicrobial: group A Streptococcus is the most common single pathogen; mixed with oral anaerobes (Fusobacterium, Prevotella, Peptostreptococcus), Staphylococcus (including MRSA), and other streptococci. Fusobacterium necrophorum is a particularly important anaerobe because it can lead to Lemierre syndrome (septic thrombophlebitis of the internal jugular vein with septic emboli — see pitfalls). (2) Presentation — often in a patient with 3-7 days of worsening sore throat: severe unilateral throat pain, dysphagia and drooling, trismus (jaw muscle spasm from pterygoid irritation), muffled 'hot potato' voice, ipsilateral ear pain, fever, tender cervical lymphadenopathy. Exam: unilaterally enlarged tonsil displaced medially and inferiorly, uvular deviation to the contralateral side, bulging of the soft palate above the tonsil. Distinguish from peritonsillar cellulitis (no discrete pus collection — treated with antibiotics alone, often indistinguishable on exam without imaging or aspiration). (3) Workup. Clinical diagnosis is often sufficient in a classic presentation. CT neck with IV contrast for atypical presentations, suspected deeper extension (parapharyngeal or retropharyngeal), failed needle aspiration, or severe trismus preventing adequate exam. Intraoral ultrasound is an emerging, radiation-free alternative. Labs: CBC (leukocytosis), CMP, monospot or EBV serology (can mimic — though can also coexist; steroids used liberally if EBV tonsillitis). Rapid strep testing of the tonsil exudate. (4) Management. Drainage by needle aspiration (18-gauge needle, guarded to prevent deep penetration into the carotid) or incision and drainage is the mainstay — usually performed at the bedside under local anesthesia. Send pus for Gram stain and culture. Empiric antibiotics: ampicillin-sulbactam IV, clindamycin, or amoxicillin-clavulanate for less severe outpatient cases. Penicillin-allergic: clindamycin. Add vancomycin if severe illness, failure to improve, or MRSA concern. Dexamethasone 10 mg IV reduces pain and swelling and is now routine. Hydration, analgesia, and close monitoring. Tonsillectomy (Quinsy tonsillectomy, either acute or delayed) is considered for recurrent PTA, concurrent airway compromise, or difficult drainage. (5) Classic pitfalls: (a) missing LEMIERRE SYNDROME — in a patient with PTA or pharyngitis (often from Fusobacterium necrophorum) who develops neck pain, fever, and sepsis, suspect septic thrombophlebitis of the internal jugular vein. CT neck with contrast identifies the thrombus; septic pulmonary emboli are common; treatment is prolonged antibiotics (penicillin + metronidazole or piperacillin-tazobactam) for weeks, with anticoagulation controversial. (b) Carotid artery injury during needle aspiration — always use a guarded needle and aspirate along the tonsillar pillar, not posterior. (c) Discharging a patient who cannot tolerate oral intake or has persistent trismus — admit for IV hydration and antibiotics. (d) Not considering airway compromise in bilateral PTA or very large unilateral abscess — early ENT consultation and preparation for airway intervention. (e) Missing mononucleosis in a young adult with tonsillar swelling — avoid amoxicillin (rash) and counsel activity restriction for splenic rupture prevention."
    }
  }
};
