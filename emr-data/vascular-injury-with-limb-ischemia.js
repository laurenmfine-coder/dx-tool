...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: popliteal artery injury with acute limb ischemia from displaced supracondylar femur fracture after high-speed MVC. Key learning: (1) Vascular injury is a critical complication of lower-extremity trauma, particularly at anatomic 'tethering points' where arteries are relatively fixed: popliteal artery in posterior knee (supracondylar femur fracture, knee dislocation — up to 20-30% with popliteal injury, the highest of any joint dislocation), common femoral artery in groin, brachial artery in elbow, and axillary artery in shoulder dislocation. Acute limb ischemia from vascular injury is a time-critical emergency — warm ischemia time of 6 hours is the classic threshold before irreversible tissue injury, though skin and subcutaneous tissue tolerate longer than muscle and nerve. (2) Classic 'hard signs' of vascular injury (any one warrants emergent operative intervention): (a) Active pulsatile bleeding. (b) Absent distal pulses. (c) Expanding or pulsatile hematoma. (d) Audible bruit or palpable thrill. (e) Distal ischemia (5 Ps: pain, pallor, paresthesias, pulselessness, poikilothermia). 'Soft signs' (stable hematoma, proximity of wound to vessel, minor isolated distal pulse deficit with normal ABI, history of significant bleeding at scene, injury at anatomic hazard point) warrant workup but not immediate OR. (3) Workup. Ankle-brachial index (ABI) or Injured Extremity Index (comparing injured to uninjured limb): <0.9 is abnormal in adults and suggests vascular injury; 100% sensitivity and >95% specificity when combined with clinical exam. CT angiography: definitive imaging — identifies arterial injury, level, extent, and guides operative planning. Conventional angiography historically the gold standard, now reserved for intraoperative assessment or interventional repair. Duplex ultrasound: operator-dependent, less sensitive for small injuries. (4) Management. (a) Airway, breathing, circulation (polytrauma workup) — vascular injury does not take precedence over airway or massive central bleeding. (b) Reduce and immobilize fractures and dislocations — can restore perfusion if vascular compromise is from mechanical compression; reassess pulses after reduction. (c) Emergent vascular surgery consultation for revascularization — options include primary repair, vein interposition graft (reversed saphenous vein most common), prosthetic graft (less preferred due to infection risk), endovascular stent (for selected injuries). (d) Concurrent orthopedic stabilization — often damage control with external fixation first, definitive ORIF after vascular repair. (e) Prophylactic FASCIOTOMY of all four compartments of the leg at time of repair — prolonged ischemia with reperfusion risks compartment syndrome from reperfusion edema. (f) Anticoagulation during and after repair (heparin intraop, then antiplatelet post-op) to maintain graft patency. (g) IV antibiotics for open injury and surgical prophylaxis. Reperfusion monitoring: compartment pressures, creatine kinase (rhabdomyolysis), potassium (reperfusion hyperkalemia), acid-base (reperfusion acidosis). (5) Prognosis and complications. Amputation rate for popliteal injury: 10-25% overall, with higher rates if ischemia >6 hours, concurrent severe nerve injury (tibial or peroneal nerve), severe soft tissue loss, or infection. Outcomes improve substantially with organized trauma system approach, rapid diagnosis, and prompt revascularization. Long-term: graft patency surveillance with duplex ultrasound, rehabilitation for motor and sensory deficits, management of possible chronic pain. Classic pitfalls: (a) accepting 'palpable pulse' or 'normal Doppler' as sole evidence of vascular integrity — always check ABI and have low threshold for CTA in knee dislocation, supracondylar femur fractures, and any soft-sign injuries. (b) Delaying revascularization for full orthopedic fixation — vascular takes priority in limb-threatening ischemia; use damage control orthopedics. (c) Omitting fasciotomy — compartment syndrome after revascularization can cost the limb. (d) Missing concurrent nerve injury (peroneal, tibial) — poor functional outcome even with patent vascular repair. (e) Forgetting that 'spontaneous reduction' of a knee dislocation doesn't exclude vascular injury — any suspected knee dislocation should have ABI and vascular imaging even if the knee has reduced before arrival."
    }
  }
};
