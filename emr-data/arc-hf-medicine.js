...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for medicine. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) medicine assessment revealed the key discriminating features. (3) Dorothy has been hospitalized three times this year for decompensated HF. Her EF is 28% and her GDMT doses are sub-optimal: metoprolol 25mg (target 200mg), lisinopril 5mg (target 40mg). Her Cr is 1.6. Why has GDMT not been uptitrated \u2014 and what is your systematic plan to reach target doses over the next 3 months while monitoring her creatinine? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
