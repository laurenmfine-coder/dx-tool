...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for pharmacy. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) pharmacy assessment revealed the key discriminating features. (3) Kevin's Opioid Risk Tool score is 8 (high risk). He has been on oxycodone for 9 months with no functional improvement. He is requesting a dose increase. Using the pharmacological evidence \u2014 explain why escalating opioids in this scenario may cause opioid-induced hyperalgesia, and design a realistic 3-month multimodal analgesic taper plan with specific alternatives at each step. (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
