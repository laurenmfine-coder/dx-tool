...
window.EMR_DATA = {
  "base": {
    ...
    "allergies": [
      {
        "allergen": "Aspirin",
        "reaction": "Facial flushing, nasal congestion, bronchospasm within 45 min of 325mg aspirin",
        "severity": "Severe",
        "type": "NSAID-ERD (COX-1)"
      },
      {
        "allergen": "Ibuprofen",
        "reaction": "Same reaction as aspirin — congestion and wheeze",
        "severity": "Severe",
        "type": "NSAID-ERD (COX-1)"
      },
      {
        "allergen": "Naproxen",
        "reaction": "Nasal blockade and chest tightness",
    ...
    "socialHistory": [
      ...
      [
        "Occupation",
        "Registered Nurse — 18 years. Works ICU. Exposure to cleaning agents (quaternary ammonium compounds). Not identified as OA trigger."
      ],
      [
        "Housing",
        "Single-family home. No pets. Central AC. Lives with husband and 3 children."
      ],
      [
        "Anosmia",
        "Complete loss of smell × 3 years. Partial taste loss. Cannot detect smoke detector alarm — smoke safety concern flagged."
      ],
      [
        "NSAID history",
        "First aspirin reaction age 36 — ibuprofen for headache → immediate nasal blockade + wheeze. Has avoided all NSAIDs since. Uses acetaminophen exclusively."
      ],
      [
        "Prior procedures",
        "FESS (bilateral, 2022) — initial improvement in nasal breathing for 4 months, then complete polyp recurrence by month 8."
      ]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "Chronic rhinosinusitis with nasal polyps (CRSwNP) — bilateral, grade 3",
          "status": "Active",
          "onset": "Chronic"
        },
        {
          "id": "prob-2",
          "description": "AERD (Aspirin-Exacerbated Respiratory Disease) / Samter's Triad — asthma + nasal polyps + NSAID-ERD",
          "status": "Active",
          "onset": "Chronic"
        },
        {
          "id": "prob-3",
          "description": "Asthma — moderate persistent, on fluticasone 220 mcg BID + albuterol PRN",
          "status": "Active",
          "onset": "Chronic"
        },
        {
          "id": "prob-4",
          "description": "Anosmia — complete × 3 years. Significant QOL impact.",
          "status": "Active",
          "onset": "Chronic"
        },
        {
          "id": "prob-5",
          "description": "Aspirin/NSAID hypersensitivity — all COX-1 inhibitors contraindicated",
          "status": "Active",
          "onset": "Chronic"
        }
      ],
      "medications": [
        {
          "id": "med-1",
          "name": "Fluticasone propionate 220 mcg",
          "dose": "2 puffs BID",
          "route": "Inhaled",
        ...
        },
        {
          ...
          "route": "Intranasal",
          "indication": "CRSwNP — inadequate response to date"
        },
        {
          "id": "med-3",
        ...
        },
        {
          ...
          "dose": "PRN",
          "route": "Oral",
          "indication": "Safe analgesic for AERD"
        }
      ],
      "vitals": {
        "rows": [
      ...
      "labs": {
        "ct_sinus": {
          ...
          "rows": [
            {
              "test": "Lund-Mackay Score",
              "value": "21 / 24",
              "flag": "H",
              "ref": "0 = no disease; 24 = maximum opacification",
              "note": "Severe CRSwNP. Score >12 is threshold for surgical candidacy."
            },
            {
              "test": "Bilateral ethmoid sinuses",
              "value": "Near-complete opacification",
              "note": "Ethmoid disease is hallmark of CRSwNP and AERD — eosinophilic inflammation preferentially affects anterior ethmoids"
            },
            {
              "test": "Bilateral maxillary sinuses",
              "value": "80% opacified, bilateral mucosal thickening",
              "flag": "H"
            },
            {
              "test": "Bilateral nasal cavities",
              "value": "Bilateral soft tissue masses (polyps) filling nasal cavities bilaterally — grade 3",
              "flag": "H"
            },
            {
              "test": "Frontal sinuses",
              "value": "Partial opacification bilaterally"
            },
            {
              "test": "Sphenoid sinuses",
              "value": "Mild mucosal thickening"
            },
            {
              "test": "Bony structures",
              "value": "No erosion. Lamina papyracea intact. Skull base intact.",
              "note": "Important to confirm no erosion before surgical planning"
            }
          ],
        ...
        "nasal_endoscopy": {
          ...
          "rows": [
            {
              "test": "Nasal polyp grade (Lund-Kennedy)",
              "value": "Grade 3 bilaterally",
              "flag": "H",
              "note": "Grade 3 = polyps completely obstructing nasal cavity. Scale 0–3 per side."
            },
            {
              "test": "Middle meatus",
              "value": "Completely occluded by polypoid tissue bilaterally"
            },
            {
              "test": "Inferior turbinate",
              "value": "Hypertrophic bilaterally, mucosal edema"
            },
            {
              "test": "Mucus quality",
              "value": "Thick, tenacious mucus bilaterally — characteristic of eosinophilic CRS"
            },
            {
              "test": "Septal deviation",
              "value": "Mild left-sided deviation — not clinically significant"
            }
          ]
        },
        "labs_ent": {
          ...
          "rows": [
            {
              ...
              "flag": "H",
              "ref": "<500",
              "note": "Elevated — consistent with Type 2/eosinophilic CRSwNP. Predicts poor surgical outcome without biologic treatment."
            },
            {
              "test": "Total IgE",
              "value": "284",
            ...
            },
            {
              ...
              "flag": "H",
              "ref": "<100 pg/mg (normal); >1,000 = AERD-range",
              "note": "Markedly elevated. LTE₄ is the urinary metabolite of leukotriene C₄ — the master mediator of AERD. LTE₄ >1,000 pg/mg in symptomatic AERD patients is well-documented. Confirms leukotriene overproduction."
            },
            {
              "test": "FeNO",
              "value": "44",
              ...
              "flag": "H",
              "ref": "<25 ppb normal",
              "note": "Elevated FeNO — Type 2 airway inflammation present in lower airway also. United airway confirmed."
            }
          ]
        }
      },
    ...
    "office": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "Postoperative AERD bronchospasm — ketorolac administered despite documented NSAID allergy. Near-miss medication error.",
          "status": "Resolved",
          "onset": "Acute"
        },
        {
          "id": "prob-2",
          "description": "FESS — bilateral polypectomy + ethmoidectomy + antrostomy completed successfully",
          "status": "Resolving"
        },
        {
          "id": "prob-3",
          "description": "CRSwNP — significant polyp burden removed. Pathology ordered.",
          "status": "Active"
        }
      ],
      "medications": [
        {
          "id": "med-1",
          "name": "Methylprednisolone 125 mg IV",
          "dose": "Single dose — AERD exacerbation",
          "route": "IV",
          "indication": "Acute AERD bronchospasm from ketorolac"
        },
        {
          "id": "med-2",
          "name": "Albuterol 2.5 mg",
          "dose": "Continuous nebulization × 30 min",
          "route": "Nebulized",
          "indication": "Acute bronchospasm reversal"
        },
        {
          "id": "med-3",
          ...
          "dose": "Daily × 7 days",
          "route": "Oral",
          "indication": "Postoperative anti-inflammatory + AERD exacerbation recovery"
        },
        {
          "id": "med-4",
          "name": "Saline nasal irrigation",
          "dose": "BID (beginning POD 2)",
          "route": "Intranasal",
          "indication": "Post-FESS wound care"
        },
        {
          "id": "med-5",
          "name": "Acetaminophen 500 mg",
          "dose": "q6h PRN pain",
          "route": "Oral",
          "indication": "NSAID-safe analgesia — documented in chart after error"
        }
      ],
      "vitals": {
        "rows": [
          {
            "time": "PACU (post-ketorolac)",
            "bp": "156/94",
            "hr": "118",
            "rr": "28",
            "spo2": "89% RA",
            "note": "Acute bronchospasm"
          },
          {
            "time": "30 min post-treatment",
            "bp": "138/86",
            "hr": "96",
            "rr": "18",
            "spo2": "96% 2L NC"
      ...
      "labs": {
        "pathology": {
          ...
          "rows": [
            {
              "test": "Gross description",
              "value": "Multiple glistening polypoidal fragments, bilateral, total 8.4g"
            },
            {
              "test": "Eosinophil density (tissue)",
              "value": ">100 eosinophils / high-power field (HPF)",
              "flag": "H",
              "note": "ECES (eosinophilic CRS) confirmed. Threshold for eosinophilic CRS = >10 eos/HPF. >100 = marked eosinophilia — highest-risk category for recurrence without biologic."
            },
            {
              "test": "Edematous stroma",
              "value": "Present — extensive stromal edema with Charcot-Leyden crystals",
              "note": "Charcot-Leyden crystals = breakdown products of eosinophil granules. Pathognomonic of intense eosinophilic inflammation."
            },
            {
              "test": "Fungal elements",
              "value": "ABSENT — no fungal hyphae on GMS stain",
              "note": "ABPA/fungal sinusitis excluded"
            },
            {
              "test": "Dysplasia/malignancy",
              "value": "ABSENT"
            }
          ],
    ...
    "inpatient": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "AERD — aspirin desensitization completed (see procedure note). Now on aspirin 325 mg daily.",
          "status": "Controlled"
        },
        {
          "id": "prob-2",
          "description": "CRSwNP — post-FESS improvement. Biologic initiated to prevent recurrence.",
          "status": "Active/Treating"
        },
        {
          "id": "prob-3",
          "description": "Asthma — well controlled on ICS. FEV₁ 84% predicted.",
          "status": "Controlled"
        },
        {
          "id": "prob-4",
          "description": "Partial olfactory return post-FESS — improvement noted.",
          "status": "Improving"
        }
      ],
      "medications": [
        {
          "id": "med-1",
          "name": "Dupilumab (Dupixent) 300 mg/2 mL",
          "dose": "300 mg SC loading (2×150) then 300 mg SC q4w (CRSwNP dosing)",
          "route": "Subcutaneous",
          "indication": "CRSwNP + asthma — anti-IL-4Rα. NOTE: CRSwNP dose = 300 mg q4w (different from asthma dose 200 mg q2w)."
        },
        {
          "id": "med-2",
          "name": "Aspirin 325 mg",
          "dose": "Daily (maintained post-desensitization)",
          "route": "Oral",
          "indication": "AERD disease-modifying therapy — reduces polyp recurrence, improves nasal patency, reduces leukotriene production when continued daily"
        },
        {
          "id": "med-3",
          "name": "Fluticasone nasal spray 50 mcg",
        ...
        {
          "id": "med-4",
          "name": "Budesonide nasal rinse 0.5 mg/2 mL",
          "dose": "1 vial per nostril via neti pot once daily",
          "route": "Intranasal",
          "indication": "Post-FESS high-volume nasal steroid delivery — superior to spray after FESS opens sinuses"
        },
        {
          "id": "med-5",
          "name": "Saline nasal irrigation",
        ...
        {
          "id": "med-6",
          "name": "Fluticasone inhaled 220 mcg",
          "dose": "2 puffs BID",
          "route": "Inhaled",
          "indication": "Asthma controller"
        }
      ...
      "labs": {
        "aspirin_desensitization": {
          ...
          "rows": [
            {
              "test": "Pre-procedure FEV₁",
              "value": "2.94 L (84% predicted)",
              "note": "Adequate baseline for ASD — FEV₁ ≥70% required before initiating"
            },
            {
              "test": "Pre-procedure SpO₂",
              "value": "98% RA"
            },
            {
              "test": "Premedication",
              "value": "Montelukast 10 mg PO (night before + morning of). NO antihistamine premedication — would mask nasal symptoms used to detect threshold.",
              "note": "Montelukast reduces leukotriene-mediated reaction during ASD without masking nasal symptoms."
            },
            {
              "test": "Dose 1 (60 mg aspirin)",
              "value": "Administered 08:30. No reaction. FEV₁ 2.91L at 90 min.",
              "note": "Starting dose 60 mg — below threshold for most AERD patients. Observe 90 min per dose."
            },
            {
              "test": "Dose 2 (100 mg aspirin)",
              "value": "Administered 10:15. Mild nasal congestion at 60 min — rhinorrhea, increased nasal resistance. NO bronchospasm. FEV₁ unchanged (2.89 L). Oxymetazoline 2 sprays per nostril → rapid resolution. Proceeded.",
              "note": "Nasal reaction at 100 mg = threshold dose confirmed. Managed nasally. No systemic reaction."
            },
            {
              "test": "Dose 3 (160 mg aspirin)",
              "value": "Administered 12:00. Mild nasal congestion again — treated with oxymetazoline. No systemic reaction. FEV₁ 2.86L.",
              "note": "Continued desensitization protocol despite nasal reaction — nasal-only reactions are expected and manageable."
            },
            {
              "test": "Dose 4 (325 mg aspirin)",
              "value": "Administered 13:30. Mild nasal congestion — treated. No bronchospasm. FEV₁ 2.88L (stable). DESENSITIZED to 325 mg.",
              "note": "Full therapeutic dose achieved."
            },
            {
              "test": "Post-procedure status",
              "value": "Desensitization complete. Patient discharged with aspirin 325 mg daily prescription and instructions for strict daily continuation.",
              "note": "CRITICAL: Aspirin must be taken EVERY DAY without interruption. Missing >48h causes re-sensitization and requires full repeat protocol."
            }
          ],
        ...
        "biologic_rationale": {
          ...
          "rows": [
            {
              "test": "Indication: CRSwNP",
              "value": "FDA-approved for CRSwNP — reduces polyp size, improves sense of smell, reduces need for OCS/surgery",
              "note": "SINUS-52 trial: 57% reduction in nasal polyp score vs placebo. Sense of smell improved in 50% of patients (placebo 20%)."
            },
            {
              "test": "Indication: Comorbid asthma",
              "value": "Dual-approved for both CRSwNP and asthma — addresses united airway disease with one biologic",
              "note": "Only biologic with approval in both CRSwNP + asthma + atopic dermatitis + EoE"
            },
            {
              "test": "AERD: mechanism benefit",
              "value": "IL-4 and IL-13 drive leukotriene overproduction in AERD. Dupilumab blocks IL-4Rα → reduces IL-4/IL-13 signaling → less arachidonic acid shunting → reduced LTC4/LTD4 production",
              "note": "Dupilumab reduces urinary LTE4 in AERD patients. Complementary to aspirin desensitization (different mechanism)."
            },
            {
              "test": "Blood eos threshold met",
              "value": "680 cells/µL (threshold ≥150 OR FeNO ≥25)",
              "note": "Both thresholds exceeded."
            },
            {
              "test": "Dose for CRSwNP",
              "value": "300 mg SC q4 weeks (vs 200 mg q2w for asthma-only indication)",
              "note": "CRSwNP dosing = 300 mg q4w. If patient had asthma alone, dose would be 200 mg q2w. Combined disease — q4w preferred for convenience, adequate for both."
            }
          ]
        },
          ...
          "rows": [
            {
              "test": "FEV₁",
              "value": "2.94 L (84% predicted)",
              "note": "Improved from pre-FESS baseline (76% predicted). Upper airway patency improvement → reduced mouth breathing → improved lower airway humidification."
            },
            {
              "test": "FEV₁/FVC",
              "value": "0.78"
            },
            {
              "test": "Post-BD FEV₁",
              "value": "3.02 L (86%)",
              "note": "Minimal BD response — asthma well controlled."
            }
          ]
        }
      },
  ...
  "guided": {
    "coachPrompts": {
      "final": "Diagnosis: severe CRSwNP with AERD (aspirin-exacerbated respiratory disease, Samter's Triad). Key learning: (1) Samter's Triad is the combination of chronic rhinosinusitis with nasal polyps, asthma, and NSAID hypersensitivity. It represents a COX-1-mediated eicosanoid dysregulation: inhibition of COX-1 shunts arachidonic acid toward cysteinyl leukotrienes, triggering nasal and bronchial inflammation. Classic presentation is a middle-aged adult with refractory polyposis, anosmia, and asthma who reacts to aspirin or NSAIDs within 30-90 minutes. (2) Diagnosis is clinical (history of reproducible NSAID reaction plus polyps plus asthma); confirmation can be done with graded aspirin challenge in a monitored setting when the diagnosis is uncertain. CT sinus typically shows pansinus opacification and polypoid mucosal thickening; endoscopy reveals grade 2-3 polyps. (3) Biologic selection for CRSwNP is now evidence-based. Dupilumab (anti-IL-4Ra, blocks type 2 inflammation) has the strongest data for CRSwNP with asthma and is first line for polyp reduction, asthma control, and smell recovery (SINUS-24/52 trials). Omalizumab (anti-IgE) is reasonable when allergic asthma dominates. Mepolizumab and benralizumab (anti-IL-5 axis) are options when eosinophilia is the dominant driver but are less potent for polyps than dupilumab. (4) Aspirin desensitization remains a powerful option in AERD: after desensitization, daily aspirin (typically 325-650 mg BID) suppresses leukotriene-driven inflammation, reduces polyp recurrence, and decreases systemic steroid need. It requires commitment (daily therapy indefinitely, cannot be interrupted), adequate asthma control before initiation, and access to a supervised protocol. Dupilumab and aspirin desensitization can be complementary; the choice depends on asthma severity, cost, tolerance, and patient preference. (5) Classic pitfall: treating isolated rhinosinusitis with repeated antibiotic courses without recognizing the unified airway. Any patient with recurrent polyps should be asked explicitly about NSAID reactions; many patients have simply avoided NSAIDs for years without a formal diagnosis. Counsel all AERD patients to avoid all COX-1 inhibitors (aspirin, ibuprofen, naproxen, ketorolac) and to use acetaminophen or selective COX-2 inhibitors (celecoxib) when analgesia is needed. Anosmia recovery is often the most meaningful patient-centered outcome — track it formally with a smell identification test at baseline and follow-up."
    }
  }
};
