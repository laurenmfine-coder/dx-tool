/* emr-data/idiopathic-angioedema.js — Multi-Setting Allergy Case: Idiopathic Angioedema */
window.EMR_DATA = {
  "base": {
    "patient": {
  ...
  "encounters": {
    "ed": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "Idiopathic Angioedema",
          "status": "Active",
          "onset": "Chronic",
          "icd10": ""
        }
      ...
      "visits": [
        {
          ...
          "cc": "Third episode facial swelling in 2 months — no trigger identified",
          "hpi": "Daniel Castillo-Perez presents with third episode facial swelling in 2 months — no trigger identified.",
    ...
    "inpatient": {
      "patient": {
        "chiefComplaint": "Admitted for Idiopathic Angioedema management",
        "diagnosis": "Idiopathic Angioedema"
      },
      "problems": [
        {
      ...
      "visits": [
        {
          ...
          "date": "03/02/2026",
          "provider": "Dr. Attending",
          "cc": "Admitted for Idiopathic Angioedema management",
          "hpi": "Daniel Castillo-Perez — Admitted for Idiopathic Angioedema management",
          "exam": "See documentation.",
          "assessment": "See assessment.",
          "plan": "See orders."
        }
    ...
    "consult": {
      "patient": {
        "chiefComplaint": "A/I consult — recurrent idiopathic angioedema, escalation plan",
        "diagnosis": "Idiopathic Angioedema"
      },
      "problems": [
        {
      ...
      "visits": [
        {
          ...
          "cc": "A/I consult — recurrent idiopathic angioedema, escalation plan",
          "hpi": "Daniel Castillo-Perez presents with a/i consult — recurrent idiopathic angioedema, escalation plan.",
          "exam": "See documentation.",
          "assessment": "See assessment.",
          "plan": "See orders."
        }
    ...
    "clinic": {
      "patient": {
        "chiefComplaint": "Follow-up — angioedema frequency on uptitrated antihistamines",
        "diagnosis": "Idiopathic Angioedema"
      },
      "problems": [
        {
      ...
      "medications": [
        {
          ...
          "dose": "300mg",
          "route": "SC",
          "frequency": "Q4 weeks (if refractory)",
          "status": "Active",
          "prescriber": "Dr. Elena Rodriguez, MD"
        },
        {
      ...
      "visits": [
        {
          ...
          "date": "03/02/2026",
          "provider": "Dr. Attending",
          "cc": "Follow-up — angioedema frequency on uptitrated antihistamines",
          "hpi": "Daniel Castillo-Perez presents with follow-up — angioedema frequency on uptitrated antihistamines.",
          "exam": "See documentation.",
          "assessment": "See assessment.",
          "plan": "See orders."
        }
