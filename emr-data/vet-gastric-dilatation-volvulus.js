...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Acute Abdominal Distension",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Acute Abdominal Distension",
    "acuity": 1,
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for vet. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) vet assessment revealed the key discriminating features. (3) GDV is minutes-to-death. What is your immediate stabilization sequence \u2014 and at what point is surgery the only option? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
