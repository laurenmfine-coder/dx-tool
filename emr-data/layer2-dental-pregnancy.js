...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Second Trimester Pregnant Patient",
    "race": "Middle Eastern",
    "address": "6201 Stirling Rd, Cooper City, FL 33328",
    "phone": "(954) 555-3137",
    "email": "jordanle@email.com",
    "emergencyContact": {
      "name": "Robert Chen (Family)",
      "phone": "(954) 555-9091"
    }
  },
  "problems": [
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Second Trimester Pregnant Patient",
      "assessment": "Working diagnosis: Second Trimester Pregnant Patient",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with second trimester pregnant patient. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
