...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Epistaxis, Coughing Blood",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Epistaxis, Coughing Blood",
    "acuity": 1,
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for vet. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) vet assessment revealed the key discriminating features. (3) Anticoagulant rodenticide toxicity: why is the PT prolonged before clinical bleeding occurs \u2014 and why does treatment require 4-6 weeks of Vitamin K1? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
