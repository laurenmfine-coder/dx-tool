...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Post-Op Rotator Cuff Repair Week 8",
    "race": "American Indian or Alaska Native",
    "address": "4799 Oak St, Fort Lauderdale, FL 33537",
    "phone": "(954) 555-1959",
    "email": "tamikawi@email.com",
    "emergencyContact": {
  ...
  "problems": [
    {
      "problem": "Primary: Post-Op Rotator Cuff Repair Week 8",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Post-Op Rotator Cuff Repair Week 8",
      "assessment": "Working diagnosis: Post-Op Rotator Cuff Repair Week 8",
  ...
  "meta": {
    "caseId": "pt-rotator-cuff-rehab",
    "diagnosis": "See diagnosis \u2014 Post-Op Rotator Cuff Repair Week 8",
    "acuity": 3,
    "presentation": "Post-Op Rotator Cuff Repair Week 8",
    "category": "orthopedic"
  },
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with post-op rotator cuff repair week 8. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
    ...
    "ddxTargets": [
      "Post-Op Rotator Cuff Repair Week 8 \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      "phase2": "The student is reviewing a pt case with chief complaint: Post-Op Rotator Cuff Repair Week 8. What are the most important questions for a pt to ask \u2014 and what clinical findings would distinguish this from the top 2 alternatives on the differential?",
      ...
      "final": "Case debrief for pt. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) pt assessment revealed the key discriminating features. (3) Week 8 post-arthroscopic rotator cuff repair. What is the evidence-based ROM progression at this stage \u2014 and what functional test determines return to overhead sport? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
