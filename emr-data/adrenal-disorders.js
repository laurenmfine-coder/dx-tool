/* emr-data/adrenal-disorders.js — alias wrapper */
window.CASES = window.CASES || {};
/* This topic uses case 'adrenal-crisis' — see emr-data/adrenal-crisis.js */
if (window.CASES['adrenal-crisis']) {
  window.CASES['adrenal-disorders'] = window.CASES['adrenal-crisis'];
} else {
  window.CASES['adrenal-disorders'] = {
    id: 'adrenal-disorders', name: 'See adrenal-crisis', age: '', dob: '',
    mrn: 'RDX-ALIAS', setting: 'See topic', category: 'alias', acuity: 2,
    chiefComplaint: 'See CoachDx for adrenal-disorders',
