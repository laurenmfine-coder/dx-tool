...
window.EMR_DATA = {
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 ICU Patient",
    "acuity": 1,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "ICU Patient \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for nursing. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) nursing assessment revealed the key discriminating features. (3) Your patient on an insulin drip has a glucose of 48. She is sedated and cannot report symptoms. The insulin drip order says 'hold for glucose <70 and call MD.' You hold the drip and give dextrose. Thirty minutes later glucose is 62. The intern says 'glucose is coming up, resume the drip at the previous rate.' What do you say? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
