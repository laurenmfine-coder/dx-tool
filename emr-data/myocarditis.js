...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: acute myocarditis. Key learning: (1) Myocarditis is inflammation of the myocardium with a broad etiologic differential. Causes: viral (most common in developed world — Coxsackie B, adenovirus, parvovirus B19, HHV-6, SARS-CoV-2, influenza), bacterial (diphtheria, Lyme, tuberculosis), fungal and parasitic (Chagas disease — major cause in Latin America), autoimmune (SLE, sarcoidosis, giant cell myocarditis, eosinophilic myocarditis), drug-induced (clozapine, checkpoint inhibitors which cause a high-mortality immune-related myocarditis, anthracyclines, 5-FU, some illicit drugs), and hypersensitivity reactions. (2) Presentation is variable and can mimic other cardiac diagnoses. The spectrum ranges from subclinical disease to fulminant myocarditis with cardiogenic shock. Common presentations: recent viral illness followed by chest pain (often pericarditis-like from concurrent myopericarditis), dyspnea, fatigue, heart failure symptoms, palpitations, and syncope. Young athletes and young adults with new heart failure, ventricular arrhythmia, or sudden cardiac arrest should prompt consideration of myocarditis. (3) Workup. ECG: ST-segment elevation or depression, T-wave inversion, new bundle branch block, AV block, or low voltage — can mimic STEMI. Cardiac biomarkers: elevated troponin reflects myocardial necrosis. Echocardiography: regional or global wall motion abnormalities, reduced EF, pericardial effusion, increased wall thickness from edema. Cardiac MRI with gadolinium is the noninvasive gold standard — Lake Louise criteria (T2-weighted edema imaging, early gadolinium enhancement for hyperemia/capillary leak, late gadolinium enhancement for fibrosis/necrosis) support the diagnosis. Coronary angiography is often performed to rule out ACS, especially in older patients with risk factors. Endomyocardial biopsy is the histologic gold standard but is reserved for fulminant or unexplained cases, giant cell myocarditis suspicion, or when therapy depends on specific histology. (4) Management. Supportive: heart failure therapy (ACE-I/ARB, beta-blocker, MRA, SGLT2 inhibitor, diuretics as needed) for reduced EF — most patients recover over weeks to months but a minority develop chronic cardiomyopathy. Arrhythmia management as appropriate, including temporary pacing for high-grade block. Advanced heart failure therapies (inotropes, mechanical circulatory support — IABP, Impella, VA-ECMO, LVAD, transplant) for cardiogenic shock from fulminant myocarditis. Specific immunosuppression is reserved for certain etiologies: giant cell myocarditis (combination immunosuppression — cyclosporine plus steroids plus azathioprine), eosinophilic myocarditis, cardiac sarcoidosis (corticosteroids), checkpoint-inhibitor myocarditis (high-dose steroids, withdraw drug). Avoid NSAIDs — can worsen renal function and fluid retention. EXERCISE RESTRICTION is critical: abstain from competitive or high-intensity exercise for 3-6 months minimum; return after normalization of biomarkers, EF, and absence of arrhythmia — typically requires cardiology clearance. (5) Classic pitfalls: (a) misdiagnosing as STEMI in a young patient with chest pain and ST elevation — cath without obstruction plus elevated troponin plus preceding viral illness should raise myocarditis suspicion; MRI and cardiology consultation. (b) Missing checkpoint-inhibitor myocarditis in oncology patients — high mortality, requires prompt high-dose steroids. (c) Discharging without counseling about exercise restriction — sudden death risk during acute myocarditis. (d) Overlooking giant cell and eosinophilic myocarditis — distinct histologies with rapid progression that require aggressive immunosuppression and often advanced therapies; endomyocardial biopsy is needed when fulminant or atypical."
    }
  }
};
