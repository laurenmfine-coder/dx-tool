...
window.EMR_DATA = {
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Claudette appears mildly anxious and tired, with some difficulty concentrating during the interview. She is forthcoming about her medication non-adherence but initially downplays the severity of her symptoms, attributing them to stress. Her distress level is moderate as she's concerned about her worsening symptoms but trying to remain composed.",
    "interviewQuestions": [
      "Can you describe your headaches in more detail?",
      "When did these headaches first start?",
      "Where exactly do you feel the headache pain?",
      "How severe are your headaches on a scale of 1-10?",
      "What makes your headaches better or worse?",
      "Have you noticed any changes in your vision, nausea, or confusion?",
      "Tell me about your blood pressure medications and how you take them",
      "Have you been checking your blood pressure at home?",
      "Any chest pain, shortness of breath, or swelling in your legs?",
      "Have you noticed any changes in your urination?",
      "Any family history of high blood pressure or heart problems?",
      "Do you have any drug allergies?",
      "Have you had headaches like this before?"
    ],
    "patientResponses": {
      "default": "I'm sorry, could you repeat that? I'm having trouble focusing today.",
      "onset": "The headaches started about 2-3 months ago, but they've gotten much worse this past week. They seem to come on gradually, usually in the afternoon or evening.",
      "character": "It's a constant, throbbing pain that feels like pressure building up in my head. Sometimes it feels like my head might explode.",
      "location": "The pain is mainly at the back of my head and neck, but sometimes it spreads to the sides too. It doesn't really shoot anywhere else.",
      "severity": "Usually around a 6 or 7 out of 10, but today it's been an 8. It's making it hard for me to concentrate and do my usual activities around the house.",
      "aggravating": "Stress definitely makes it worse, and bending over or coughing seems to make the pressure worse too. Bright lights bother me more when I have the headache.",
      "relieving": "Tylenol helps a little bit, and lying down in a dark room sometimes helps. But nothing really makes it go away completely.",
      "associated": "I've been feeling more tired than usual, and sometimes I feel a little dizzy when I stand up. No nausea or vomiting though. I have been urinating more frequently lately.",
      "denies": "No chest pain, no trouble breathing, no swelling in my legs or feet. My vision seems fine - no blurriness or seeing spots.",
      "history": "I've had regular headaches before, but nothing like this. These are much more intense and don't go away like my old headaches used to.",
      "medications": "Amlodipine 10mg daily; Lisinopril 40mg daily; Hydrochlorothiazide 25mg daily; Metformin 1000mg BID; Glipizide 10mg BID; Atorvastatin 40mg QHS; Aspirin 81mg daily",
      "allergies": "Lisinopril, Shellfish",
      "family": "My mother had high blood pressure and had a stroke when she was 70. My father also had high blood pressure and diabetes, and he had a heart attack at 65. My sister has high blood pressure and kidney problems too.",
      "social": "I'm a retired home health aide, and I live with my daughter since my husband passed. I never smoked and don't drink alcohol or use any drugs."
    },
    "examManeuvers": [
      ...
      "Neck examination for JVD",
      "Assessment of peripheral pulses"
    ],
    "examFindings": {
      "Blood pressure measurement in both arms": "Right arm 168/98, Left arm 172/102, consistent hypertensive readings bilaterally",
      "Fundoscopic examination": "Grade 2 hypertensive retinopathy with arteriovenous nicking, mild papilledema, and flame-shaped hemorrhages",
      "Neurological assessment including mental status": "Mild confusion with delayed responses, otherwise intact cranial nerves, normal motor strength, reflexes 2+ throughout",
      "Cardiovascular examination": "Regular rate and rhythm, S4 gallop present, PMI displaced laterally consistent with LVH, no murmurs",
      ...
      "Extremity examination for edema": "Trace bilateral lower extremity edema, no clubbing or cyanosis",
      "Neck examination for JVD": "Mild jugular venous distention at 45 degrees",
      "Assessment of peripheral pulses": "Diminished dorsalis pedis pulses bilaterally, otherwise palpable pulses throughout"
    },
    "ddxTargets": [
      "Hypertensive Emergency with End-Organ Damage (Encephalopathy, CKD Progression) (correct diagnosis)",
      "Hypertensive Urgency",
      "Medication Non-adherence with Hypertensive Crisis",
      "Secondary Hypertension (renovascular, endocrine)",
      "Intracranial Mass or Hemorrhage",
      "Tension Headache with Coincidental Hypertension",
      "Migraine with Hypertensive Response"
    ],
    "biasFlags": {
      "anchoring": "Risk of anchoring on 'just another hypertensive patient' and missing the severity of end-organ damage, especially given the patient's chronic poorly controlled hypertension",
      "prematureClosure": "May stop at medication non-adherence as the primary issue without recognizing the acute hypertensive emergency requiring immediate intervention",
      "availabilityBias": "Common presentation of headache in primary care may lead to underestimating the urgency and missing hypertensive emergency features"
    },
    "coachPrompts": {
      "phase2": "You've identified headache and hypertension as key features. What specific aspects of the history would help you differentiate between routine hypertension management versus a hypertensive emergency? Consider what end-organ damage you should assess for.",
      "phase5": "Your history and physical reveal concerning findings including fundoscopic changes and mild altered mental status. How do these findings change your assessment of this patient's hypertension? What immediate interventions might this patient need?",
      "finalDebrief": "This case demonstrates the progression from chronic poorly controlled hypertension to acute hypertensive emergency with end-organ damage. The key teaching points include recognizing signs of hypertensive encephalopathy, the importance of fundoscopic examination, and the critical difference between hypertensive urgency and emergency that determines immediate management."
    }
  }
};
