...
window.EMR_DATA = {
  "base": {
    ...
    "socialHistory": [
      ...
      [
        "Alcohol",
        "Moderate — 2–3 drinks/week"
      ],
      [
        "Occupation",
        "Software engineer — primarily indoor/office"
      ],
      [
        "Travel",
        "No international travel in past 5 years. Trip to Costa Rica 6 years ago (completed anti-parasitic prophylaxis)."
      ],
      [
        "Pets",
        "No pets"
      ...
      [
        "Medications",
        "Ibuprofen PRN — stopped after eosinophilia detected. No recent new medications."
      ],
      [
        "Atopy",
        "No personal or family history of atopy, asthma, eczema, or food allergy"
      ]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "Severe persistent eosinophilia AEC 4,800 cells/µL × 4 months — cause unknown. HES criteria met: AEC ≥1500 × >1 month + organ involvement suspected.",
          "status": "Active"
        },
        {
          "id": "prob-2",
          "description": "Fatigue × 3 months — possibly eosinophil-mediated organ damage",
          "status": "Active"
        },
        {
          "id": "prob-3",
          "description": "Possible eosinophilic cardiac involvement: troponin borderline elevated on PCP labs (TnI 0.08 ng/mL). Echo ordered.",
          "status": "Active — pending workup"
        },
        {
          "id": "prob-4",
          "description": "Mild dry cough × 6 weeks — eosinophilic pulmonary infiltration vs incidental",
          "status": "Active"
        }
      ],
      "medications": [
        {
          ...
          "dose": "Stopped prior to workup",
          "note": "NSAID stopped — drug-induced eosinophilia must be excluded"
        }
      ],
      "vitals": {
        "rows": [
          {
            "time": "Consultation visit",
            "bp": "128/74",
            "hr": "78",
            "rr": "14",
            "temp": "36.8",
          ...
          "rows": [
            {
              ...
              "flag": "H",
              "ref": "4,500–11,000",
              "note": "Leukocytosis — driven by eosinophilia"
            },
            {
              "test": "Eosinophils (%)",
              "value": "34%",
            ...
            },
            {
              ...
              "unit": "cells/µL",
              "flag": "H",
              "ref": "Normal <500; Mild 500–1,500; Moderate 1,500–5,000; Severe >5,000",
              "note": "⚠️ HES diagnostic threshold: AEC ≥1,500 cells/µL on 2 occasions ≥1 month apart + evidence of organ damage or dysfunction attributable to eosinophilia. AEC 4,828 = severe moderate/borderline severe range. FIP1L1-PDGFRA+ HES can cause organ damage at any AEC level."
            },
            {
              "test": "Neutrophils",
              "value": "58%",
              "note": "Normal differential in remainder"
            },
            {
              "test": "Hemoglobin",
              "value": "12.8 g/dL",
              "flag": "L",
              "note": "Mild anemia — may reflect chronic disease or bone marrow involvement"
            },
            {
              "test": "Platelets",
              "value": "148,000",
              "flag": "L",
              "note": "Low-normal. Thrombocytopenia in myeloproliferative HES."
            }
          ]
        },
        "workup": {
          ...
          "rows": [
            {
              ...
              "value": "18.4 ng/mL",
              "flag": "H",
              "ref": "Normal <11.4 ng/mL",
              "note": "⚠️ Elevated tryptase: supports myeloid/mast cell expansion. In FIP1L1-PDGFRA+ HES, tryptase elevation common due to concomitant mast cell involvement (spindle-cell mastocytosis). Tryptase >11.4 in HES = strong predictor of myeloproliferative phenotype (vs lymphocytic)."
            },
            {
              "test": "Serum IgE",
              "value": "42 IU/mL",
              "note": "NORMAL. Key: myeloproliferative HES typically has NORMAL or LOW IgE. Lymphocytic HES (Th2 driven) has elevated IgE + elevated TARC. Atopic HES (asthma/eczema) has markedly elevated IgE. Normal IgE here supports myeloproliferative phenotype."
            },
            {
              "test": "TARC (thymus and activation-regulated chemokine / CCL17)",
              "value": "210 pg/mL",
              "ref": "Normal <450 pg/mL",
              "note": "Normal TARC. Elevated TARC (>450) + elevated IgE would suggest lymphocytic HES (clonal Th2 T cells). Normal here supports myeloproliferative."
            },
            {
              "test": "B12 (vitamin B12)",
              "value": "1,840 pg/mL",
              "flag": "H",
              "ref": "Normal 200–900 pg/mL",
              "note": "⚠️ Markedly elevated B12: HALLMARK of myeloproliferative/myeloid HES. Eosinophils and mast cells produce transcobalamin → elevated serum B12. Also elevated in CML and other myeloproliferative disorders."
            },
            {
              "test": "Troponin I",
              "value": "0.11 ng/mL",
              "flag": "H",
              "ref": "<0.04 ng/mL",
              "note": "Elevated troponin — eosinophilic endomyocarditis (Löffler endocarditis). Granule proteins (MBP, ECP, EPO) released from activated eosinophils → direct cardiac myocyte toxicity."
            },
            {
              "test": "Stool O&P × 3",
              "value": "Negative",
              "note": "Parasitic cause excluded"
            },
            {
              "test": "Strongyloides IgG",
              "value": "Negative",
              "note": "Negative — Strongyloides excluded (most important helminth in returning travelers)"
            },
            {
              "test": "Toxocara IgG",
              "value": "Negative"
    ...
    "office": {
      ...
      "problems": [
        {
          "id": "prob-1",
          "description": "HES — complete hematologic remission on imatinib. AEC normalized to 180 cells/µL.",
          "status": "Remission"
        },
        {
          "id": "prob-2",
          "description": "Löffler endomyocarditis — EF recovering (48% → 56% on repeat echo). Apical thrombus partially resolved.",
          "status": "Improving"
        }
      ],
      "medications": [
        {
          "id": "med-1",
          "name": "Imatinib (Gleevec) 100 mg",
          "dose": "Once daily with meal",
          "route": "Oral",
          "indication": "TKI for FIP1L1-PDGFRA HES. Continue indefinitely — discontinuation leads to relapse in most."
        },
        {
          "id": "med-2",
          "name": "Warfarin",
          "dose": "Dose-adjusted to INR 2–3",
          "route": "Oral",
          "indication": "Intracardiac thrombus anticoagulation. Duration: until cardiac imaging confirms thrombus resolution."
        }
      ],
      "vitals": {
        "rows": [
          ...
          "rows": [
            {
              ...
              "unit": "cells/µL",
              "ref": "Baseline: 4,828",
              "note": "96% reduction. Complete hematologic remission (AEC <500)."
            },
            {
              "test": "FIP1L1-PDGFRA RT-PCR",
              "value": "NEGATIVE — undetectable",
              "note": "Complete molecular remission. Target: undetectable fusion transcript. Achieved at 3 months — excellent response."
            },
            {
              "test": "Serum tryptase",
              "value": "7.2 ng/mL",
              "ref": "Baseline: 18.4 ng/mL",
              "note": "Normalized (was 18.4). Confirms mast cell population also suppressed by imatinib."
            },
            {
              "test": "B12",
              "value": "420 pg/mL",
              "ref": "Baseline: 1,840 pg/mL",
              "note": "Normalized — myeloproliferative burden resolved."
            },
            {
              "test": "Troponin I",
              "value": "0.02 ng/mL",
              "note": "Normalized from 0.11 — cardiac injury resolved."
            },
            {
              "test": "Echo EF",
              "value": "56% (repeat echo)",
              "ref": "Baseline: 48%",
              "note": "Recovered toward normal. Apical thrombus partially resolved on anticoagulation + imatinib. Mitral regurgitation reduced to 1+."
            }
          ]
        }
      },
  ...
  "guided": {
    "coachPrompts": {
      "final": "Diagnosis: myeloproliferative hypereosinophilic syndrome (HES) with FIP1L1-PDGFRA fusion, complicated by eosinophilic endomyocarditis and lung infiltration. Key learning: (1) Hypereosinophilic syndrome is defined by persistent eosinophilia >=1,500/uL on at least two occasions a month apart (or once with end-organ damage), plus evidence of eosinophil-mediated organ damage. The most feared complications are cardiac (eosinophilic endomyocarditis progressing through necrotic, thrombotic, and fibrotic stages — Loffler endocarditis), pulmonary infiltrates, skin involvement (urticaria, angioedema, nodules), neurologic (encephalopathy, peripheral neuropathy, cerebral infarction), and gastrointestinal (eosinophilic gastroenteritis). Troponin and cardiac MRI are essential in any patient with sustained eosinophilia — cardiac damage can be clinically silent until advanced. (2) The diagnostic workup is guided by a structured differential: (a) secondary/reactive eosinophilia — parasitic infection (strongyloides is a must-rule-out before any immunosuppression; check serology), drug reaction (DRESS syndrome, eosinophilia-triggering drugs), allergic/atopic disease, ABPA, collagen vascular disease, adrenal insufficiency. (b) Clonal/neoplastic — myeloproliferative HES (FIP1L1-PDGFRA fusion is the classic imatinib-responsive lesion; also PDGFRB, FGFR1, JAK2 rearrangements), chronic eosinophilic leukemia, systemic mastocytosis, T-cell lymphoma (aberrant T-cell clones secreting IL-5 leading to lymphocytic variant HES). (c) Idiopathic HES — diagnosis of exclusion. Testing must include strongyloides serology, stool O&P, HIV, tryptase, vitamin B12 (elevated in myeloproliferative variants), peripheral flow cytometry for aberrant T-cell populations, bone marrow biopsy with cytogenetics and molecular testing for FIP1L1-PDGFRA and related fusions, and TCR rearrangement studies. (3) Treatment is driven by subtype. FIP1L1-PDGFRA-positive patients respond dramatically to imatinib at low doses (100-400 mg daily) with hematologic remission within weeks and molecular remission in most. Lymphocytic variant and idiopathic HES are first treated with systemic corticosteroids (prednisone 0.5-1 mg/kg/day). Second-line and steroid-sparing options include mepolizumab (anti-IL-5, FDA-approved for HES), benralizumab (anti-IL-5Ra), hydroxyurea, and interferon-alpha. (4) Cardiac management: anticoagulation is strongly considered when intracardiac thrombus is present; heart failure is treated with standard evidence-based therapy; advanced fibrotic endomyocardial disease may require surgical intervention. Monitor troponin, NT-proBNP, and echocardiography serially. (5) Classic pitfalls: (a) starting systemic steroids without first ruling out strongyloides — disseminated strongyloidiasis in an immunosuppressed host is often fatal. (b) Missing FIP1L1-PDGFRA by not ordering the molecular test — these patients can be spared steroids entirely. (c) Treating eosinophilia as 'just atopy' without checking for organ involvement — silent cardiac disease is the classic catastrophe. (d) Forgetting that the eosinophil count does not have to be extremely high to cause organ damage; sustained moderate eosinophilia over months or years can still cause fibrosis."
    }
  }
};
