...
,"references":[
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Sandra Kim is alert and cooperative, clearly concerned but provides a clear history.",
    "interviewQuestions": [
    ...
    "patientResponses": {
        ...
        "medications": "'I take Cephalexin; Clobetasol 0.05%; Petroleum jelly.'",
        "allergies": "'My allergies: Nickel.'",
        "family": "Mother: eczema",
        "social": "Occupation: Hairstylist 20 years \u2014 PPD in hair dye is the trigger  Impact: Hands cracking, bleeding \u2014 cannot work, losing clients  Prior care: Told to \"moisturize more\" \u2014 never patch tested  Financial: Self-employed \u2014 no sick leave, income stopped during flares  Identity: \"Being a hairstylist is all I know\""
    },
    "examManeuvers": [
        "General appearance",
        "Vital signs",
    ...
    "coachPrompts": {
        "phase2": "Before interviewing Sandra Kim: what does the chart suggest? Top 3 diagnoses?",
