...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: acute acetaminophen overdose — a common but potentially fatal toxic ingestion. Key learning: (1) Acetaminophen (paracetamol) is the most common medication overdose in the US and a leading cause of acute liver failure in developed countries. Toxic dose: >150 mg/kg or >7.5 g in adults; chronic toxicity can occur at lower doses in malnourished patients, alcohol use disorder, CYP-inducing medications (phenytoin, carbamazepine, rifampin, INH), and fasting states. Mechanism: acetaminophen is mostly conjugated to safe glucuronide/sulfate; a small fraction (~5%) is oxidized by CYP2E1 to NAPQI, which is detoxified by glutathione. In overdose, glutathione is depleted, and NAPQI causes centrilobular hepatic necrosis. (2) Four clinical stages of acetaminophen toxicity. Stage 1 (0-24 hours) — mild nausea, vomiting, malaise, or asymptomatic. Deceptively benign. Stage 2 (24-72 hours) — RUQ pain, hepatomegaly, rising AST/ALT and INR as hepatotoxicity manifests. Stage 3 (72-96 hours) — peak hepatotoxicity; acute liver failure (coagulopathy, encephalopathy, hypoglycemia, metabolic acidosis); possible death. Stage 4 (4 days-2 weeks) — recovery (most patients) or death. (3) Assessment and Rumack-Matthew nomogram. Timing of ingestion is critical — the nomogram is valid only for a single acute ingestion with known timing (4-24 hours post-ingestion). Draw acetaminophen level at 4 hours post-ingestion (or immediately if later). Plot level on nomogram; above the treatment line = treat with NAC. Special situations requiring empiric NAC (nomogram does not apply or is unreliable): - Unknown time of ingestion. - Massive ingestion (>24-30 g). - Staggered ingestion (multiple times). - Extended-release formulation (delayed peak). - Signs of hepatotoxicity (elevated AST/ALT). - Chronic therapeutic supratherapeutic dosing. - Pregnancy (transplacental toxicity). Check at baseline: acetaminophen level, AST/ALT, INR, BMP, glucose, ABG, lactate, salicylate level (common co-ingestant), ethanol, and urine pregnancy test. (4) Treatment — N-ACETYLCYSTEINE (NAC) is the antidote. NAC replenishes glutathione, directly binds NAPQI, and has other hepatoprotective effects. Most effective within 8-10 hours of ingestion, but still beneficial at any time including established liver injury. IV 21-hour protocol: 150 mg/kg over 1 hour, then 50 mg/kg over 4 hours, then 100 mg/kg over 16 hours. Oral 72-hour protocol: 140 mg/kg loading, then 70 mg/kg q4h x 17 doses. EXTEND NAC BEYOND 21 HOURS if: elevated transaminases, abnormal INR (>1.3), persistent acetaminophen detectable, or encephalopathy. Adverse effects of IV NAC: anaphylactoid reactions (usually mild; slow infusion, antihistamines; rarely stop NAC). (5) Supportive care and liver failure management. Monitor: LFTs, INR, glucose, BMP, lactate every 6-12 hours initially. Consider transfer to liver transplant center for: King's College criteria met (pH <7.3 after resuscitation; OR PT >100 sec + creatinine >3.4 + grade III/IV encephalopathy), or rapidly worsening hepatic function. Avoid acidosis, hypoglycemia, hypothermia; consider ICU admission. Charcoal 50 g PO within 1-2 hours of acute ingestion if patient can protect airway. Psychiatric evaluation for any intentional overdose, safety planning, means restriction, and disposition coordination. Classic pitfalls: (a) stopping NAC at 21 hours in a patient with rising LFTs or coagulation abnormalities. (b) Missing delayed toxicity in staggered ingestion — nomogram does not apply; treat based on history and LFT trend. (c) Not checking salicylate and acetaminophen levels in every overdose. (d) Forgetting the psychiatric, safety planning, and social follow-up components. (e) Over-reliance on nomogram in non-qualifying cases — low threshold for empiric NAC."
    }
  }
};
