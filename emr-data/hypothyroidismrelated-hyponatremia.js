...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: severe hypothyroidism (TSH 68) with symptomatic hyponatremia (Na 119) secondary to medication non-adherence. Key learning: (1) Hypothyroidism causes hyponatremia through two main mechanisms: reduced cardiac output with decreased renal perfusion triggering non-osmotic ADH release, and direct impaired free-water excretion at the distal nephron. The hyponatremia is typically euvolemic or mildly hypovolemic with a picture that can mimic SIADH (low serum osmolality, inappropriately concentrated urine, urine sodium over 20). TSH should be checked in any workup of unexplained hyponatremia, along with cortisol, glucose, lipids, and a medication review. (2) Severity of hyponatremia drives urgency. Severe (under 120) or symptomatic hyponatremia (seizures, obtundation, respiratory compromise) requires immediate correction with hypertonic 3% saline — typically 100-150 mL boluses repeated up to three times — aiming to raise sodium by 4-6 mEq/L in the first few hours to reverse symptoms. Chronic hyponatremia must be corrected slowly: no more than 8-10 mEq/L in 24 hours (some guidelines say 6-8), to avoid osmotic demyelination syndrome (formerly called central pontine myelinolysis). Check sodium every 2-4 hours during active correction. (3) Myxedema coma is the extreme end of the spectrum and is a true emergency. It presents with hypothermia, bradycardia, hypotension, hyponatremia, hypoglycemia, hypoventilation (CO2 retention), and altered mental status. Treatment is emergent IV levothyroxine 200-400 mcg loading dose then 50-100 mcg daily, plus IV hydrocortisone 100 mg q8h (given empirically because coexisting adrenal insufficiency is common and treating hypothyroidism alone can precipitate adrenal crisis), plus supportive care including mechanical ventilation, warming, and IV fluids. Always give hydrocortisone BEFORE or WITH levothyroxine, never after, if adrenal status is uncertain. (4) Long-term management hinges on adherence and proper administration. Levothyroxine should be taken on an empty stomach, at least 30-60 minutes before food, and separated from calcium, iron, antacids, PPIs, and cholestyramine which impair absorption. Recheck TSH 6-8 weeks after any dose change. In elderly patients and those with known CAD, start low (25-50 mcg daily) and titrate slowly to avoid precipitating ischemia. (5) Classic pitfalls: (a) correcting hyponatremia too rapidly, precipitating osmotic demyelination, which is typically irreversible and presents days later with quadriparesis, dysphagia, dysarthria, and locked-in syndrome. (b) Giving thyroid hormone without steroid coverage in possible adrenal insufficiency. (c) Missing myxedema coma in an older patient attributed to stroke, dementia, or sepsis. (d) Forgetting that medication non-adherence is the most common cause of 'refractory' hypothyroidism — always ask non-judgmentally about what the patient is actually taking, how often, and whether they can afford their medications."
    }
  }
};
