...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: vocal cord dysfunction (VCD), also called paradoxical vocal fold motion (PVFM) — an asthma mimic. Key learning: (1) VCD is an upper airway disorder characterized by paradoxical vocal cord adduction during inspiration, causing inspiratory or biphasic stridor, dyspnea, cough, throat tightness, and voice changes — often misdiagnosed and treated as asthma for years. Patient demographics: classically affects young women, athletes, and individuals with anxiety or vocal strain; can coexist with asthma in up to 40%. Triggers: exercise, strong odors and irritants (perfume, cleaning chemicals), stress, postnasal drip, GERD, upper respiratory infection, and occasionally cold air. (2) Distinguishing VCD from asthma. Features favoring VCD: inspiratory symptoms more than expiratory (asthma is predominantly expiratory), upper airway tightness (throat, neck), stridor rather than wheeze, acute onset and rapid resolution, poor response to bronchodilators, normal SpO2 during episodes, absence of nocturnal symptoms, absence of atopic triad. Flow-volume loop shows flattening of the INSPIRATORY limb (extrathoracic variable obstruction pattern) in contrast to asthma's expiratory flattening. Laryngoscopy during an episode is diagnostic — shows adduction of the vocal cords during inspiration with a posterior 'diamond-shaped' glottic chink. Asthma and VCD can coexist — don't exclude asthma based on VCD diagnosis. (3) Workup. Pulmonary function testing with flow-volume loops: flattened inspiratory limb (variable extrathoracic obstruction) in VCD; asthma shows expiratory abnormalities (concave down-sloping expiratory limb, reversible with bronchodilator). Methacholine challenge — typically negative in pure VCD, positive in asthma. Laryngoscopy — direct visualization at rest and during provocation is the gold standard; flexible fiberoptic nasendoscopy in the clinic. Exercise challenge or mannitol/methacholine provocation can reproduce symptoms. Workup for comorbid triggers: GERD evaluation, rhinitis/postnasal drip assessment, allergy testing, psychiatric evaluation. (4) Treatment. (a) ACUTE EPISODE management: reassurance (anxiety worsens VCD), distraction, pursed-lip breathing, panting breaths, 'sniffing' breaths through the nose, heliox (helium-oxygen mixture — reduces airway resistance and work of breathing in severe episodes). AVOID reflexive administration of nebulized albuterol and systemic steroids (no benefit in pure VCD, and can reinforce 'asthma' misdiagnosis). (b) LONG-TERM management: - Speech therapy with a speech-language pathologist specialized in VCD (laryngeal control techniques, relaxed-throat breathing, diaphragmatic breathing) — MAINSTAY of treatment, highly effective. - Trigger identification and avoidance. - Treatment of concurrent GERD (PPI if indicated), rhinitis (nasal corticosteroid, saline), and anxiety/depression if present (CBT, SSRIs as appropriate). - Botulinum toxin injection into thyroarytenoid muscle — second-line for refractory cases. - Avoid chronic systemic steroids and excessive asthma medications (common iatrogenic harm in misdiagnosed VCD). (5) Classic pitfalls: (a) persistent misdiagnosis as 'asthma' — patients often have years of escalating asthma therapy with inadequate response before VCD is recognized; think of VCD in 'treatment-resistant asthma' and in stridulous episodes. (b) Sedating or intubating a patient with acute VCD exacerbation — many episodes resolve with reassurance and breathing techniques; intubation is rarely necessary. (c) Not evaluating for concurrent asthma — coexistence is common, and both conditions need addressing. (d) Missing GERD and laryngopharyngeal reflux as chronic irritants and triggers — treat aggressively. (e) Forgetting the psychological component and speech therapy referral — these are the most effective interventions and are often underutilized."
    }
  }
};
