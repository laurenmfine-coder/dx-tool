...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for nursing. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) nursing assessment revealed the key discriminating features. (3) Robert was admitted for pneumonia. This morning his glucose is 387 on an insulin drip protocol. He is eating a full diet. His home medications include glipizide. The physician orders sliding scale insulin in addition to the drip. What is the most dangerous element of this order \u2014 and what does your inpatient diabetes management education need to cover before discharge? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
