...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Recurrent Ankle Sprains",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Recurrent Ankle Sprains",
      "assessment": "Working diagnosis: Recurrent Ankle Sprains",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with recurrent ankle sprains. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
