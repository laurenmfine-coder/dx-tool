...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Post-TKR Day 3",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Post-TKR Day 3",
      "assessment": "Working diagnosis: Post-TKR Day 3",
  ...
  "meta": {
    "caseId": "post-tkr-rehab-pt",
    "diagnosis": "See diagnosis \u2014 Post-TKR Day 3",
    "acuity": 3,
    "presentation": "Post-TKR Day 3",
    "category": "orthopedic"
  },
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with post-tkr day 3. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
    ...
    "ddxTargets": [
      "Post-TKR Day 3 \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      "phase2": "The student is reviewing a pt case with chief complaint: Post-TKR Day 3. What are the most important questions for a pt to ask \u2014 and what clinical findings would distinguish this from the top 2 alternatives on the differential?",
      ...
      "final": "Case debrief for pt. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) pt assessment revealed the key discriminating features. (3) What ROM and functional milestones determine safe discharge from inpatient PT after TKR? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
