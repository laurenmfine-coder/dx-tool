// Virtual EMR Case: Vitreous Hemorrhage
// Variant: vitreous-hemorrhage | Acuity: ESI-2
...
window.EMR_DATA = {
  "patient": {
    ...
    "mrn": "RDX-2025-41726",
    "pronouns": "He/Him",
    "insurance": "Medicare Part B with BlueCross Supplemental",
  ...
  "problems": [
    {
      ...
      "onset": "2006",
      "status": "Active",
      "notes": "A1c 9.4%; on insulin and metformin; multiple missed appointments; diabetic retinopathy documented"
    },
    {
      "problem": "Proliferative Diabetic Retinopathy — Bilateral",
      "icd": "E11.351",
      "onset": "2022",
      "status": "Active",
      "notes": "High-risk PDR bilateral; panretinal photocoagulation (PRP) completed left eye 2023; right eye PRP partially completed — patient missed follow-up sessions"
    },
    {
      "problem": "Diabetic Macular Edema — Right Eye",
      "icd": "E11.311",
      "onset": "2023",
      "status": "Active",
      "notes": "Received 2 intravitreal anti-VEGF injections (aflibercept) right eye; missed 3rd injection appointment"
    },
    {
      ...
      "onset": "2008",
      "status": "Active",
      "notes": "On amlodipine and lisinopril; suboptimally controlled"
    },
    {
      ...
      "onset": "2021",
      "status": "Active",
      "notes": "eGFR 38; diabetic nephropathy; proteinuria; nephrology following"
    },
    {
    ...
    },
    {
      ...
      "onset": "2019",
      "status": "Active",
      "notes": "Bilateral feet; decreased monofilament sensation; on gabapentin"
    }
  ],
  "medications": [
    {
      "name": "Insulin Glargine (Lantus) 32 units SQ QHS",
      "sig": "Inject 32 units subcutaneously at bedtime",
    ...
    {
      "name": "Insulin Lispro (Humalog) sliding scale AC",
      "sig": "Inject subcutaneously before meals per sliding scale",
      "prescriber": "Dr. Torres",
      "start": "06/2022",
      "refills": 2,
      "status": "Active"
  ...
  "allergies": [
    ...
    },
    {
      ...
      "type": "Drug",
      "reaction": "Dry cough with lisinopril — tolerable; patient declines switch",
      "severity": "Mild",
      "verified": "Yes"
    }
  ],
  ...
  "visits": [
    {
      ...
      "cc": "Follow-up: DM2, HTN, CKD; missed several specialist appointments",
      "hpi": "64-year-old male with poorly controlled T2DM, HTN, CKD 3b, and proliferative diabetic retinopathy presents for follow-up. A1c 9.4% — elevated from 8.8% 6 months ago. Admits to inconsistent insulin use and dietary non-compliance. Missed last 3 ophthalmology appointments (incomplete PRP right eye, missed anti-VEGF injection). Reports occasional blurred vision bilateral, worse right eye. Denies new floaters, flashes, or sudden vision loss at this visit. Neuropathy stable — numbness in feet bilateral. No foot ulcers. Weight slightly down.",
      "exam": "General: Obese male, NAD. HEENT: PERRL, difficulty visualizing fundi due to limited dilation in office — dot hemorrhages visible bilateral. Neck: No bruits. CV: RRR, no murmurs. Lungs: CTAB. Abdomen: Soft, obese, NT. Extremities: 1+ pitting edema bilateral. Feet: Decreased monofilament sensation bilateral (3/10 sites); no ulcers; pedal pulses diminished. Neuro: A&O x3.",
      "assessment": "1. T2DM — worsening control, A1c 9.4%\n2. PDR bilateral — INCOMPLETE treatment; high risk for vitreous hemorrhage and vision loss\n3. HTN — uncontrolled\n4. CKD 3b — progressive; proteinuria\n5. Diabetic neuropathy — stable\n6. Multiple missed specialist appointments — adherence barriers",
      "plan": "1. Increase Lantus to 36 units QHS; reinforce sliding scale\n2. URGENT ophthalmology re-referral — emphasized risk of BLINDNESS from untreated PDR\n3. Social work referral for transportation and appointment assistance\n4. Continue current BP meds; add HCTZ 12.5mg if Cr permits (discuss with nephrology)\n5. Nephrology follow-up — re-referred\n6. Recheck A1c, BMP, CBC, lipids, urine albumin/creatinine in 4 weeks\n7. Diabetic foot care education\n8. RTC 4-6 weeks; return IMMEDIATELY for sudden vision loss, new floaters, flashes, or any eye emergency"
    },
    {
      "id": "V002",
      "date": "06/18/2024",
      "type": "Primary Care",
      "provider": "Dr. Amanda Torres, MD",
      "cc": "Follow-up: DM2, HTN",
      "hpi": "64-year-old male for chronic disease follow-up. A1c 8.8%. Missed ophthalmology follow-up for PRP completion. Reports intermittent blurry vision attributed to blood sugar swings. No foot ulcers. Weight up 3 lbs.",
      "exam": "General: Obese, NAD. Feet: No ulcers, decreased sensation. CV: RRR. Extremities: Trace edema.",
      "assessment": "1. T2DM — suboptimal\n2. PDR — incomplete PRP, requires urgent follow-up\n3. HTN — poorly controlled",
      "plan": "1. Adjust insulin\n2. Re-emphasize ophthalmology follow-up\n3. Dietary counseling\n4. RTC 3 months"
    }
  ],
  "labs": [
    {
      ...
      "collected": "12/10/2024 08:00",
      "facility": "ReasonDx Medical Center Lab",
      "accession": "LAB-2024-121015",
      "status": "Final",
  ...
  "imaging": [
    {
      ...
      "accession": "IMG-2024-06181",
      "status": "FINAL",
      "orderedBy": "Dr. Amanda Torres, MD",
      "readBy": "Dr. James Chen, MD (Radiology)",
      "facility": "ReasonDx Medical Center Imaging",
      "priority": "Routine",
      "clinical": "64M DM2, HTN, CKD — annual screening.",
      "technique": "PA and lateral views, upright.",
      "findings": "Heart: Mildly enlarged cardiac silhouette (cardiothoracic ratio 0.54).\\n\\nLungs: Clear bilaterally. No effusion, consolidation, or pneumothorax.\\n\\nMediastinum: Aortic atherosclerotic calcifications.\\n\\nBones: Mild degenerative changes.",
      "impression": "1. Mild cardiomegaly.\\n2. Aortic atherosclerosis.\\n3. No acute process.",
      "dictated": "06/18/2024 11:45",
      "verified": "06/18/2024 14:10"
    }
  ],
  "immunizations": [
    {
  ...
  "familyHistory": [
    "Mother: T2DM, CKD (on dialysis), deceased at 70",
    "Father: T2DM, glaucoma, HTN, deceased at 72",
    "Sister: T2DM with retinopathy, alive at 60",
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: vitreous hemorrhage secondary to untreated proliferative diabetic retinopathy. Key learning: (1) Vitreous hemorrhage is blood in the normally clear vitreous cavity, causing sudden visual disturbance ranging from floaters ('cobwebs', 'spots') to complete vision loss depending on severity. Etiologies: (a) Proliferative diabetic retinopathy (most common — abnormal fragile neovessels bleed into vitreous). (b) Posterior vitreous detachment (PVD) with retinal tear (common — as vitreous detaches, retinal vessels can tear). (c) Retinal vein occlusion (especially branch retinal vein occlusion). (d) Trauma. (e) Retinal macroaneurysm. (f) Sickle cell retinopathy. (g) Terson syndrome (vitreous hemorrhage associated with subarachnoid hemorrhage — increased ICP rupturing peripapillary vessels). (h) Anticoagulation — exacerbates bleeding but rarely causes it alone. (2) Proliferative diabetic retinopathy (PDR) pathophysiology. Chronic hyperglycemia damages retinal microvasculature → capillary non-perfusion and ischemia → VEGF-driven neovascularization at the optic disc and elsewhere. New vessels are fragile, leak, and bleed into the vitreous. Fibrovascular proliferation contracts, causing tractional retinal detachment — a sight-threatening complication. Screening: annual dilated fundus exam in all diabetic patients (sooner after diagnosis for T2DM given possible pre-existing disease; within 5 years for T1DM). (3) Presentation. Sudden onset floaters, blurring, vision loss, or a 'curtain' or 'rain' of dots — patients often describe a sudden 'cloud' obscuring vision. Pain is usually absent (distinguishes from angle-closure glaucoma, endophthalmitis). Visual acuity varies from near-normal (small hemorrhage) to light perception only (dense hemorrhage). Red reflex may be absent or diminished on penlight exam. Fundus exam obscured by blood — dilated exam by ophthalmologist is diagnostic. (4) Workup and evaluation. Ophthalmologic examination: visual acuity, slit-lamp, intraocular pressure, dilated fundus exam. B-scan ultrasound when view is obscured — identifies retinal detachment, tumor, or underlying pathology. Bloodwork: A1c (essential for diabetic patients), CBC, coagulation, BP. Fluorescein angiography and OCT once hemorrhage clears. (5) Management. (a) Urgent ophthalmology consultation — within 24 hours for any sudden vision loss. (b) Elevate head of bed, limit physical activity (to allow blood to settle and clear), avoid anticoagulants and antiplatelets when not medically necessary. (c) Address modifiable risk factors — BP control, glycemic control, anticoagulation review (in patients with cardiac indications, usually continued with close monitoring — not stopped without clear benefit). (d) Specific treatment of PDR: - Anti-VEGF intravitreal injections (aflibercept, ranibizumab, bevacizumab) — reduce neovascularization, accelerate clearance of vitreous hemorrhage. - Panretinal photocoagulation (PRP) — laser treatment to reduce ischemic drive; historical standard, still important. - Pars plana vitrectomy — for non-clearing vitreous hemorrhage, tractional retinal detachment, or when underlying pathology can't be assessed after 1-3 months. (e) Address concurrent diabetic macular edema — anti-VEGF injections, focal laser. (f) Underlying diabetes management: intensive glycemic control (target A1c <7% when safe), BP control, lipid management, regular follow-up. Classic pitfalls: (a) attributing sudden vision loss in a diabetic to 'just floaters' without urgent ophthalmology referral — delayed diagnosis of underlying PDR or retinal detachment loses vision. (b) Not screening diabetic patients regularly — many present with vision-threatening PDR having never had dilated eye exam. (c) Missing Terson syndrome — vitreous hemorrhage plus altered mental status or severe headache should prompt evaluation for SAH. (d) Stopping anticoagulation reflexively — decisions should balance bleeding in the eye against thromboembolic risk. (e) Forgetting the systemic vasculopathy — patients with PDR have high rates of concurrent cardiovascular, cerebrovascular, and renal disease; address comprehensively."
    }
  }
};
