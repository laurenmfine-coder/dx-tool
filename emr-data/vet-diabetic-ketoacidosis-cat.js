...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Vomiting, Not Eating",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Vomiting, Not Eating",
    "acuity": 2,
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for vet. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) vet assessment revealed the key discriminating features. (3) Feline DKA: how does the feline insulin receptor differ from humans, and why do cats go in and out of diabetes \u2014 what metabolic feature drives this? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
