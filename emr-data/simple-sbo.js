...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: simple (uncomplicated) adhesive small bowel obstruction without strangulation. Key learning: (1) Adhesive small bowel obstruction is the most common cause of SBO in developed countries, accounting for >60% of cases. Most patients have had prior abdominal surgery — even decades earlier — with adhesions forming fibrous bands that kink, twist, or constrict the small bowel. Simple obstruction has no vascular compromise and is distinguished clinically and radiographically from strangulation (which mandates surgery). (2) Presentation tetrad: abdominal pain (colicky), distension, vomiting (bilious in proximal, feculent/dark in distal or long-standing), and obstipation. Physical exam findings depend on location and duration — high-pitched 'tinkling' bowel sounds early, absent late; distension (more pronounced with distal obstruction); tenderness without peritoneal signs in simple obstruction. Examine for hernias at every evaluation — always. (3) Imaging. CT abdomen/pelvis with IV contrast (oral contrast often omitted or water-soluble gastrografin used): identifies obstruction level (transition point), cause, completeness, and looks for strangulation features (bowel wall thickening, mesenteric edema, closed loop, reduced enhancement, free fluid, pneumatosis, portal venous gas). Plain radiographs: dilated small bowel loops, air-fluid levels in step-ladder pattern — less sensitive and specific than CT, useful when CT not immediately available. Upright chest X-ray: evaluates for free air suggesting perforation. Labs: CBC, CMP, lactate (surrogate for strangulation), coagulation, type and screen. (4) Conservative (non-operative) management is appropriate for simple SBO without strangulation — succeeds in 70-80% of first-episode adhesive SBO. (a) NPO with NG decompression (relieves distension, symptoms, and aspiration risk). (b) IV isotonic crystalloid replacement and correction of electrolyte abnormalities (hypokalemia, hypochloremic metabolic alkalosis from NG losses common). (c) Serial abdominal exam and vital signs monitoring, often every few hours. (d) Pain control with judicious opioids (avoid paralytic ileus). (e) No antibiotics routinely for simple obstruction. (f) GASTROGRAFIN CHALLENGE — oral water-soluble contrast (100 mL diluted) is both prognostic and potentially therapeutic: if contrast reaches the colon on repeat abdominal X-ray within 8-24 hours, the obstruction is likely to resolve without surgery; if it does not progress, operation is more likely. Some studies show gastrografin itself may hasten resolution by osmotic effect. (5) Operative indications (stop conservative management and operate): (a) Signs of strangulation (peritonitis, fever, tachycardia, acidosis, lactate elevation, concerning CT findings). (b) Complete obstruction with no clinical improvement after 24-48 hours of NG decompression. (c) Closed-loop obstruction. (d) Incarcerated hernia. (e) Progressive abdominal distension, worsening pain, or hemodynamic changes. Surgical approach: laparoscopic or open adhesiolysis; resection if bowel is non-viable. Post-operatively, adhesion barriers (Seprafilm, etc.) may reduce recurrence. Classic pitfalls: (a) delaying surgery for strangulation — decompensation is rapid; maintain low threshold for operative conversion. (b) Missing hernia in the abdominal wall or groin — always examine. (c) Attributing persistent symptoms to 'ileus' after surgery beyond typical timeframe (3-5 days) — CT for re-obstruction. (d) Not providing education about future adhesive obstruction risk — lifelong 10-30% recurrence, warning signs to return. (e) Forgetting that obstruction in a patient without prior surgery should raise suspicion for malignancy, hernia, or less common causes — broader workup warranted."
    }
  }
};
