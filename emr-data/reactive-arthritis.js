...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: reactive arthritis with the classic triad of arthritis, conjunctivitis, and urethritis (formerly called Reiter syndrome), HLA-B27 associated, following Campylobacter infection. Key learning: (1) Reactive arthritis is a seronegative spondyloarthropathy triggered by a genitourinary or gastrointestinal infection, typically occurring 2-4 weeks after the inciting infection. Triggering pathogens: Chlamydia trachomatis (most common — GU), Salmonella, Shigella, Yersinia, Campylobacter, and C. difficile (GI). About 60-80% of patients are HLA-B27 positive, with stronger association, more severe disease, and axial involvement in B27+ individuals. (2) Classic manifestations. The classic triad 'can't see, can't pee, can't climb a tree' — conjunctivitis, urethritis, and arthritis — is present in only a minority. Arthritis: asymmetric oligoarthritis of large joints, especially lower extremities (knees, ankles), dactylitis ('sausage digit'), enthesitis (especially Achilles tendonitis and plantar fasciitis), and inflammatory low back pain (sacroiliitis). Extra-articular features: conjunctivitis or anterior uveitis (iritis — painful red eye, photophobia — ophthalmology emergency), mucocutaneous (keratoderma blennorrhagicum on palms and soles, circinate balanitis, painless oral ulcers), and rarely cardiac (aortic regurgitation, conduction abnormalities). (3) Diagnosis is clinical. Labs: HLA-B27 typing (supports diagnosis but not required); CRP/ESR elevated; synovial fluid inflammatory (WBC 2,000-50,000, PMN predominance), negative Gram stain and culture (sterile reactive process), no crystals. Document the preceding infection: stool studies for enteric pathogens, urine NAAT or GC/Chlamydia for GU pathogens — often negative by the time arthritis appears, so negative tests don't exclude. Rule out septic arthritis (arthrocentesis), gout, RA (RF/anti-CCP negative), and other spondyloarthropathies (psoriatic arthritis, IBD-associated, ankylosing spondylitis). Imaging: X-rays early are often normal; chronic changes include periostitis, enthesophytes (heel 'spurs'), and asymmetric sacroiliitis. (4) Treatment. Acute phase: NSAIDs (naproxen, indomethacin) are first-line and often sufficient. Intraarticular corticosteroids for monoarticular large joints. Systemic corticosteroids for severe disease or when NSAIDs contraindicated. Antibiotics: treat persistent Chlamydia infection (azithromycin or doxycycline) if detected; enteric infections are usually self-limited and do not need antibiotic treatment to resolve the arthritis. Prolonged antibiotic courses for reactive arthritis itself are controversial and generally not recommended. Chronic or refractory disease: DMARDs (sulfasalazine first, methotrexate), TNF inhibitors (etanercept, adalimumab) for severe or axial disease. Ophthalmology referral for any eye involvement. (5) Prognosis. Most cases resolve within 3-12 months; 20-40% develop chronic or recurrent disease, especially HLA-B27+. Progression to classical ankylosing spondylitis can occur in a subset. Classic pitfalls: (a) missing anterior uveitis — any red painful photophobic eye needs urgent ophthalmology referral; untreated uveitis causes permanent vision loss. (b) Over-treating with prolonged antibiotics for reactive arthritis itself — evidence of benefit is limited, and risks of adverse effects and resistance are real. (c) Forgetting to test for and treat concurrent Chlamydia in GU-triggered cases (both the patient and partners). (d) Missing the axial component (sacroiliitis) when focus is only on peripheral joints — pelvis imaging and inflammatory back pain screening are important. (e) Not counseling about recurrence risk — patients with reactive arthritis, especially HLA-B27+, should be monitored long-term for progression to chronic spondyloarthritis."
    }
  }
};
