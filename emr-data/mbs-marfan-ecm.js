...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Marfan Syndrome",
    "race": "Asian",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Marfan Syndrome",
      "assessment": "Working diagnosis: Marfan Syndrome",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with marfan syndrome. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
