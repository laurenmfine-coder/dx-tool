...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: acute CPPD (calcium pyrophosphate deposition) crystal arthropathy — 'pseudogout' — of the knee, with underlying primary hyperparathyroidism as a secondary cause. Key learning: (1) CPPD disease is a spectrum: asymptomatic chondrocalcinosis (often incidental on X-ray), acute CPP crystal arthritis ('pseudogout'), chronic CPP crystal inflammatory arthritis (polyarticular, RA-like), and OA with CPPD. Acute pseudogout typically affects the knee (most common), wrist, shoulder, or hip, with sudden-onset monoarticular swelling, warmth, erythema, and severe pain peaking over 6-24 hours — clinically similar to gout and septic arthritis. Attack triggers: trauma, surgery (especially parathyroidectomy — 'pseudogout after surgery'), acute illness, and IV bisphosphonates. (2) Differential diagnosis for acute monoarthritis — always rule out septic arthritis (risk of joint destruction within hours). Arthrocentesis is mandatory in every first-presentation acute monoarthritis: (a) Cell count and differential (WBC >50,000 with PMN predominance favors septic; 2,000-50,000 favors inflammatory/crystal; <2,000 favors noninflammatory). (b) Gram stain and culture. (c) Crystal analysis under polarized microscopy: CPPD = rhomboid, weakly POSITIVELY birefringent crystals (blue parallel to axis); MSU (gout) = needle-shaped, strongly NEGATIVELY birefringent (yellow parallel to axis). Crystal disease and septic arthritis can coexist — culture is essential. (3) Secondary causes of CPPD — the '5 H's' mnemonic: Hyperparathyroidism (primary), Hemochromatosis, Hypomagnesemia, Hypophosphatasia, and Hypothyroidism. Also: familial/genetic (ANKH mutations), Gitelman syndrome, and aging (most common cause in elderly). Any CPPD patient under 55 or with unusual severity/distribution should be screened for secondary causes: calcium, magnesium, phosphate, PTH, ferritin/transferrin saturation, alkaline phosphatase, and TSH. (4) Management of acute attack. Monoarticular large joint: intraarticular corticosteroid injection (e.g., triamcinolone 40 mg) — highly effective and avoids systemic side effects. Systemic therapy when multiple joints or injection contraindicated: NSAIDs (naproxen 500 mg BID, indomethacin 50 mg TID — mind renal function and GI risk). Colchicine 1.2 mg PO followed by 0.6 mg PO one hour later, then 0.6 mg BID-TID until symptoms resolve. Systemic corticosteroids (prednisone 30-40 mg PO daily with taper) for those who can't take NSAIDs or colchicine. Address the precipitant (infection, metabolic disturbance). (5) Chronic prevention and treatment of primary hyperparathyroidism. No proven disease-modifying therapy exists for CPPD itself; colchicine prophylaxis (0.6 mg daily or BID) can reduce attack frequency. Magnesium supplementation for hypomagnesemia. Primary hyperparathyroidism: parathyroidectomy for symptomatic disease (stones, fractures, hypercalcemic symptoms, osteoporosis), or per guidelines for asymptomatic disease (age <50, calcium >1 mg/dL above normal, GFR <60, T-score <=-2.5). Classic pitfalls: (a) calling it pseudogout without arthrocentesis and missing septic arthritis. (b) Treating multiple attacks without screening for secondary causes — a 40-year-old with pseudogout should trigger metabolic workup. (c) Giving IV bisphosphonate without flagging pseudogout risk in a patient with known CPPD. (d) Forgetting that CPPD can present as 'pseudo-rheumatoid arthritis' with symmetric polyarthritis — rheumatology evaluation helpful. (e) Treating chronically with indomethacin in an older patient — high GI and renal toxicity; alternative agents are safer."
    }
  }
};
