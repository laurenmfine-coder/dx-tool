...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Known Bisphosphonate User",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Known Bisphosphonate User",
    "acuity": 2,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "Known Bisphosphonate User \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for dentistry. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) dentistry assessment revealed the key discriminating features. (3) A patient who had a tooth extracted 3 weeks ago presents with exposed necrotic bone, purulent discharge, and jaw pain. She has been on oral alendronate for osteoporosis for 8 years. The extraction site is not healing. She asks if she should stop the bisphosphonate immediately. What is the diagnosis, what is the management, and what do you tell her about stopping the medication? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
