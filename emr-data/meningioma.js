...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: right parasagittal meningioma (4.8 cm) presenting with new-onset focal seizure, contralateral focal deficits, and 8 mm midline shift. Key learning: (1) Meningiomas are the most common primary CNS tumor in adults, arising from arachnoidal cap cells. Most (about 80%) are WHO grade 1 (benign), with grade 2 (atypical) and grade 3 (anaplastic/malignant) being progressively aggressive. Common locations are parasagittal/convexity (most common, classic for motor and sensory deficits when near the precentral/postcentral gyri), sphenoid wing, posterior fossa, and skull base. Risk factors include female sex (about 2:1), prior cranial radiation, and neurofibromatosis type 2. (2) Presentation depends on location and growth rate. Because meningiomas grow slowly, patients often tolerate substantial tumors before becoming symptomatic. Classic presentations: new-onset focal seizure (often the first symptom of a convexity meningioma), progressive focal deficit, headache (often positional, worse in morning), cognitive or personality change (frontal), visual loss (optic nerve sheath, sphenoid wing), cranial neuropathies (skull base), and signs of increased intracranial pressure in large lesions. (3) Imaging. MRI with and without contrast is the study of choice: meningiomas appear extra-axial, homogeneously enhancing with a 'dural tail' (enhancement extending along the dura), have CSF cleft between tumor and brain, and often cause peritumoral edema. Midline shift greater than 5 mm is a warning sign of impending herniation and demands urgent management. CT shows a well-circumscribed, hyperdense extra-axial mass often with calcifications and hyperostosis of adjacent bone. (4) Management depends on size, location, symptoms, and grade. Incidental small asymptomatic meningiomas (under 2-3 cm, stable, away from critical structures) — observe with serial MRI. Symptomatic or growing lesions — surgical resection is standard (Simpson grade reflects completeness of resection; complete removal including involved dura and bone gives lowest recurrence). Stereotactic radiosurgery (SRS) is an alternative for small, surgically inaccessible, or residual lesions. Fractionated radiation is used for incomplete resections or grade 2/3 tumors. Dexamethasone reduces peritumoral edema and symptoms but does not treat the tumor; levetiracetam or other AED for seizures. (5) Classic pitfalls: (a) missing the diagnosis in older women with slowly progressive cognitive decline attributed to dementia — image any 'atypical dementia' or unexplained focal findings. (b) Starting prophylactic AEDs in all meningioma patients — evidence supports AEDs only in those who have had a seizure, not universal prophylaxis. (c) Under-recognizing sagittal sinus invasion in parasagittal meningiomas — MRV or MRA is essential preoperatively because sinus involvement changes the operative approach and risk profile. (d) Forgetting that meningioma recurrence is long-term — all resected patients need serial MRI surveillance for years."
    }
  }
};
