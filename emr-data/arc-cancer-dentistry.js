...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Patient Starting Head and Neck Radiation",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Patient Starting Head and Neck Radiation",
      "assessment": "Working diagnosis: Patient Starting Head and Neck Radiation",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with patient starting head and neck radiation. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
