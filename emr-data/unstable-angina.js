...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: unstable angina — a non-ST-elevation acute coronary syndrome without troponin elevation. Key learning: (1) Acute coronary syndrome (ACS) spans a spectrum based on ECG and biomarkers: (a) STEMI — ST elevation on ECG, transmural infarction, emergent reperfusion. (b) NSTEMI — no ST elevation but troponin elevation (myocardial necrosis). (c) Unstable angina — anginal symptoms at rest or crescendo pattern but no troponin elevation. The distinction between UA and NSTEMI has narrowed with high-sensitivity troponin assays, and most patients previously classified as UA would now have some troponin elevation. (2) Clinical features. Classic: substernal chest pressure/pain radiating to left arm, neck, or jaw, associated with diaphoresis, nausea, dyspnea. Atypical (common in women, elderly, diabetics): dyspnea, fatigue, epigastric pain, indigestion, jaw pain, atypical chest pain quality. Unstable features: new-onset angina (within 2 months) with significant intensity, crescendo angina (worsening frequency, duration, severity, or threshold), angina at rest. (3) Initial workup. (a) Serial ECGs (baseline and every 15-30 minutes during chest pain) — look for dynamic ST depression, T-wave inversion; compare to prior. (b) High-sensitivity troponin at presentation and at 1-3 hours (0/1h or 0/2h algorithms rule in or out MI efficiently). (c) Bedside echocardiography for LV function and wall motion. (d) CXR for heart failure, alternate diagnoses. (e) CBC, BMP, lipid panel, PT/PTT, type and screen. (f) Risk scoring: HEART score (ED), TIMI score, GRACE score. (4) Management. Antiplatelet therapy: - Aspirin 325 mg chewed loading, then 81 mg daily indefinitely. - P2Y12 inhibitor — ticagrelor or prasugrel preferred over clopidogrel in ACS. Anticoagulation: unfractionated heparin OR enoxaparin OR bivalirudin (during PCI for selected patients). Anti-ischemic: nitrates (caution with RV infarct, PDE-5 use, hypotension), beta-blocker (unless contraindicated), calcium channel blocker (for symptom control when beta-blocker contraindicated). High-intensity statin (atorvastatin 80 mg or rosuvastatin 40 mg). ACE-I or ARB for LV dysfunction, hypertension, diabetes, CKD — reduces remodeling. Invasive strategy timing: - Very high-risk (hemodynamic instability, refractory angina, life-threatening arrhythmia, mechanical complication): immediate angiography (<2 hours). - High-risk (rising troponin, dynamic ST changes, elevated GRACE): early (<24 hours). - Intermediate: <72 hours. - Low-risk: ischemia-guided (stress testing or outpatient evaluation). (5) Discharge and long-term. Dual antiplatelet therapy (aspirin + P2Y12 inhibitor) for 12 months after PCI with stent (shorter in high bleeding risk; longer in recurrent events). Cardiac rehabilitation referral reduces mortality, hospitalization, and depression — highly underutilized. Address modifiable risk factors: tobacco, BP, LDL (target <55-70 in established CVD), diabetes, obesity, activity, mental health. Return precautions and symptom recognition. Follow-up within 1-2 weeks for medication adherence, side effects, and functional status. Classic pitfalls: (a) missing ACS in women, elderly, diabetics with atypical symptoms — low threshold for ECG and troponin. (b) Failing to perform serial ECGs — dynamic changes may be missed on a single snapshot. (c) Stopping DAPT prematurely after stenting — stent thrombosis often fatal. (d) Not using high-intensity statin in ACS regardless of baseline LDL — major mortality benefit. (e) Underutilizing cardiac rehab and smoking cessation counseling."
    }
  }
};
