...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: blunt testicular trauma with rupture of the tunica albuginea — a urologic emergency. Key learning: (1) Testicular trauma is typically blunt (sports injury, straddle injury, assault) but can be penetrating (stab, gunshot). The tunica albuginea is the tough fibrous capsule surrounding testicular parenchyma; its rupture allows extrusion of seminiferous tubules and hemorrhage. Other injuries in the trauma spectrum: hematocele (blood in tunica vaginalis), testicular contusion, intratesticular hematoma, epididymal injury, and dislocation. (2) Presentation: severe scrotal pain, swelling, bruising, nausea/vomiting, and inability to tolerate scrotal examination. Clinical exam: large tender scrotal hematoma, absent or indeterminate testicular contour, transillumination typically absent (hematocele is opaque), absent cremasteric reflex possible. Distinguish from testicular torsion (typically non-traumatic, though trauma can precede), epididymitis, and hemorrhagic hydrocele. (3) Workup — ULTRASOUND is the imaging modality of choice for suspected testicular trauma. Findings in rupture: heterogeneous testicular echotexture (disrupted parenchyma extruding through tunica defect), loss of normal contour, absent or reduced testicular perfusion on Doppler, large hematocele. Ultrasound sensitivity for rupture is 80-100% depending on operator experience. MRI reserved for equivocal cases. CT for polytrauma and associated injuries. (4) Management. Testicular rupture requires EMERGENT surgical exploration within 72 hours (ideally sooner) to preserve testicular function and fertility. Operative principles: scrotal hematoma evacuation, identification of tunica defect, debridement of nonviable tissue, primary repair of tunica albuginea (with absorbable sutures), and preservation of as much testicular tissue as feasible. Orchiectomy when the testicle is unsalvageable — severe tissue loss, vascular compromise, or extensive disruption. Even severely injured testicles can often be salvaged with timely surgery (preservation rates 80-90% with surgery within 72 hours, much lower with delay). Large hematocele without rupture: drainage and exploration to prevent chronic pain and atrophy. Supportive care: scrotal support, ice, analgesia, antiemetics, tetanus update, antibiotics for penetrating trauma or surgical site. (5) Complications and follow-up. Chronic pain, testicular atrophy, infertility (especially bilateral injury), hypogonadism (with bilateral orchiectomy or severe bilateral injury), and delayed infection. Offer sperm cryopreservation preoperatively when feasible and fertility is a concern. Post-operative follow-up: semen analysis (if fertility concerns), testosterone measurement (hypogonadism risk in significant trauma), and ultrasound for testicular size over time. Psychological support — the emotional impact of genital injury can be significant. Classic pitfalls: (a) delaying surgery for observation or conservative management in testicular rupture — salvage rate drops sharply after 72 hours. (b) Over-reassuring on clinical exam alone — ultrasound is essential to assess tunica integrity. (c) Missing concurrent testicular torsion — particularly in pediatric blunt trauma, where torsion can be triggered by trauma. (d) Not addressing fertility and hormone consequences — discuss openly with patient. (e) Forgetting genital protective equipment counseling in contact sports and certain occupations — primary prevention."
    }
  }
};
