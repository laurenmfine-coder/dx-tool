...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Bipolar I Discharge from Inpatient Unit",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Bipolar I Discharge from Inpatient Unit",
      "assessment": "Working diagnosis: Bipolar I Discharge from Inpatient Unit",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with bipolar i discharge from inpatient unit. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
