...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: White and Brown Spots on Multiple Permanent Teeth",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 White and Brown Spots on Multiple Permanent Teeth",
    "acuity": 3,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "White and Brown Spots on Multiple Permanent Teeth \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for dentistry. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) dentistry assessment revealed the key discriminating features. (3) Distinguish dental fluorosis from enamel hypoplasia from white spot lesions from MIH (molar-incisor hypomineralization). How does the pattern and history help \u2014 and what restorative options apply to each? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
