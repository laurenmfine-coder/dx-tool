...
window.EMR_DATA = {
      ...
      "groups": [
        {
          ...
          "results": [
            ...
            { "test": "Creatinine", "value": "10.4", "unit": "mg/dL", "range": "0.7-1.3", "flag": "H" },
            { "test": "Sodium", "value": "134", "unit": "mEq/L", "range": "136-145", "flag": "L" },
            { "test": "Potassium", "value": "5.8", "unit": "mEq/L", "range": "3.5-5.1", "flag": "H" },
            { "test": "CO2", "value": "18", "unit": "mEq/L", "range": "23-29", "flag": "L" },
            { "test": "Calcium", "value": "8.2", "unit": "mg/dL", "range": "8.5-10.5", "flag": "L" },
            { "test": "Phosphorus", "value": "7.8", "unit": "mg/dL", "range": "2.5-4.5", "flag": "H" },
        ...
        },
        {
          ...
          "results": [
            ...
            { "test": "Hematocrit", "value": "28.0", "unit": "%", "range": "38.3-48.6", "flag": "L" },
        ...
        },
        {
          ...
          "results": [
            { "test": "PTH (Intact)", "value": "380", "unit": "pg/mL", "range": "15-65", "flag": "H" },
            { "test": "HbA1c", "value": "8.2", "unit": "%", "range": "<5.7", "flag": "H" }
          ]
        }
      ]
    }
  ...
  "immunizations": [
    { "vaccine": "Influenza (2025-2026)", "date": "10/2025", "site": "Left deltoid IM", "lot": "FL25-9720", "mfr": "Sanofi" },
    { "vaccine": "COVID-19 Booster (Moderna)", "date": "09/2025", "site": "Right deltoid IM", "lot": "CV25-2718", "mfr": "Moderna" },
    { "vaccine": "Prevnar 20", "date": "03/2023", "site": "Left deltoid IM", "lot": "PV20-612", "mfr": "Pfizer" },
    { "vaccine": "Hepatitis B Series (high-dose — Heplisav-B)", "date": "2022", "site": "Right deltoid IM", "lot": "HB22-408", "mfr": "Dynavax" },
    { "vaccine": "Tdap", "date": "06/2021", "site": "Left deltoid IM", "lot": "TD21-388", "mfr": "GSK" }
  ],
  "familyHistory": [
  ...
  "socialHistory": [
    ["Occupation", "Disabled; formerly worked as bus driver for Broward County Transit; on SSDI since 2022"],
    ["Marital", "Divorced (2015); lives alone; ex-wife still involved as emergency contact"],
    ["Tobacco", "Former — 20 pack-years; quit 2018 (after PCI)"],
    ["Alcohol", "Denies current use; prior social drinking"],
    ["Drugs", "Denies"],
    ["Exercise", "Very limited — deconditioned; walks to mailbox; fatigues easily"],
    ["Housing", "Section 8 apartment; ground floor; no car (broken); relies on Medicaid transportation for dialysis — frequently unreliable"],
    ["Safety", "Fall risk; no firearms; limited social support"],
    ["Advance Directive", "Living will completed; DNR per patient preference; DPOA designated (ex-wife Diane)"]
  ],
  "meta": {
    "caseId": "uremic-encephalopathy",
    "diagnosis": "Uremic Encephalopathy (Missed Dialysis x4 Sessions — ESRD with BUN >120, Hyperkalemia 6.8, Metabolic Acidosis, Volume Overload, Uremic Pericarditis, AMS with Asterixis in Non-Adherent HD Patient with Transportation Barriers)",
    "acuity": 2,
