...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: uremic encephalopathy in a patient with ESRD who missed multiple dialysis sessions, with BUN >120, hyperkalemia, metabolic acidosis, volume overload, and uremic pericarditis. Key learning: (1) Uremic encephalopathy is a manifestation of severely elevated uremic toxins affecting the central nervous system. It occurs in advanced CKD/ESRD, especially in missed dialysis, underdialysis, or acute decompensation. Symptoms span a spectrum: fatigue, apathy, insomnia, cognitive slowing (early), then confusion, disorientation, asterixis, myoclonus, hallucinations, obtundation, seizures, and coma (late). Correlated with BUN level (typically >100) but severity is not linearly related to any single solute. (2) Indications for dialysis in acute/subacute kidney failure — AEIOU mnemonic: (a) Acidosis — refractory metabolic acidosis (pH <7.1-7.2) not responding to medical therapy. (b) Electrolytes — life-threatening hyperkalemia refractory to medical management, severe hypercalcemia, severe hypermagnesemia. (c) Ingestions — salicylate, methanol, ethylene glycol, lithium, metformin-associated lactic acidosis. (d) Overload — fluid overload with pulmonary edema refractory to diuretics. (e) Uremia — uremic encephalopathy, uremic pericarditis, uremic bleeding (platelet dysfunction), severe uremic symptoms. (3) Uremic complications beyond encephalopathy. Uremic pericarditis — pericardial inflammation from uremic toxins; friction rub, chest pain (often pleuritic, positional), risk of effusion and tamponade; requires urgent dialysis and monitoring for tamponade (echocardiography, pulsus paradoxus). Uremic bleeding — platelet dysfunction (uremic toxins impair platelet adhesion and aggregation); manifests as mucocutaneous bleeding, prolonged bleeding time; treatments: DDAVP (releases endothelial vWF), cryoprecipitate, conjugated estrogens (slower onset), transfused platelets (transient benefit — platelets dysfunction soon after). Uremic neuropathy — sensorimotor peripheral neuropathy, restless legs; improves with adequate dialysis. Calciphylaxis — painful necrotic skin lesions from vascular calcification; morbidity high, challenging to treat. Renal osteodystrophy — bone disease from CKD-mineral bone disorder (CKD-MBD). (4) Management. Emergent hemodialysis — definitive treatment; plan within hours. For initial dialysis after prolonged uremia, use 'reduced intensity' (shorter duration, lower blood flow, smaller dialyzer) to avoid dialysis disequilibrium syndrome — rapid solute removal can cause cerebral edema (BUN drops faster in serum than intracranial CSF, driving water into brain). Concurrent management: correct hyperkalemia (calcium, insulin, albuterol, bicarbonate — see ESRD hyperkalemia case), treat volume overload (low-K dialysate, ultrafiltration), treat pericarditis (dialysis is the primary therapy; avoid NSAIDs), correct acidosis via dialysis (bicarbonate in dialysate). Avoid nephrotoxins (NSAIDs, contrast, aminoglycosides) in ESRD. (5) Discharge and long-term. Identify why dialysis was missed: transportation (arrange Medicaid transport, family support, nursing facility care if needed), depression/substance use screening, home vs in-center dialysis reconsideration, patient education. Social work involvement — many missed dialysis cases have remediable social determinants. Consider kidney transplant evaluation if candidate. Palliative care — for patients considering withdrawal of dialysis or with poor functional status. Classic pitfalls: (a) dialyzing too aggressively after prolonged uremia — dialysis disequilibrium with cerebral edema; mitigate with reduced intensity. (b) Missing uremic pericarditis with tamponade physiology — echo early. (c) Attributing encephalopathy to 'dementia' or 'delirium' without checking renal function and uremic toxin levels. (d) Not addressing why dialysis was missed — same problem will recur. (e) Forgetting hidden dietary potassium sources — salt substitutes, leafy greens, nuts, chocolate, star fruit (neurotoxic in ESRD)."
    }
  }
};
