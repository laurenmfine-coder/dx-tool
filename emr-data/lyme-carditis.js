...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: Lyme carditis with high-grade atrioventricular (AV) block. Key learning: (1) Lyme disease is caused by the spirochete Borrelia burgdorferi, transmitted by Ixodes ticks, and progresses through three stages: early localized (erythema migrans — the classic expanding bull's-eye rash at the bite site, though may be absent in up to 30%), early disseminated (multiple EM lesions, facial nerve palsy, meningitis, carditis), and late (arthritis — typically large joints like the knee — and chronic neuroborreliosis). Lyme carditis occurs in about 1% of untreated cases, usually in the early disseminated phase (weeks after exposure), and classically presents with fluctuating AV block of variable degree. (2) Clinical presentation of Lyme carditis: palpitations, dizziness, syncope or presyncope, dyspnea, and chest discomfort in a patient with epidemiologic risk (endemic region, outdoor exposure, tick bite, EM rash — though rash is absent in many patients). ECG classically shows AV block that can fluctuate rapidly between first-degree, Mobitz II, and third-degree block — the rapid variability and young age of the patient should prompt consideration. Less commonly: myopericarditis, mild LV dysfunction, and rarely bundle branch block or atrial arrhythmias. (3) The 'Suspicious Index in Lyme Carditis' (SILC) score helps stratify patients: Constitutional symptoms (1), Outdoor activity/endemic region (1), Male sex (1), Erythema migrans or rash (1), Young age under 50 (1), Tick bite history (1). Score 7+ suggests Lyme etiology. Diagnosis: two-step serology (ELISA screening, confirmatory Western blot for IgM in early and IgG in later disease). Serology may be negative in very early disease — clinical suspicion with exposure history supports empiric treatment. (4) Management of Lyme carditis with high-degree AV block requires hospital admission with continuous cardiac monitoring. Treatment is IV ceftriaxone 2 g daily for 14-21 days (can be narrowed to oral doxycycline once block resolves). Transcutaneous or transvenous pacing is used for hemodynamically unstable high-grade block; because the block typically resolves within days to weeks of antibiotics, PERMANENT pacemakers are almost never indicated — this is critical to avoid unnecessary lifetime device placement in young patients. Full recovery of conduction is the rule. (5) Classic pitfalls: (a) implanting a permanent pacemaker in a young patient with high-grade block without considering Lyme — always ask about exposures and check serology in patients from endemic areas with unexplained AV block. (b) Missing the diagnosis without an EM rash — the rash is absent in a substantial minority, and a negative history does not exclude Lyme. (c) Undertreating with oral antibiotics alone in high-grade block — IV ceftriaxone is standard for cardiac involvement. (d) Forgetting to evaluate for other tick-borne co-infections (Babesia, Anaplasma, Powassan virus) in patients from endemic regions with atypical or severe presentations."
    }
  }
};
