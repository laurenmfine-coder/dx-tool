...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for mbs. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) mbs assessment revealed the key discriminating features. (3) Using bacteriology and immunology: trace how E. coli causes urosepsis from virulence factor to systemic inflammatory response \u2014 and why does the inflammatory cascade lower blood pressure even after the bacteria are treated? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
