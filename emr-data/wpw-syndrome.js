...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: Wolff-Parkinson-White (WPW) syndrome with pre-excited SVT causing exercise-induced syncope, left-sided accessory pathway, documented orthodromic AVRT. Key learning: (1) WPW syndrome is congenital pre-excitation from an accessory atrioventricular pathway (AP) — a muscular bridge (most commonly left lateral, then posteroseptal, then right free wall) that conducts impulses from atrium to ventricle bypassing the AV node. 'WPW pattern' is the asymptomatic ECG finding; 'WPW syndrome' is pre-excitation with clinical arrhythmia. Prevalence ~1-3 per 1000; most patients are asymptomatic, but a subset have tachyarrhythmias and a small but real sudden cardiac death risk. (2) Classic ECG triad: short PR interval (<120 ms), delta wave (slurred upstroke of QRS from early ventricular pre-excitation), and wide QRS (>120 ms from fusion of early and normal activation). Localizing the AP based on delta wave axis and morphology: left-sided APs have negative delta in lead I and aVL; right-sided APs have positive delta in lead I; posteroseptal in inferior leads. (3) Arrhythmias in WPW. (a) ORTHODROMIC AVRT (most common, ~80% of WPW tachyarrhythmias) — narrow-complex SVT; impulse goes down AV node and up the accessory pathway. Treat as SVT: vagal maneuvers, adenosine, beta-blocker, calcium channel blocker. (b) ANTIDROMIC AVRT (~5-10%) — wide-complex tachycardia; impulse goes down the accessory pathway and up the AV node. Can mimic VT. (c) PRE-EXCITED ATRIAL FIBRILLATION (dangerous, ~25-50% lifetime incidence in WPW) — chaotic atrial impulses conducted rapidly through the accessory pathway, which can produce irregular wide-complex tachycardia with rates >300 bpm and risk of VF. CRITICAL: avoid AV nodal blockers (adenosine, beta-blockers, calcium channel blockers, digoxin, amiodarone IV) in pre-excited AF — blocking the AV node drives more impulses through the accessory pathway and can precipitate VF. Treatment: electrical cardioversion for unstable; procainamide or ibutilide for stable. (4) Sudden cardiac death risk. WPW-related sudden death is rare (~0.1% per year) but a real concern, especially in young patients. Risk stratification: symptomatic patients (especially syncope, particularly exercise-induced), short refractory period of accessory pathway (<250 ms during AF — assessed at EP study), multiple accessory pathways, Ebstein anomaly. Exercise-induced syncope in WPW is a red flag. (5) Management. (a) Asymptomatic WPW pattern — observation is reasonable; risk stratification with EP study is increasingly recommended, especially for young patients, athletes, and those in certain occupations (aviation, commercial drivers) because ablation prevents the rare sudden death. (b) Symptomatic WPW — EP study and RADIOFREQUENCY CATHETER ABLATION of accessory pathway is CURATIVE with >95% success rate and low complication rate in experienced hands. First-line therapy for most symptomatic WPW. (c) Medical therapy (when ablation not available or declined): flecainide or propafenone suppress AP conduction; avoid AV nodal blockers in pre-excited AF. (d) Counsel patients about avoiding AV nodal blockers until ablation. (e) Activity restrictions during evaluation — avoid competitive sports with unevaluated WPW and exertional syncope. Classic pitfalls: (a) giving adenosine or beta-blocker to a patient in pre-excited AF — drives ventricular response higher and can precipitate VF. (b) Missing WPW in ECG by not looking for delta wave — short PR without delta wave is LGL syndrome (not WPW). (c) Missing antidromic AVRT or pre-excited AF as the cause of wide-complex tachycardia in a young patient — treat as VT if uncertain (cardioversion, procainamide). (d) Not offering ablation to symptomatic WPW patient — curative, low-risk, widely available in experienced centers. (e) Forgetting that WPW can be lost to follow-up (as in this case) and patients can present acutely — any young patient with documented WPW and syncope warrants expedited EP evaluation."
    }
  }
};
