...
window.EMR_DATA = {
  "patient": {
    ...
    "chiefComplaint": "Passed out after feeling my heart pounding"
  },
  "problems": [
    {
  ...
  "socialHistory": [
    [
      "Occupation",
      "Auto mechanic at dealership; full-time"
    ],
    [
      "Marital",
      "Married 2 years; wife is 4 months pregnant (first child)"
    ],
    [
      "Tobacco",
      "Never smoker"
    ...
    [
      "Alcohol",
      "Social — 2-3 beers on weekends; reduced since wife became pregnant"
    ],
    [
      "Drugs",
      "Denies; former marijuana use in college (stopped 2022)"
    ],
    [
      "Exercise",
      "Recreational soccer league 2x/week; weight training 3x/week — has been avoiding soccer since last prolonged palpitation episode"
    ],
    [
      "Housing",
      "Apartment with wife"
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: Wolff-Parkinson-White syndrome with pre-excited SVT causing exertional syncope, left-sided accessory pathway. Key learning: (1) WPW syndrome is a congenital cardiac condition with an accessory pathway (bundle of Kent) connecting atria and ventricles, bypassing the AV node. Prevalence ~0.1-0.3% of the general population; most are asymptomatic. The accessory pathway allows early ventricular depolarization (pre-excitation), seen on ECG as: (a) Short PR interval (<120 ms). (b) Delta wave (slurred upstroke to QRS). (c) Wide QRS (>120 ms). (d) Secondary ST-T changes. Concealed pathways (conduct only retrograde) — no resting ECG findings but predispose to AV reentry tachycardia. (2) Arrhythmias in WPW. (a) Orthodromic AVRT (most common, 90-95% of arrhythmias) — atrial impulse conducts anterograde down AV node, retrograde up accessory pathway. Narrow complex regular tachycardia (QRS not pre-excited during AVRT). (b) Antidromic AVRT (less common) — anterograde down accessory pathway, retrograde up AV node. Wide complex regular tachycardia (fully pre-excited). (c) ATRIAL FIBRILLATION with pre-excitation — the most dangerous. Atrial impulses conduct rapidly down the accessory pathway without AV node slowing; very fast ventricular rates (sometimes >250-300 bpm) can degenerate to VF and sudden cardiac death. Characteristic ECG: IRREGULARLY IRREGULAR, wide QRS, rates >200, variable QRS width (different degrees of pre-excitation from beat to beat). (3) Acute management. Orthodromic AVRT (narrow complex, regular): - Vagal maneuvers (Valsalva, modified Valsalva with leg raise, carotid massage). - Adenosine 6 mg IV rapid push (may repeat with 12 mg) — usually terminates. - Second-line: IV beta-blocker or calcium channel blocker (diltiazem, verapamil) if stable. - Synchronized cardioversion if unstable. Antidromic AVRT or WPW with AFib: - AVOID AV nodal blocking agents (adenosine, diltiazem, verapamil, beta-blockers, digoxin) — blocking the AV node allows all impulses to go down the accessory pathway and can precipitate VF. - Use procainamide or ibutilide (sodium channel blocking antiarrhythmics) which slow the accessory pathway. - Synchronized cardioversion for hemodynamic instability (first-line for any WPW-AFib in many algorithms). (4) Long-term management. Catheter ablation of the accessory pathway is the definitive treatment — success rate 90-95% for most pathways, low complication rate. Indications for ablation: symptomatic arrhythmia, documented AFib with pre-excitation, high-risk occupations (pilots, drivers, divers), athletes, and patient preference. Asymptomatic patients with WPW ECG — risk stratification with electrophysiology study (looks at shortest pre-excited RR interval during AFib — <220-250 ms = high risk); ablation recommended for high-risk features. Medical therapy alone (when ablation not done): for orthodromic AVRT, beta-blocker or calcium channel blocker as prophylaxis; flecainide or propafenone for those without structural heart disease; avoid AV-nodal blocking agents alone in patients with documented AFib. (5) Sports and activity counseling. WPW is a recognized cause of sudden cardiac death in young athletes. Pre-participation screening and evaluation of any athlete with suspicious symptoms (palpitations, syncope, pre-syncope with exertion). Post-ablation — most patients can return to full activity after confirmation of success. Classic pitfalls: (a) giving adenosine to WPW with AFib — can precipitate VF. (b) Missing AFib with pre-excitation by calling it VT — the irregular rhythm and variable QRS morphology are clues; hemodynamic instability warrants cardioversion regardless of precise mechanism. (c) Not offering ablation to symptomatic patients — definitive cure is usually available. (d) Missing asymptomatic WPW on routine ECG — incidental finding in young patients warrants risk stratification. (e) Forgetting to counsel about sudden death risk, driving restrictions after syncope, and restricted competitive athletics until evaluation complete."
    }
  }
};
