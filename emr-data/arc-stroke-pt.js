...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for pt. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) pt assessment revealed the key discriminating features. (3) James is day 5 post-stroke. Right upper extremity 2/5, right lower 3/5. Brunnstrom stage II. He is in acute rehab. His wife asks: will he walk again? Using the neuroplasticity evidence \u2014 what intensity and task specificity does this week's PT need to look like to maximize his recovery window? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
