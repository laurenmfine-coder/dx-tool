...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Extraction 3 Days Ago",
  ...
  "problems": [
    {
      "problem": "Primary: Extraction 3 Days Ago",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Extraction 3 Days Ago",
      "assessment": "Working diagnosis: Extraction 3 Days Ago",
  ...
  "meta": {
    "caseId": "dental-dry-socket",
    "diagnosis": "See diagnosis \u2014 Extraction 3 Days Ago",
    "acuity": 3,
    "presentation": "Extraction 3 Days Ago",
    "category": "other"
  },
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with extraction 3 days ago. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
    ...
    "ddxTargets": [
      "Extraction 3 Days Ago \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      "phase2": "The student is reviewing a dentistry case with chief complaint: Extraction 3 Days Ago. What are the most important questions for a dentistry to ask \u2014 and what clinical findings would distinguish this from the top 2 alternatives on the differential?",
      ...
      "final": "Case debrief for dentistry. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) dentistry assessment revealed the key discriminating features. (3) Alveolar osteitis versus early socket infection \u2014 how do you distinguish them, and what is the evidence-based management for dry socket including irrigation and alvogyl placement? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
