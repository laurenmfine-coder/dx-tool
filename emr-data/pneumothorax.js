...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: primary spontaneous pneumothorax (PSP). Key learning: (1) Pneumothorax classification: (a) Primary spontaneous (PSP) — no underlying lung disease, typically tall thin young men 18-40 (6:1 male predominance), often with subpleural blebs/bullae rupture; smoking increases risk 9-22x. (b) Secondary spontaneous (SSP) — underlying lung disease (COPD, cystic fibrosis, Pneumocystis pneumonia, TB, cancer, LAM, Marfan) — more dangerous because the underlying lung has poor reserve. (c) Traumatic — penetrating or blunt chest trauma. (d) Iatrogenic — central line, transbronchial biopsy, transthoracic needle biopsy, CPR, mechanical ventilation. (e) Tension pneumothorax — pressurized air accumulation causing mediastinal shift and hemodynamic collapse — clinical diagnosis requiring IMMEDIATE needle decompression, then tube thoracostomy. (2) Clinical presentation. Sudden-onset unilateral pleuritic chest pain and dyspnea; in small PSP often surprisingly mild — patients may present hours later. Physical exam: decreased breath sounds on the affected side, hyperresonance to percussion, decreased tactile fremitus. Tension pneumothorax: tracheal deviation away from affected side, jugular venous distension, hemodynamic instability, profound respiratory distress. (3) Diagnosis. Upright PA chest X-ray: visceral pleural line with absence of lung markings peripheral to it. CT chest: highest sensitivity, identifies small pneumothoraces, characterizes underlying lung disease, and visualizes bullae. Bedside ultrasound: absence of lung sliding is highly sensitive for pneumothorax, especially in unstable patients; the 'lung point' confirms the transition zone. Measurement of size (British Thoracic Society 2 cm from chest wall at hilum level, or apex-to-cupula distance) guides management. (4) Management by size and clinical status. Small PSP (<2 cm, minimal symptoms): observation with oxygen (increases nitrogen gradient, speeds reabsorption), serial CXR, outpatient management in selected reliable patients with follow-up in 24-48 hours. Moderate-large PSP (>=2 cm or significant symptoms): simple aspiration (catheter insertion and manual aspiration) OR small-bore chest tube (pigtail 8-14 Fr) — modern guidelines favor these less invasive approaches over traditional 24-32 Fr thoracostomy for PSP. Tension pneumothorax: IMMEDIATE needle decompression (14-16 gauge angiocath, 2nd intercostal space midclavicular line OR 4th-5th ICS anterior axillary line in larger patients) then definitive tube thoracostomy. Secondary spontaneous pneumothorax: more aggressive management — tube thoracostomy for most cases, longer observation, and lower threshold for surgical intervention. Persistent air leak >3-5 days or recurrent pneumothorax: VATS pleurodesis (mechanical abrasion or talc) and bullectomy. (5) Discharge counseling. Avoid air travel until fully resolved and for 1-2 weeks after resolution (expansion of residual air at altitude). No scuba diving ever after PSP (absolute contraindication). Smoking cessation strongly emphasized — reduces recurrence 50-70%. Recurrence rate 20-50% after first PSP and higher after each subsequent episode; after second recurrence, definitive surgical management (VATS with pleurodesis and bullectomy) is standard. Return precautions: increasing dyspnea, recurrent chest pain, hemodynamic instability. Classic pitfalls: (a) missing tension pneumothorax and waiting for CXR — clinical diagnosis warranting immediate decompression. (b) Inserting too large a chest tube for simple PSP — pigtail catheters are effective and less traumatic. (c) Failing to identify catamenial pneumothorax (recurrent around menses, endometriosis of diaphragm) in women of reproductive age — consider thoracic endometriosis. (d) Attributing chest pain in a tall thin young man to musculoskeletal cause without imaging — low threshold for CXR or ultrasound. (e) Forgetting to counsel about occupational risks (pilots, divers, astronauts) and recurrence prevention."
    }
  }
};
