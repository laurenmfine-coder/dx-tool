...
window.EMR_DATA = {
  ...
  "problems": [
    {
      ...
      "onset": "2024",
      "status": "Active",
      "notes": "Lip and tongue swelling without urticaria. On lisinopril 3 years \u2014 can occur any time after initiation."
    },
    {
      "problem": "Airway risk \u2014 tongue involvement",
      "icd": "J38.4",
      "onset": "2024",
      "status": "Active",
      "notes": "Tongue angioedema can progress to laryngeal involvement. Serial airway exams q30 minutes."
    },
    {
      "problem": "Hypertension \u2014 requires alternative antihypertensive",
      "icd": "I10",
      "onset": "2019",
      "status": "Active",
      "notes": "ARB is safe alternative \u2014 does not cause bradykinin-mediated angioedema by same mechanism."
    }
  ],
  "medications": [
    {
      "name": "STOP lisinopril immediately \u2014 permanent discontinuation",
      "sig": "Document allergy. Do NOT switch to another ACE inhibitor.",
    ...
    {
      "name": "Epinephrine 0.3mg IM \u2014 if airway compromise develops",
      "sig": "IM injection lateral thigh \u2014 for laryngeal edema or hemodynamic compromise",
      "prescriber": "ED",
      "start": "2024",
      "refills": 0,
      "status": "PRN Emergency"
    },
    {
      "name": "Icatibant 30mg SQ (bradykinin B2 receptor antagonist)",
      "sig": "Specific treatment for bradykinin-mediated angioedema \u2014 most effective available agent",
      "prescriber": "ED/Allergy",
      "start": "2024",
      "refills": 0,
    ...
    {
      "name": "Loratadine 10mg PO \u2014 symptomatic comfort only",
      "sig": "Antihistamines do NOT treat bradykinin angioedema \u2014 given for comfort only",
      "prescriber": "ED",
      "start": "2024",
      "refills": 0,
      "status": "Active \u2014 limited efficacy"
    }
  ],
  "allergies": [
    {
  ...
  "guided": {
    ...
    "ddxTargets": [
      "ACE inhibitor angioedema \u2014 bradykinin-mediated, no urticaria (correct)",
      "Hereditary angioedema \u2014 normal C4/C1-INH excludes HAE",
      "Allergic (IgE-mediated) angioedema \u2014 would have urticaria and elevated tryptase",
      "Acquired C1 esterase inhibitor deficiency \u2014 excluded by normal complement",
      "Idiopathic histaminergic angioedema \u2014 responds to antihistamines, has urticaria",
      "Contact angioedema \u2014 localized, exposure history differs"
    ],
    "biasFlags": {
