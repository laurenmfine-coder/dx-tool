...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Sensory Avoiding",
    "race": "Multiracial",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Sensory Avoiding",
      "assessment": "Working diagnosis: Sensory Avoiding",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with sensory avoiding. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
