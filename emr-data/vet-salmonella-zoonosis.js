...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Bloody Diarrhea",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Bloody Diarrhea",
    "acuity": 2,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "Hospitalized Cow \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for vet. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) vet assessment revealed the key discriminating features. (3) One-health emergency: Salmonella Dublin is reportable and zoonotic. What is your isolation protocol, staff exposure notification, and public health reporting obligation? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
