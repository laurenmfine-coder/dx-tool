...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: phlegmasia cerulea dolens — a limb-threatening complication of massive deep vein thrombosis. Key learning: (1) Phlegmasia cerulea dolens (PCD) is the most severe manifestation of acute DVT, caused by near-complete thrombotic obstruction of the deep and often collateral venous outflow of an entire extremity (most commonly iliofemoral). The spectrum: phlegmasia alba dolens ('white painful leg' — extensive DVT with arterial spasm but without venous infarction) progresses to phlegmasia cerulea dolens ('blue painful leg' — venous outflow so compromised that arterial inflow is also compromised, with severe pain, cyanosis, massive edema) which can progress to venous gangrene (irreversible tissue necrosis). Mortality is 20-40%, and amputation rate is 20-50% in affected limbs. (2) Risk factors are those of standard DVT magnified: active malignancy (most common association — often metastatic or occult), hypercoagulable states, prolonged immobilization, recent surgery, pregnancy, estrogen use, antiphospholipid syndrome, heparin-induced thrombocytopenia, and extensive external compression (pelvic mass, May-Thurner syndrome). (3) Presentation. Triad: severe pain, pitting edema extending to the groin, and cyanotic discoloration of the entire affected limb. Bullae, paresthesias, decreased pulses (from edema-induced compartment-like compression, not primary arterial occlusion), and signs of systemic hypovolemic shock (massive third-spacing into the affected limb can sequester liters of fluid). Contrast with acute limb ischemia (primary arterial): cold, pale/mottled, absent pulses, 'six Ps' — but without massive edema of PCD. (4) Workup. Urgent venous duplex ultrasound of the affected limb and contralateral limb. CT venography or MR venography for extent of thrombus and pelvic/iliac involvement. Labs: CBC, coagulation, D-dimer, CMP, lactate, CPK (rhabdomyolysis from limb compartment syndrome), type and crossmatch. Imaging should not significantly delay treatment in obvious cases. (5) Management is aggressive and multidisciplinary (vascular surgery, interventional radiology, hematology). (a) Immediate therapeutic anticoagulation (IV unfractionated heparin — most rapidly titratable, reversible, and safe during intervention). (b) Elevate the limb (reduces edema and facilitates venous drainage). (c) Aggressive IV fluid resuscitation — patients are massively volume-depleted from third-spacing. (d) Catheter-directed thrombolysis (CDT) or pharmacomechanical thrombectomy (e.g., AngioJet, ClotTriever) are first-line for PCD with threatened limb — restore venous patency within the 'golden hours' to prevent progression to gangrene and post-thrombotic syndrome. (e) Systemic thrombolysis is an option if catheter-based intervention is unavailable but has higher bleeding risk. (f) Surgical venous thrombectomy for failure of endovascular therapy or profound compromise — historically associated with higher morbidity but salvages limbs in experienced centers. (g) Fasciotomy for limb-threatening compartment syndrome. (h) Long-term anticoagulation — duration indefinite for malignancy-associated or recurrent; minimum 3-6 months otherwise. (i) Compression stockings for post-thrombotic syndrome prevention. (j) Evaluate for and treat underlying provoking factor (malignancy screen, hypercoagulability workup when appropriate, May-Thurner identification and possible stenting). Classic pitfalls: (a) under-recognizing PCD as 'just a bad DVT' — the blue cyanotic limb demands immediate escalation. (b) Delaying thrombolytic intervention for diagnostic imaging — clinical picture with ultrasound confirmation is sufficient to activate vascular/IR. (c) Missing HIT as the precipitating hypercoagulable state in a hospitalized patient — always consider in recent heparin exposure with thrombosis and thrombocytopenia. (d) Forgetting occult malignancy screening in unprovoked PCD, especially in patients over 40 — age-appropriate screening plus directed evaluation for cancer-related hypercoagulability."
    }
  }
};
