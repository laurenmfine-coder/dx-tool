...
window.EMR_DATA = {
  "base": {
    "patient": {
      ...
      "dob": "04/11/1953", "age": "72", "sex": "Male", "pronouns": "he/him",
      "mrn": "MRN-228874", "language": "English/Vietnamese", "race": "Asian",
      "phone": "(714) 555-8874", "email": "w.tran@email.com",
      "address": "3382 Westminster Ave, Garden Grove, CA 92843",
      "insurance": "Medicare", "pcp": "Dr. Linh Nguyen, MD",
      "pharmacy": "Rite Aid — Westminster",
      "emergencyContact": { "name": "Mai Tran", "phone": "(714) 555-2211", "relationship": "Spouse" }
    },
    "allergies": [{ "allergen": "NKDA", "reaction": "", "severity": "", "type": "" }],
    "immunizations": [{ "name": "Influenza", "date": "10/2025", "lot": "FL-25", "site": "Left Deltoid" }],
    "familyHistory": ["Father: lung cancer (smoker)", "Non-contributory otherwise"],
    "socialHistory": [
      ["Oncology", "Squamous cell carcinoma of the lung — stage IV (pleural effusion). Diagnosed 2 months ago. Starting chemotherapy next week."],
      ["Smoking", "40 pack-year history — quit 10 years ago"],
      ["Symptoms", "'Bones hurt, stones in past, abdominal groans, psychic moans' — classic hypercalcemia mnemonic"],
      ["Calcium supplements", "Was taking OTC calcium carbonate 1500mg/day for bone health — recently increased dose"],
      ["Vitamin D", "On vitamin D3 2000 IU daily"]
    ]
  },
  "encounters": {
    "ed": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Severe hypercalcemia — Ca 14.2 mg/dL (corrected for albumin). Confusion, polyuria, weakness. Most likely hypercalcemia of malignancy (PTHrP-mediated in squamous cell cancer). PTH appropriately suppressed.", "status": "Active", "onset": "Subacute", "icd10": "E83.52" },
        { "id": "prob-2", "description": "PTHrP (parathyroid hormone-related peptide) — produced by squamous cell carcinomas. Mimics PTH action: increases bone resorption + renal calcium reabsorption → hypercalcemia. PTH will be LOW (suppressed by elevated Ca).", "status": "Active", "onset": "Subacute", "icd10": "C34.12" },
        { "id": "prob-3", "description": "Volume depletion — hypercalcemia causes nephrogenic DI → polyuria → volume depletion → decreased renal calcium clearance (worsens hypercalcemia). Aggressive IV hydration is cornerstone of treatment.", "status": "Active", "onset": "Subacute", "icd10": "E86.0" },
        { "id": "prob-4", "description": "Calcium supplements + vitamin D — contributing factor, stop immediately", "status": "Active", "onset": "Chronic", "icd10": "E83.52" }
      ],
      "medications": [
        { "id": "med-1", "name": "Calcium carbonate supplements", "dose": "1500mg", "route": "PO", "frequency": "Daily — STOP immediately", "status": "STOP", "prescriber": "Self-prescribed OTC" },
        { "id": "med-2", "name": "Vitamin D3", "dose": "2000 IU", "route": "PO", "frequency": "Daily — STOP during hypercalcemia", "status": "STOP", "prescriber": "Self-prescribed OTC" },
        { "id": "med-3", "name": "Amlodipine", "dose": "5mg", "route": "PO", "frequency": "Daily", "status": "Active — continue", "prescriber": "Dr. Linh Nguyen, MD" }
      ],
      "vitals": [{ "date": "03/15/2026", "time": "08:00", "bp": "108/72", "hr": "102", "rr": "18", "temp": "37.0°C", "spo2": "97%", "pain": "3/10" }],
      "visits": [{
      ...
      "labs": [{
        "date": "03/15/2026", "time": "08:20", "status": "Final", "orderedBy": "Dr. Attending",
        "accession": "LAB-228874", "collected": "03/15/2026 08:15", "fasting": "Not fasting",
        "facility": "ReasonDx Medical Center", "specimenType": "Blood",
        "groups": [
          { "name": "CALCIUM AND PARATHYROID STUDIES", "results": [
            { "test": "Total Calcium", "value": "14.2", "unit": "mg/dL", "range": "8.5-10.5 (severe: >14)", "flag": "H" },
            { "test": "Albumin", "value": "2.8", "unit": "g/dL", "range": "3.5-5.0", "flag": "L" },
            { "test": "Corrected Calcium", "value": "15.2", "unit": "mg/dL", "range": "8.5-10.5", "flag": "H" },
            { "test": "Ionized Calcium", "value": "1.98", "unit": "mmol/L", "range": "1.12-1.32", "flag": "H" },
            { "test": "PTH (Parathyroid Hormone)", "value": "8", "unit": "pg/mL", "range": "15-65 (SUPPRESSED)", "flag": "L" },
            { "test": "PTHrP (Parathyroid Hormone-Related Peptide)", "value": "ELEVATED (62 pmol/L)", "unit": "", "range": "<2 pmol/L", "flag": "H" },
            { "test": "25-OH Vitamin D", "value": "62", "unit": "ng/mL", "range": "30-100", "flag": "" },
            { "test": "1,25-OH Vitamin D", "value": "18", "unit": "pg/mL", "range": "18-72", "flag": "" }
          ]},
          { "name": "METABOLIC", "results": [
            ...
            { "test": "Phosphorus", "value": "1.8", "unit": "mg/dL", "range": "2.5-4.5 (LOW — PTHrP increases renal phosphorus excretion)", "flag": "L" },
            { "test": "Sodium", "value": "145", "unit": "mEq/L", "range": "136-145", "flag": "" },
    ...
    "inpatient": {
      ...
      "problems": [
        { "id": "prob-1", "description": "Hypercalcemia — responding. Ca 14.2 → 12.4 → 11.8. Mental status improving. Zoledronic acid effect expected to peak at 48-72h.", "status": "Improving", "onset": "Subacute", "icd10": "E83.52" },
        { "id": "prob-2", "description": "AKI — creatinine 1.8 from volume depletion. Improving with IVF — Cr now 1.4.", "status": "Improving", "onset": "Acute", "icd10": "N17.9" }
      ],
      "medications": [
        { "id": "med-1", "name": "Normal Saline", "dose": "200 mL/hr", "route": "IV", "frequency": "Continuous — reducing rate as Ca improves", "status": "Active", "prescriber": "Dr. Medicine Attending" }
      ],
      "vitals": [{ "date": "03/16/2026", "time": "06:00", "bp": "118/76", "hr": "88", "rr": "16", "temp": "37.0°C", "spo2": "98%", "pain": "1/10" }],
      "visits": [{
      ...
      "labs": [{
        ...
        "accession": "LAB-228875", "collected": "03/16/2026 05:55", "fasting": "Fasting",
        "facility": "ReasonDx Medical Center", "specimenType": "Blood",
        "groups": [
          { "name": "CALCIUM TREND", "results": [
            { "test": "Total Calcium", "value": "11.8", "unit": "mg/dL", "range": "8.5-10.5", "flag": "H" },
            { "test": "Trend", "value": "14.2 → 12.4 → 11.8 — RESPONDING ✓", "unit": "", "range": "Target <12", "flag": "" },
  ...
  "references": [
    { "id": "StatPearls-Hypercalcemia", "title": "Hypercalcemia", "authors": "Zagzag J, Hu MI, Fisher SB, Perrier ND", "journal": "StatPearls", "year": 2024, "doi": "", "url": "https://www.ncbi.nlm.nih.gov/books/NBK430714/", "openAccess": true, "validates": ["Corrected calcium calculation", "Differential diagnosis (PTH vs PTHrP)", "Treatment stepwise (IVF, calcitonin, bisphosphonates)", "Furosemide not first-line"] }
  ]
};
