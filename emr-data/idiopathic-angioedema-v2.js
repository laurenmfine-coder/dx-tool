...
window.EMR_DATA = {
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Thomas appears anxious and frustrated, frequently touching his swollen lips while speaking. He's very forthcoming about his symptoms and extensive prior workup, expressing significant distress about the unpredictability of his episodes and how they've impacted his career and personal life. He seems desperate for answers after two years of recurrent episodes without an identifiable cause.",
    "interviewQuestions": [
      "When did this current episode of lip swelling begin?",
      "Can you describe what the swelling looks like and feels like?",
      ...
      "Tell me about your previous episodes of swelling - when and where did they occur?",
      "Have you ever had swelling of your throat or tongue?",
      "What treatments have you tried for these episodes?",
      "Has anyone in your family had similar swelling episodes?",
      "Are you currently taking any medications?",
      "Do you have any known allergies?",
      "How have these episodes affected your daily life and work?",
      "Have you noticed any patterns or triggers for your episodes?"
    ],
    "patientResponses": {
      "default": "I'm not sure I understand what you're asking. Could you rephrase that? I'm really worried about this swelling.",
      "onset": "The lip swelling started about 6 hours ago when I woke up this morning. It came on gradually over the first few hours.",
      "character": "My lips feel tight, swollen, and kind of numb. They look puffy and distorted - much larger than normal.",
      "location": "Just my lips this time, both upper and lower. No swelling anywhere else on my face or body right now.",
      "severity": "I'd say it's about a 6 out of 10. It's not the worst I've had, but it's definitely noticeable and uncomfortable.",
      "aggravating": "Nothing seems to make it worse. I've been avoiding eating or drinking much because I'm worried it might get worse.",
      "relieving": "I took some Benadryl and famotidine like my doctor recommended, but it doesn't seem to be helping much this time.",
      "associated": "No difficulty breathing or swallowing today, thank God. No rash, itching, or other symptoms.",
      "denies": "No trouble breathing, no throat tightness, no rash or hives, no nausea or vomiting, no new exposures that I can think of.",
      "history": "This is my 8th episode in 2 years. I've had swelling of my face, hands, feet, and one scary time my throat was involved. No pattern I can identify.",
      "medications": "Diphenhydramine; Famotidine; Methylprednisolone",
      "allergies": "NKDA",
      "family": "No one in my family has ever had anything like this. My parents are healthy, no siblings with similar problems.",
      "social": "I'm a sales rep and travel a lot for work, or I used to. I've had to cancel three business trips because I'm terrified of having an episode away from home. I don't smoke, drink maybe a glass of wine with dinner occasionally."
    },
    "examManeuvers": [
      "Inspection of lips and perioral area",
      "Palpation of swollen areas",
      ...
      "Assessment of extremities for swelling"
    ],
    "examFindings": {
      "Inspection of lips and perioral area": "Bilateral symmetric lip swelling, more pronounced in lower lip, non-erythematous, no vesicles or ulceration",
      "Palpation of swollen areas": "Soft, non-tender, non-pitting edema of both lips, normal temperature",
      "Assessment of airway patency": "Clear airway, no stridor, normal voice quality, no respiratory distress",
      "Examination of oropharynx and tongue": "Normal tongue size and position, no uvular swelling, normal posterior pharynx",
      "Skin examination for urticaria or rash": "No urticaria, petechiae, or rash on face, neck, chest, or arms",
      "Lymph node palpation": "No cervical, submandibular, or supraclavicular lymphadenopathy",
      "Cardiovascular examination": "Regular rate and rhythm, no murmurs, no JVD",
      "Pulmonary examination": "Clear to auscultation bilaterally, no wheezes or stridor",
      "Abdominal examination": "Soft, non-tender, no hepatosplenomegaly",
    ...
    "biasFlags": {
      ...
      "prematureClosure": "Risk of immediately accepting 'idiopathic' diagnosis without considering if any new triggers or causes have emerged since last workup",
      "availabilityBias": "May focus too heavily on hereditary angioedema or allergic causes due to their prominence in medical education, despite normal workup"
    },
    "coachPrompts": {
