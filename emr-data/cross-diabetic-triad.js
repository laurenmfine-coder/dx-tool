...
window.EMR_DATA = {
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 T2DM A1c 10.2%",
    "acuity": 2,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "55yo T2DM A1c 10.2% \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for medicine. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) medicine assessment revealed the key discriminating features. (3) His toe ulcer has exposed tendon visible and he rates pain 2/10. He mentions his eye doctor found new retinal changes last month. His dentist has been treating his gum disease. He is asking which problem to address first. What does the 2/10 pain rating mean in the context of the exposed tendon \u2014 and what single intervention addresses the most organ systems? (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
