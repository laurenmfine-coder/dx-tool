...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: community-acquired pneumonia superimposed on very severe COPD (GOLD stage IV) with acute hypercapnic respiratory failure and sepsis. Key learning: (1) This is the most severe end of the pneumonia-plus-COPD spectrum: a patient with baseline FEV1 <30% predicted, limited respiratory reserve, evidence of sepsis, and decompensated hypercapnic respiratory failure. Mortality is high (20-40%), and the care bundle of early antibiotics, respiratory support, sepsis resuscitation, and careful ventilatory management is critical. (2) Sepsis recognition and management (Surviving Sepsis Campaign). Initial hour bundle: obtain blood cultures x2 BEFORE antibiotics when feasible, measure lactate, administer broad-spectrum antibiotics within 1 hour, begin 30 mL/kg IV crystalloid within the first 3 hours for hypotension or lactate >=4, start vasopressors (norepinephrine first) if still hypotensive after fluids. Source control: CXR and sputum culture for pneumonia; expand imaging if alternative source suspected. Balance volume resuscitation against worsening oxygenation — use dynamic measures of volume responsiveness (pulse pressure variation, bedside IVC ultrasound, passive leg raise) rather than blind fluid bolus in patients with severe COPD. (3) Respiratory management. Target SpO2 88-92% (avoid overoxygenation in chronic CO2 retainers). NIV (BiPAP) is first-line for acute hypercapnic respiratory failure in COPD — reduces intubation, mortality, and length of stay. Contraindications: altered mental status preventing cooperation, inability to protect airway, hemodynamic instability, copious secretions, facial trauma. If NIV fails (not improving or worsening after 1-2 hours, worsening pH, tiring patient), intubate and ventilate. Ventilator strategy: low tidal volumes (6 mL/kg ideal body weight), adequate expiratory time (prolonged I:E ratio 1:4 or more), PEEP matched to intrinsic PEEP (auto-PEEP), permissive hypercapnia — accept higher PaCO2 to allow adequate expiration. Avoid beta-agonist excess and monitor for arrhythmia and hypokalemia. (4) Antibiotics — empiric coverage including Pseudomonas and MRSA is appropriate in very severe COPD with sepsis: piperacillin-tazobactam or cefepime PLUS azithromycin (or respiratory fluoroquinolone) PLUS vancomycin (for MRSA). De-escalate based on cultures. Add systemic corticosteroids (prednisone 40 mg PO daily or equivalent IV) for COPD exacerbation component. Consider and treat viral co-infection (influenza, RSV, SARS-CoV-2) with season-appropriate testing and antivirals. (5) Goals of care. GOLD stage IV COPD carries poor prognosis — 5-year survival ~30-50% depending on comorbidities. Every hospital admission is an opportunity to discuss advance care planning, palliative care consultation, and goals of care — especially if the patient is on home oxygen, has frequent hospitalizations, significant weight loss, BMI <21, or severe functional limitation. Preferences for intubation, CPR, and end-of-life priorities should be explored before deterioration. Classic pitfalls: (a) intubating early in COPD exacerbation before adequate trial of NIV — NIV is first-line unless contraindicated. (b) High tidal volumes in a COPD patient on the ventilator — causes dynamic hyperinflation, breath stacking, hypotension, and barotrauma; dial down tidal volume and extend expiratory time. (c) Withholding steroids because of pneumonia — COPD exacerbation with or without pneumonia benefits from systemic steroids. (d) Not discussing goals of care with patients and families in advanced COPD — 'surprise question' (would you be surprised if the patient died in the next year?) helps identify appropriate timing. (e) Forgetting to discharge with pulmonary rehab referral, inhaler technique reinforcement, smoking cessation plan, vaccination update, and close follow-up to prevent readmission."
    }
  }
};
