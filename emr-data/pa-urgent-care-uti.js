...
window.EMR_DATA = {
  ...
  "problems": [
    {
      "problem": "Primary: Dysuria 2 Days",
      "icd": "Z00.00",
      "onset": "2024",
      "status": "Active",
      "notes": "See HPI"
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Dysuria 2 Days",
    "acuity": 3,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "Dysuria 2 Days \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for pa. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) pa assessment revealed the key discriminating features. (3) Choose your antibiotic \u2014 and explain the stewardship reasoning that makes this more than just picking from a list. (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
