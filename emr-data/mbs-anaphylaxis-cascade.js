...
window.EMR_DATA = {
  ...
  "meta": {
    ...
    "diagnosis": "See diagnosis \u2014 Anaphylaxis",
    "acuity": 2,
  ...
  "guided": {
    ...
    "ddxTargets": [
      "Anaphylaxis \u2014 primary diagnosis (correct)",
    ...
    "coachPrompts": {
      ...
      "final": "Case debrief for mbs. Key learning points: (1) The diagnosis is consistent with the presenting findings. (2) mbs assessment revealed the key discriminating features. (3) Trace mediator release to each clinical feature \u2014 then identify which adrenergic receptor subtype reverses each component. (4) Interprofessional coordination is essential for optimal patient outcomes in this case type."
    }
  }
};
