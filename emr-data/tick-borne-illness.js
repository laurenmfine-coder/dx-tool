...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: human monocytic ehrlichiosis (HME) from Ehrlichia chaffeensis infection. Key learning: (1) Tick-borne illnesses in the US include Lyme disease (Borrelia burgdorferi), anaplasmosis (Anaplasma phagocytophilum), ehrlichiosis (Ehrlichia chaffeensis, E. ewingii, E. muris eauclairensis), babesiosis (Babesia microti), Rocky Mountain spotted fever (Rickettsia rickettsii), tularemia, and Powassan virus. Exposure history is critical: recent tick bite (only 50-70% recall one), outdoor activity in endemic area, season (typically spring-summer peak), and geography. Ehrlichia chaffeensis — transmitted by Lone Star tick (Amblyomma americanum), endemic in southeastern and south-central United States. (2) Clinical presentation of ehrlichiosis: Non-specific febrile illness: high fever, severe headache, myalgia, malaise, nausea/vomiting, often 7-14 days after tick exposure. Rash is uncommon in adult ehrlichiosis (~30%) — absence does not exclude diagnosis. Laboratory: leukopenia (especially lymphopenia), thrombocytopenia, elevated liver enzymes (AST, ALT), elevated LDH, and elevated inflammatory markers. The triad of fever, leukopenia, and thrombocytopenia in an endemic area is highly suggestive. Severe disease: toxic shock, ARDS, meningoencephalitis, renal failure, DIC, and death (1-3% mortality). Immunocompromised patients (HIV, transplant, immunosuppressive therapy) have worse outcomes. (3) Diagnosis. Clinical suspicion in endemic area with appropriate exposure and findings. Confirmatory testing: (a) PCR for Ehrlichia DNA on blood — most sensitive in first week of illness. (b) Peripheral smear — morulae (intracellular bacterial aggregates) in monocytes (HME) or neutrophils (anaplasmosis/HGA); low sensitivity but highly specific. (c) Serology (IFA) with IgG and IgM — fourfold rise in paired acute and convalescent titers confirms diagnosis; acute-phase serology often negative because IgM response takes 1-2 weeks. (4) Treatment. DOXYCYCLINE 100 mg PO/IV BID is first-line for ALL tick-borne rickettsial and ehrlichial infections, regardless of age. Start EMPIRICALLY whenever ehrlichiosis, anaplasmosis, or Rocky Mountain spotted fever is suspected — DO NOT wait for confirmation; delay is associated with increased mortality, particularly for RMSF. Duration: 7-14 days or at least 3 days after fever resolves and clinical improvement. Response: fever typically defervesces within 48 hours; failure to respond should prompt reconsideration of diagnosis. In pregnancy and children, doxycycline remains first-line for tick-borne rickettsial infections — the old contraindication in young children (dental staining) is less concerning with short courses (<21 days) and is outweighed by mortality risk of untreated RMSF. Doxycycline over chloramphenicol (older alternative) — shorter course, better efficacy, fewer adverse effects. (5) Prevention and co-infection considerations. Tick prevention: DEET-containing insect repellent, permethrin-treated clothing, avoid tick habitats, daily tick checks, prompt removal of attached ticks (fine-tipped tweezers, grasp close to skin, steady upward pressure; avoid twisting/burning). Prophylactic doxycycline (single 200 mg dose) is recommended for adults and children after an Ixodes (deer tick) bite with attachment >=36 hours in highly endemic Lyme regions — reduces Lyme incidence. Co-infection is possible: Lyme and anaplasmosis transmitted by same tick (Ixodes); consider broader testing in severe or atypical illness. Babesiosis can coexist with Lyme/anaplasmosis — suspect in severe illness, hemolytic anemia, or immunocompromised patients. Classic pitfalls: (a) waiting for serology to confirm before treating — empirically treat any suspected rickettsial/ehrlichial illness with doxycycline; mortality rises with delay. (b) Missing RMSF — 'spotless' RMSF is common early, and delay is catastrophic (20% mortality untreated vs <5% treated). (c) Avoiding doxycycline in pregnancy or children when tick-borne rickettsial infection is suspected — short-course doxycycline is safe and lifesaving. (d) Missing co-infection in patients not responding to expected therapy — think babesiosis if hemolytic features, think Lyme if persistent arthritis or neurologic. (e) Not counseling patients about tick prevention in endemic areas and high-risk occupations."
    }
  }
};
