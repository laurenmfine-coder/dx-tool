...
window.EMR_DATA = {
  ...
  "guided": {
    ...
    "coachPrompts": {
      ...
      "final": "Diagnosis: human monocytic ehrlichiosis (HME) caused by Ehrlichia chaffeensis. Key learning: (1) Ehrlichiosis is a tick-borne rickettsial-like illness common in the south-central, southeastern, and mid-Atlantic United States. The main species: Ehrlichia chaffeensis (vector: Amblyomma americanum, the Lone Star tick; reservoir: white-tailed deer) causes human monocytic ehrlichiosis; Anaplasma phagocytophilum (vector: Ixodes scapularis; reservoir: small mammals) causes human granulocytic anaplasmosis (similar clinical picture but distinct organism). (2) Presentation typically 1-3 weeks after tick exposure (often unrecognized bite): fever, chills, headache, myalgia, malaise, nausea/vomiting, sometimes cough, confusion. Rash (maculopapular or petechial) occurs in about 30% of adults and 60% of children — more common in ehrlichiosis than anaplasmosis, less than RMSF. Key laboratory findings: LEUKOPENIA (especially lymphopenia), THROMBOCYTOPENIA, elevated transaminases, elevated LDH, and sometimes hyponatremia — the 'tick-borne triad' of fever + cytopenias + transaminitis in an exposed person should prompt empiric doxycycline. Severe complications: meningoencephalitis, renal failure, ARDS, DIC, toxic shock-like syndrome, and hemophagocytic lymphohistiocytosis (HLH) — mortality 1-3% overall, higher in immunocompromised (especially asplenia, HIV). (3) Differential in a patient with fever after possible tick exposure. (a) Ehrlichiosis/anaplasmosis. (b) Rocky Mountain spotted fever (Rickettsia rickettsii, Dermacentor ticks) — classically centripetal rash, more severe, higher mortality, treat empirically. (c) Lyme disease (Borrelia burgdorferi, Ixodes) — erythema migrans, flu-like illness; later arthritis, carditis, neurologic. (d) Babesiosis (Babesia microti, Ixodes) — fever, hemolytic anemia, thrombocytopenia; severe in asplenic patients (similar to malaria). (e) Powassan virus — rare but severe neurologic disease. (f) Alpha-gal syndrome (delayed allergy to mammalian meat after Lone Star tick bite) — not acute febrile illness but distinctive. Co-infections with multiple tick-borne pathogens are possible in endemic areas. (4) Diagnosis. Clinical — empiric treatment for suspected tick-borne illness should not wait for confirmation. Laboratory confirmation: PCR on whole blood (sensitive in early disease, best before antibiotics); serology (fourfold rise in IgG between acute and convalescent samples confirms); peripheral blood smear may show intracytoplasmic morulae (characteristic mulberry-like inclusions) in monocytes (ehrlichiosis) or neutrophils (anaplasmosis). Rule out co-infections in endemic areas. (5) Treatment. DOXYCYCLINE 100 mg PO/IV BID is first-line for all ages, including children under 8 and in pregnancy (benefits of rapid treatment outweigh theoretical dental staining risks — CDC position). Duration: at least 5-7 days and for at least 3 days after fever resolves; typical course 7-14 days. Rifampin is an alternative (e.g., for doxycycline allergy, but less effective). Rapid clinical response expected within 48-72 hours — persistent fever beyond that suggests alternative diagnosis, co-infection, or complication. Hospitalization and supportive care for severe disease. Prevention: tick avoidance (protective clothing, permethrin-treated clothing, DEET or picaridin repellents), daily tick checks, prompt removal with fine-tipped tweezers. Classic pitfalls: (a) delaying doxycycline waiting for confirmation — treat empirically in suspected RMSF or ehrlichiosis. (b) Using drug other than doxycycline — doxycycline is now preferred even in pregnancy/pediatrics. (c) Missing co-infections — test for Lyme, Babesia in endemic areas. (d) Not counseling tick-bite prevention at every primary care visit in endemic regions. (e) Forgetting to consider HLH in severe or atypically progressing cases — fever, pancytopenia, hyperferritinemia, splenomegaly."
    }
  }
};
