...
window.EMR_DATA = {
  "patient": {
    ...
    "language": "English",
    "chiefComplaint": "Implant Placed 3 Months Ago",
    "race": "Middle Eastern",
  ...
  "visits": [
    {
      ...
      "summary": "Patient seen for Implant Placed 3 Months Ago",
      "assessment": "Working diagnosis: Implant Placed 3 Months Ago",
  ...
  "guided": {
    "supported": true,
    "patientPersona": "Patient presents with implant placed 3 months ago. They are cooperative and provide history as able. Emotional presentation appropriate to acuity level. Communication style consistent with case context.",
    "interviewQuestions": [
