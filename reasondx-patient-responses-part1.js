...
(function() {
    ...
    const RAYMOND_HUGHES = {
        ...
        responses: {
            ...
            "medical history|medical problems|past medical history|health problems|conditions|diagnoses":
                "High blood pressure - had that about 10 years. Cholesterol was borderline high at my last checkup. And chronic back pain.",
            
            "anything else|complete list|any other conditions":
                "That's the main stuff. Just those three things really.",
