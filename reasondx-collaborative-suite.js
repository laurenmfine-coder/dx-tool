...
(function() {
    ...
    // ========================================================================
    // AUTO-INJECT MENU ITEMS
    // ========================================================================
    
    function injectCollaborativeMenu() {
        const placeholder = document.getElementById('collaborative-menu-placeholder');
        if (placeholder && typeof renderCollaborativeMenuItems === 'function') {
            placeholder.innerHTML = renderCollaborativeMenuItems();
        }
    }

    // Inject on DOM ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', injectCollaborativeMenu);
    } else {
        injectCollaborativeMenu();
    }

    // Also inject whenever the menu is rendered (observe for changes)
    ...
    // Start observing once app element exists
    const startObserving = () => {
        const app = document.getElementById('app');
        if (app) {
            menuObserver.observe(app, { childList: true, subtree: true });
            injectCollaborativeMenu(); // Initial injection
        }
    };
